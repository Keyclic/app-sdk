...
,
  ...
  return GetTicketCollection200Response(
        embedded: GetTicketCollection200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetTicketCollection200Response> listFromJson(Iterable? json) {
    if (json == null) {
      return <GetTicketCollection200Response>[];
    }

    return json.fold(<GetTicketCollection200Response>[], (List<GetTicketCollection200Response> previousValue, element) {
      final GetTicketCollection200Response? object = GetTicketCollection200Response.fromJson(element);
  ...
  static Map<String, GetTicketCollection200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetTicketCollection200Response>{};
    }

    return json.entries.fold(<String, GetTicketCollection200Response>{}, (Map<String, GetTicketCollection200Response> previousValue, element) {
      final GetTicketCollection200Response? object = GetTicketCollection200Response.fromJson(element.value);
      if (object is GetTicketCollection200Response) {
  ...
  static Map<String, List<GetTicketCollection200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetTicketCollection200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetTicketCollection200Response>>(key, GetTicketCollection200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetTicketCollection200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
