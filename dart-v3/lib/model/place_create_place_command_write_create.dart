...
,
  ...
  static List<PlaceCreatePlaceCommandWriteCreate> listFromJson(Iterable? json) {
    ...
    return json.fold(<PlaceCreatePlaceCommandWriteCreate>[], (List<PlaceCreatePlaceCommandWriteCreate> previousValue, element) {
      final PlaceCreatePlaceCommandWriteCreate? object = PlaceCreatePlaceCommandWriteCreate.fromJson(element);
  ...
  static Map<String, PlaceCreatePlaceCommandWriteCreate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, PlaceCreatePlaceCommandWriteCreate>{};
    }

    return json.entries.fold(<String, PlaceCreatePlaceCommandWriteCreate>{}, (Map<String, PlaceCreatePlaceCommandWriteCreate> previousValue, element) {
      final PlaceCreatePlaceCommandWriteCreate? object = PlaceCreatePlaceCommandWriteCreate.fromJson(element.value);
      if (object is PlaceCreatePlaceCommandWriteCreate) {
  ...
  static Map<String, List<PlaceCreatePlaceCommandWriteCreate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PlaceCreatePlaceCommandWriteCreate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PlaceCreatePlaceCommandWriteCreate>>(key, PlaceCreatePlaceCommandWriteCreate.listFromJson(value));
    });
  }

  @override
  String toString() => 'PlaceCreatePlaceCommandWriteCreate[address=$address, description=$description, name=$name, organization=$organization, parent=$parent, preferences=$preferences, state=$state]';
