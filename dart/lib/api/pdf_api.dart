...
class PdfApi {
  ...
  /// * [int] limit:
  ///   Page of the overview.
  Future<Response> cpostImageWithHttpInfo(
    String xKeyclicApp,
    FileData fileData, {
    String acceptLanguage,
    DateTime xDateTime,
    ...
    if (fileData == null) {
      throw ApiException(
          HttpStatus.badRequest, 'Missing required param: fileData');
    }

    final path = r'/pdf/images';
  ...
  Future<BinaryPagination> cpostImage(
    ...
    final response = await cpostImageWithHttpInfo(
      xKeyclicApp,
      fileData,
    ...
    if (response.body == null || response.statusCode == HttpStatus.noContent) {
      return Future<BinaryPagination>.value(null);
    }
