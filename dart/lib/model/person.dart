...
,
  ...
  static Map<String, Person> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Person>{}, (Map<String, Person> previousValue, element) {
  ...
  @override
  String toString() => 'Person[links=$links, agreement=$agreement, createdAt=$createdAt, email=$email, enabled=$enabled, familyName=$familyName, givenName=$givenName, id=$id, jobTitle=$jobTitle, optIn=$optIn, preferences=$preferences, telephone=$telephone, type=$type, updatedAt=$updatedAt, username=$username]';
