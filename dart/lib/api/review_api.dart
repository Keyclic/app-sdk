...
class ReviewApi {
  ...
  /// Also see [Retrieve one Review resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  ...
  /// Throws [DioError] if API call or serialization fails
  /// Keyclic API documentation.
  /// Also see [Create one Review resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
