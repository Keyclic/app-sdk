...
class ExternalServiceApi {
  ...
  Future<Response<void>> deleteExternalService({ 
    ...
    final String path = r'/external-services/{externalService}'.replaceAll('{' r'externalService' '}', externalService.toString());
  ...
  Future<Response<ExternalService>> getExternalService({ 
    ...
    try {
            responseData = await _apiClient.deserializeAsync<ExternalService>(response.data!, 'ExternalService');
