...
,
  ...
  return OrganizationLinksLogo(
                  href: json[r'href'],
        iriTemplate: OrganizationLinksLogoIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<OrganizationLinksLogo> listFromJson(Iterable? json) {
    ...
    return json.fold(<OrganizationLinksLogo>[], (List<OrganizationLinksLogo> previousValue, element) {
      final OrganizationLinksLogo? object = OrganizationLinksLogo.fromJson(element);
  ...
  static Map<String, OrganizationLinksLogo> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OrganizationLinksLogo>{}, (Map<String, OrganizationLinksLogo> previousValue, element) {
      final OrganizationLinksLogo? object = OrganizationLinksLogo.fromJson(element.value);
      if (object is OrganizationLinksLogo) {
  ...
  static Map<String, List<OrganizationLinksLogo>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OrganizationLinksLogo>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OrganizationLinksLogo>>(key, OrganizationLinksLogo.listFromJson(value));
    });
  }

  @override
  String toString() => 'OrganizationLinksLogo[href=$href, iriTemplate=$iriTemplate]';
