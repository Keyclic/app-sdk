...
,
  ...
  static List<ProcedureLinksCreatedByIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<ProcedureLinksCreatedByIriTemplate>[], (List<ProcedureLinksCreatedByIriTemplate> previousValue, element) {
      final ProcedureLinksCreatedByIriTemplate? object = ProcedureLinksCreatedByIriTemplate.fromJson(element);
  ...
  static Map<String, ProcedureLinksCreatedByIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ProcedureLinksCreatedByIriTemplate>{};
    }

    return json.entries.fold(<String, ProcedureLinksCreatedByIriTemplate>{}, (Map<String, ProcedureLinksCreatedByIriTemplate> previousValue, element) {
      final ProcedureLinksCreatedByIriTemplate? object = ProcedureLinksCreatedByIriTemplate.fromJson(element.value);
      if (object is ProcedureLinksCreatedByIriTemplate) {
  ...
  static Map<String, List<ProcedureLinksCreatedByIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ProcedureLinksCreatedByIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ProcedureLinksCreatedByIriTemplate>>(key, ProcedureLinksCreatedByIriTemplate.listFromJson(value));
    });
  }
