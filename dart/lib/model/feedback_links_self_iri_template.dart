...
,
  ...
  static List<FeedbackLinksSelfIriTemplate> listFromJson(Iterable? json) {
    if (json == null) {
      return <FeedbackLinksSelfIriTemplate>[];
    }

    return json.fold(<FeedbackLinksSelfIriTemplate>[], (List<FeedbackLinksSelfIriTemplate> previousValue, element) {
      final FeedbackLinksSelfIriTemplate? object = FeedbackLinksSelfIriTemplate.fromJson(element);
  ...
  static Map<String, FeedbackLinksSelfIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, FeedbackLinksSelfIriTemplate>{}, (Map<String, FeedbackLinksSelfIriTemplate> previousValue, element) {
      final FeedbackLinksSelfIriTemplate? object = FeedbackLinksSelfIriTemplate.fromJson(element.value);
      if (object is FeedbackLinksSelfIriTemplate) {
  ...
  static Map<String, List<FeedbackLinksSelfIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<FeedbackLinksSelfIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<FeedbackLinksSelfIriTemplate>>(key, FeedbackLinksSelfIriTemplate.listFromJson(value));
    });
  }
