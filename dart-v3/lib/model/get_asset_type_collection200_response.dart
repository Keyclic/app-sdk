...
,
  ...
  return GetAssetTypeCollection200Response(
        embedded: GetAssetTypeCollection200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetAssetTypeCollection200Response> listFromJson(Iterable? json) {
    ...
    return json.fold(<GetAssetTypeCollection200Response>[], (List<GetAssetTypeCollection200Response> previousValue, element) {
      final GetAssetTypeCollection200Response? object = GetAssetTypeCollection200Response.fromJson(element);
  ...
  static Map<String, GetAssetTypeCollection200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetAssetTypeCollection200Response>{};
    }

    return json.entries.fold(<String, GetAssetTypeCollection200Response>{}, (Map<String, GetAssetTypeCollection200Response> previousValue, element) {
      final GetAssetTypeCollection200Response? object = GetAssetTypeCollection200Response.fromJson(element.value);
      if (object is GetAssetTypeCollection200Response) {
  ...
  static Map<String, List<GetAssetTypeCollection200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetAssetTypeCollection200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetAssetTypeCollection200Response>>(key, GetAssetTypeCollection200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetAssetTypeCollection200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
