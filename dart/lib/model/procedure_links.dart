...
,
  ...
  static ProcedureLinks? fromJson(Object? json) {
  ...
  static List<ProcedureLinks> listFromJson(Iterable? json) {
    ...
    return json.fold(<ProcedureLinks>[], (List<ProcedureLinks> previousValue, element) {
  ...
  static Map<String, ProcedureLinks> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ProcedureLinks>{}, (Map<String, ProcedureLinks> previousValue, element) {
  ...
  static Map<String, List<ProcedureLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ProcedureLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ProcedureLinks>>(key, ProcedureLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'ProcedureLinks[createdBy=$createdBy, document=$document, self=$self]';
