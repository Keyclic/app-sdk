...
,
  ...
  static List<WorkflowTransition> listFromJson(Iterable? json) {
    ...
    return json.fold(<WorkflowTransition>[], (List<WorkflowTransition> previousValue, element) {
  ...
  static Map<String, WorkflowTransition> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, WorkflowTransition>{};
    }

    return json.entries.fold(<String, WorkflowTransition>{}, (Map<String, WorkflowTransition> previousValue, element) {
      final WorkflowTransition? object = WorkflowTransition.fromJson(element.value);
      if (object is WorkflowTransition) {
  ...
  static Map<String, List<WorkflowTransition>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<WorkflowTransition>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<WorkflowTransition>>(key, WorkflowTransition.listFromJson(value));
    });
  }

  @override
  String toString() => 'WorkflowTransition[fields=$fields, description=$description, from=$from, id=$id, name=$name, required_=$required_, to=$to, type=$type]';
