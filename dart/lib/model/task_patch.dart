...
,
  ...
  static List<TaskPatch> listFromJson(Iterable? json) {
    if (json == null) {
      return <TaskPatch>[];
    }
  ...
  static Map<String, TaskPatch> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, TaskPatch>{}, (Map<String, TaskPatch> previousValue, element) {
  ...
  static Map<String, List<TaskPatch>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<TaskPatch>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<TaskPatch>>(key, TaskPatch.listFromJson(value));
    });
  }

  @override
  String toString() => 'TaskPatch[archived=$archived, category=$category, completed=$completed, description=$description, dueBy=$dueBy, identificationNumber=$identificationNumber, name=$name, priority=$priority, scheduledAt=$scheduledAt, tags=$tags]';
