...
class PlacePagination implements Pagination, PlacePaginationAllOf {
  ...
  static Map<String, PlacePagination> mapFromJson(Map<String, dynamic>? json) {
    ...
    final map = json.map((key, value) => MapEntry<String, PlacePagination?>(
        key, PlacePagination.fromJson(value)))
      ..removeWhere((_, value) => value != null);

    return map as Map<String, PlacePagination>;
  }
