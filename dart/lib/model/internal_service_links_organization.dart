...
,
  ...
  return InternalServiceLinksOrganization(
                  href: json[r'href'],
        iriTemplate: InternalServiceLinksOrganizationIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<InternalServiceLinksOrganization> listFromJson(Iterable? json) {
    ...
    return json.fold(<InternalServiceLinksOrganization>[], (List<InternalServiceLinksOrganization> previousValue, element) {
      final InternalServiceLinksOrganization? object = InternalServiceLinksOrganization.fromJson(element);
  ...
  static Map<String, InternalServiceLinksOrganization> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, InternalServiceLinksOrganization>{};
    }

    return json.entries.fold(<String, InternalServiceLinksOrganization>{}, (Map<String, InternalServiceLinksOrganization> previousValue, element) {
      final InternalServiceLinksOrganization? object = InternalServiceLinksOrganization.fromJson(element.value);
      if (object is InternalServiceLinksOrganization) {
  ...
  static Map<String, List<InternalServiceLinksOrganization>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<InternalServiceLinksOrganization>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<InternalServiceLinksOrganization>>(key, InternalServiceLinksOrganization.listFromJson(value));
    });
  }

  @override
  String toString() => 'InternalServiceLinksOrganization[href=$href, iriTemplate=$iriTemplate]';
