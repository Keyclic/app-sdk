...
,
  ...
  static List<BookmarkLinksPlace> listFromJson(Iterable? json) {
    ...
    return json.fold(<BookmarkLinksPlace>[], (List<BookmarkLinksPlace> previousValue, element) {
  ...
  static Map<String, BookmarkLinksPlace> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, BookmarkLinksPlace>{};
    }

    return json.entries.fold(<String, BookmarkLinksPlace>{}, (Map<String, BookmarkLinksPlace> previousValue, element) {
      final BookmarkLinksPlace? object = BookmarkLinksPlace.fromJson(element.value);
      if (object is BookmarkLinksPlace) {
  ...
  static Map<String, List<BookmarkLinksPlace>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<BookmarkLinksPlace>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<BookmarkLinksPlace>>(key, BookmarkLinksPlace.listFromJson(value));
    });
  }

  @override
  String toString() => 'BookmarkLinksPlace[href=$href, iriTemplate=$iriTemplate]';
