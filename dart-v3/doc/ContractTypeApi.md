# keyclic_sdk_api_platform.api.ContractTypeApi
...
# **getContractType**
> ContractTypeJsonhalRead getContractType(identifier, xKeyclicApp, xOrganizationId, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion)

Retrieves a ContractType resource.
...
final api_instance = ContractTypeApi();
...
try { 
    final result = api_instance.getContractType(identifier, xKeyclicApp, xOrganizationId, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion);
    print(result);
} catch (e) {
    print('Exception when calling ContractTypeApi->getContractType: $e\n');
}
```
...
[**ContractTypeJsonhalRead**](ContractTypeJsonhalRead.md)
