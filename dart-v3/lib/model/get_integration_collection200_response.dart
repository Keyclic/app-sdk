...
,
  ...
  return GetIntegrationCollection200Response(
        embedded: GetIntegrationCollection200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetIntegrationCollection200Response> listFromJson(Iterable? json) {
    if (json == null) {
      return <GetIntegrationCollection200Response>[];
    }

    return json.fold(<GetIntegrationCollection200Response>[], (List<GetIntegrationCollection200Response> previousValue, element) {
      final GetIntegrationCollection200Response? object = GetIntegrationCollection200Response.fromJson(element);
  ...
  static Map<String, GetIntegrationCollection200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetIntegrationCollection200Response>{};
    }

    return json.entries.fold(<String, GetIntegrationCollection200Response>{}, (Map<String, GetIntegrationCollection200Response> previousValue, element) {
      final GetIntegrationCollection200Response? object = GetIntegrationCollection200Response.fromJson(element.value);
      if (object is GetIntegrationCollection200Response) {
  ...
  static Map<String, List<GetIntegrationCollection200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetIntegrationCollection200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetIntegrationCollection200Response>>(key, GetIntegrationCollection200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetIntegrationCollection200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
