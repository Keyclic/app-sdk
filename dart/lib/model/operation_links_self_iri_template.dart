...
class OperationLinksSelfIriTemplate {
  ...
  static List<OperationLinksSelfIriTemplate> listFromJson(List<dynamic>? json) {
    ...
    return json
        ...
        .whereType<OperationLinksSelfIriTemplate>()
        .toList();
  }
  ...
  static Map<String, OperationLinksSelfIriTemplate> mapFromJson(
    ...
    final map = json.map((key, value) =>
        MapEntry<String, OperationLinksSelfIriTemplate?>(
            key, OperationLinksSelfIriTemplate.fromJson(value)))
      ..removeWhere((_, value) => value != null);

    return map as Map<String, OperationLinksSelfIriTemplate>;
  }
