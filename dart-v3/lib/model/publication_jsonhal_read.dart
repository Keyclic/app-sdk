...
,
  ...
  static List<PublicationJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<PublicationJsonhalRead>[], (List<PublicationJsonhalRead> previousValue, element) {
      final PublicationJsonhalRead? object = PublicationJsonhalRead.fromJson(element);
  ...
  static Map<String, PublicationJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, PublicationJsonhalRead>{};
    }

    return json.entries.fold(<String, PublicationJsonhalRead>{}, (Map<String, PublicationJsonhalRead> previousValue, element) {
      final PublicationJsonhalRead? object = PublicationJsonhalRead.fromJson(element.value);
      if (object is PublicationJsonhalRead) {
  ...
  static Map<String, List<PublicationJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PublicationJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PublicationJsonhalRead>>(key, PublicationJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'PublicationJsonhalRead[links=$links, message=$message, read=$read, title=$title, id=$id, createdAt=$createdAt, updatedAt=$updatedAt, embedded=$embedded]';
