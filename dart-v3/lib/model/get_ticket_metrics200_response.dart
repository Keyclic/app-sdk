...
,
  ...
  return GetTicketMetrics200Response(
        embedded: GetTicketMetrics200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetTicketMetrics200Response> listFromJson(Iterable? json) {
    ...
    return json.fold(<GetTicketMetrics200Response>[], (List<GetTicketMetrics200Response> previousValue, element) {
      final GetTicketMetrics200Response? object = GetTicketMetrics200Response.fromJson(element);
  ...
  static Map<String, GetTicketMetrics200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetTicketMetrics200Response>{};
    }

    return json.entries.fold(<String, GetTicketMetrics200Response>{}, (Map<String, GetTicketMetrics200Response> previousValue, element) {
      final GetTicketMetrics200Response? object = GetTicketMetrics200Response.fromJson(element.value);
      if (object is GetTicketMetrics200Response) {
  ...
  static Map<String, List<GetTicketMetrics200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetTicketMetrics200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetTicketMetrics200Response>>(key, GetTicketMetrics200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetTicketMetrics200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
