...
,
  ...
  return FeedbackLinksImages(
                  href: json[r'href'],
        iriTemplate: FeedbackLinksImagesIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<FeedbackLinksImages> listFromJson(Iterable? json) {
    if (json == null) {
      return <FeedbackLinksImages>[];
    }

    return json.fold(<FeedbackLinksImages>[], (List<FeedbackLinksImages> previousValue, element) {
  ...
  static Map<String, FeedbackLinksImages> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, FeedbackLinksImages>{}, (Map<String, FeedbackLinksImages> previousValue, element) {
      final FeedbackLinksImages? object = FeedbackLinksImages.fromJson(element.value);
      if (object is FeedbackLinksImages) {
  ...
  static Map<String, List<FeedbackLinksImages>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<FeedbackLinksImages>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<FeedbackLinksImages>>(key, FeedbackLinksImages.listFromJson(value));
    });
  }

  @override
  String toString() => 'FeedbackLinksImages[href=$href, iriTemplate=$iriTemplate]';
