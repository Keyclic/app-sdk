...
final api_instance = WorkflowApi();
final xKeyclicApp = xKeyclicApp_example; // String | 
final workflow = 38400000-8cf0-11bd-b23e-10b96e4ef00d; // String | The identifier of the resource.
...
try { 
    final result = api_instance.getWorkflow(xKeyclicApp, workflow, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion);
    print(result);
} catch (e) {
 ...
 **workflow** | **String**| The identifier of the resource. | 
