...
,
  ...
  return ConfigurationLinksSelfIriTemplate(
        mapping: ConfigurationLinksSelfIriTemplateMapping.fromJson(json[r'mapping']),
    );
  }
  ...
  static List<ConfigurationLinksSelfIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<ConfigurationLinksSelfIriTemplate>[], (List<ConfigurationLinksSelfIriTemplate> previousValue, element) {
      final ConfigurationLinksSelfIriTemplate? object = ConfigurationLinksSelfIriTemplate.fromJson(element);
  ...
  static Map<String, ConfigurationLinksSelfIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ConfigurationLinksSelfIriTemplate>{};
    }

    return json.entries.fold(<String, ConfigurationLinksSelfIriTemplate>{}, (Map<String, ConfigurationLinksSelfIriTemplate> previousValue, element) {
      final ConfigurationLinksSelfIriTemplate? object = ConfigurationLinksSelfIriTemplate.fromJson(element.value);
      if (object is ConfigurationLinksSelfIriTemplate) {
  ...
  static Map<String, List<ConfigurationLinksSelfIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ConfigurationLinksSelfIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ConfigurationLinksSelfIriTemplate>>(key, ConfigurationLinksSelfIriTemplate.listFromJson(value));
    });
  }
