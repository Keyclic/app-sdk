...
,
  ...
  static List<FeedbackGeoCoordinates> listFromJson(Iterable? json) {
    ...
    return json.fold(<FeedbackGeoCoordinates>[], (List<FeedbackGeoCoordinates> previousValue, element) {
      final FeedbackGeoCoordinates? object = FeedbackGeoCoordinates.fromJson(element);
  ...
  static Map<String, FeedbackGeoCoordinates> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, FeedbackGeoCoordinates>{}, (Map<String, FeedbackGeoCoordinates> previousValue, element) {
      final FeedbackGeoCoordinates? object = FeedbackGeoCoordinates.fromJson(element.value);
      if (object is FeedbackGeoCoordinates) {
  ...
  static Map<String, List<FeedbackGeoCoordinates>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<FeedbackGeoCoordinates>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<FeedbackGeoCoordinates>>(key, FeedbackGeoCoordinates.listFromJson(value));
    });
  }

  @override
  String toString() => 'FeedbackGeoCoordinates[elevation=$elevation, point=$point]';
