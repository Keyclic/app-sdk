...
,
  ...
  return OrganizationLinksConfiguration(
                  href: json[r'href'],
        iriTemplate: OrganizationLinksConfigurationIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<OrganizationLinksConfiguration> listFromJson(Iterable? json) {
    ...
    return json.fold(<OrganizationLinksConfiguration>[], (List<OrganizationLinksConfiguration> previousValue, element) {
      final OrganizationLinksConfiguration? object = OrganizationLinksConfiguration.fromJson(element);
  ...
  static Map<String, OrganizationLinksConfiguration> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, OrganizationLinksConfiguration>{};
    }

    return json.entries.fold(<String, OrganizationLinksConfiguration>{}, (Map<String, OrganizationLinksConfiguration> previousValue, element) {
      final OrganizationLinksConfiguration? object = OrganizationLinksConfiguration.fromJson(element.value);
      if (object is OrganizationLinksConfiguration) {
  ...
  static Map<String, List<OrganizationLinksConfiguration>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OrganizationLinksConfiguration>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OrganizationLinksConfiguration>>(key, OrganizationLinksConfiguration.listFromJson(value));
    });
  }

  @override
  String toString() => 'OrganizationLinksConfiguration[href=$href, iriTemplate=$iriTemplate]';
