...
,
  ...
  return AssignmentLinksMember(
                  href: json[r'href'],
        iriTemplate: AssignmentLinksMemberIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<AssignmentLinksMember> listFromJson(Iterable? json) {
    ...
    return json.fold(<AssignmentLinksMember>[], (List<AssignmentLinksMember> previousValue, element) {
      final AssignmentLinksMember? object = AssignmentLinksMember.fromJson(element);
  ...
  static Map<String, AssignmentLinksMember> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, AssignmentLinksMember>{};
    }

    return json.entries.fold(<String, AssignmentLinksMember>{}, (Map<String, AssignmentLinksMember> previousValue, element) {
      final AssignmentLinksMember? object = AssignmentLinksMember.fromJson(element.value);
      if (object is AssignmentLinksMember) {
  ...
  static Map<String, List<AssignmentLinksMember>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<AssignmentLinksMember>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<AssignmentLinksMember>>(key, AssignmentLinksMember.listFromJson(value));
    });
  }

  @override
  String toString() => 'AssignmentLinksMember[href=$href, iriTemplate=$iriTemplate]';
