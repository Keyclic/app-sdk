...
class TransitionState {
  ...
  static Map<String, TransitionState> mapFromJson(Map<String, dynamic>? json) {
    ...
    final map = json.map((key, value) => MapEntry<String, TransitionState?>(
        key, TransitionState.fromJson(value)))
      ..removeWhere((_, value) => value != null);

    return map as Map<String, TransitionState>;
  }
