...
,
  ...
  static List<OrganizationPatch> listFromJson(Iterable? json) {
    ...
    return json.fold(<OrganizationPatch>[], (List<OrganizationPatch> previousValue, element) {
  ...
  static Map<String, OrganizationPatch> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OrganizationPatch>{}, (Map<String, OrganizationPatch> previousValue, element) {
      final OrganizationPatch? object = OrganizationPatch.fromJson(element.value);
      if (object is OrganizationPatch) {
  ...
  static Map<String, List<OrganizationPatch>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OrganizationPatch>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OrganizationPatch>>(key, OrganizationPatch.listFromJson(value));
    });
  }

  @override
  String toString() => 'OrganizationPatch[address=$address, alternateName=$alternateName, archived=$archived, archivedAt=$archivedAt, description=$description, endDate=$endDate, logo=$logo, name=$name, preferences=$preferences, startDate=$startDate]';
