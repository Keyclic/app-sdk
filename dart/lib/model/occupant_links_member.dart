...
,
  ...
  return OccupantLinksMember(
                  href: json[r'href'],
        iriTemplate: OccupantLinksMemberIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<OccupantLinksMember> listFromJson(Iterable? json) {
    if (json == null) {
      return <OccupantLinksMember>[];
    }

    return json.fold(<OccupantLinksMember>[], (List<OccupantLinksMember> previousValue, element) {
  ...
  static Map<String, OccupantLinksMember> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, OccupantLinksMember>{};
    }

    return json.entries.fold(<String, OccupantLinksMember>{}, (Map<String, OccupantLinksMember> previousValue, element) {
      final OccupantLinksMember? object = OccupantLinksMember.fromJson(element.value);
      if (object is OccupantLinksMember) {
  ...
  static Map<String, List<OccupantLinksMember>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OccupantLinksMember>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OccupantLinksMember>>(key, OccupantLinksMember.listFromJson(value));
    });
  }

  @override
  String toString() => 'OccupantLinksMember[href=$href, iriTemplate=$iriTemplate]';
