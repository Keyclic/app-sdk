...
,
  ...
  static List<FeedbackLinksPlans> listFromJson(Iterable? json) {
    if (json == null) {
      return <FeedbackLinksPlans>[];
    }

    return json.fold(<FeedbackLinksPlans>[], (List<FeedbackLinksPlans> previousValue, element) {
  ...
  static Map<String, FeedbackLinksPlans> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, FeedbackLinksPlans>{};
    }

    return json.entries.fold(<String, FeedbackLinksPlans>{}, (Map<String, FeedbackLinksPlans> previousValue, element) {
      final FeedbackLinksPlans? object = FeedbackLinksPlans.fromJson(element.value);
      if (object is FeedbackLinksPlans) {
  ...
  static Map<String, List<FeedbackLinksPlans>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<FeedbackLinksPlans>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<FeedbackLinksPlans>>(key, FeedbackLinksPlans.listFromJson(value));
    });
  }

  @override
  String toString() => 'FeedbackLinksPlans[href=$href, iriTemplate=$iriTemplate]';
