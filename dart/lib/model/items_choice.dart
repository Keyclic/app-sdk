...
,
  ...
  static List<ItemsChoice> listFromJson(Iterable? json) {
    ...
    return json.fold(<ItemsChoice>[], (List<ItemsChoice> previousValue, element) {
  ...
  static Map<String, ItemsChoice> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ItemsChoice>{}, (Map<String, ItemsChoice> previousValue, element) {
  ...
  static Map<String, List<ItemsChoice>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ItemsChoice>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ItemsChoice>>(key, ItemsChoice.listFromJson(value));
    });
  }

  @override
  String toString() => 'ItemsChoice[default_=$default_, description=$description, enum_=$enum_, format=$format, id=$id, maxItems=$maxItems, minItems=$minItems, oneOf=$oneOf, propertyOrder=$propertyOrder, title=$title, type=$type]';
