...
> OperationPagination cgetOperationsByReport(xKeyclicApp, report, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion, assignedTo, assignedTos[], after, before, isNull, leaf, level, order, organization, organizations[], query, scheduledAtAfter, scheduledAtBefore, state, states[], page, limit)
...
try { 
    var result = api_instance.cgetOperationsByReport(xKeyclicApp, report, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion, assignedTo, assignedTos[], after, before, isNull, leaf, level, order, organization, organizations[], query, scheduledAtAfter, scheduledAtBefore, state, states[], page, limit);
    print(result);
} catch (e) {
