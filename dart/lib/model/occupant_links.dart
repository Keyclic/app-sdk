...
,
  ...
  static OccupantLinks? fromJson(Object? json) {
  ...
  static List<OccupantLinks> listFromJson(Iterable? json) {
    ...
    return json.fold(<OccupantLinks>[], (List<OccupantLinks> previousValue, element) {
  ...
  static Map<String, OccupantLinks> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OccupantLinks>{}, (Map<String, OccupantLinks> previousValue, element) {
  ...
  static Map<String, List<OccupantLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OccupantLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OccupantLinks>>(key, OccupantLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'OccupantLinks[member=$member, place=$place, self=$self]';
