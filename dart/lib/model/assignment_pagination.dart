...
,
  ...
  static List<AssignmentPagination> listFromJson(Iterable? json) {
    if (json == null) {
      return <AssignmentPagination>[];
    }

    return json.fold(<AssignmentPagination>[], (List<AssignmentPagination> previousValue, element) {
      final AssignmentPagination? object = AssignmentPagination.fromJson(element);
  ...
  static Map<String, AssignmentPagination> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, AssignmentPagination>{};
    }

    return json.entries.fold(<String, AssignmentPagination>{}, (Map<String, AssignmentPagination> previousValue, element) {
      final AssignmentPagination? object = AssignmentPagination.fromJson(element.value);
      if (object is AssignmentPagination) {
  ...
  static Map<String, List<AssignmentPagination>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<AssignmentPagination>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<AssignmentPagination>>(key, AssignmentPagination.listFromJson(value));
    });
  }

  @override
  String toString() => 'AssignmentPagination[limit=$limit, page=$page, pages=$pages, total=$total, links=$links, embedded=$embedded]';
