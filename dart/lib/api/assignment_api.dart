...
class AssignmentApi {
  ...
  /// Also see [Retrieve one Assignment resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  ...
  /// Throws [DioError] if API call or serialization fails
  /// Keyclic API documentation.
  /// Also see [Create one Assignment resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  Future<Response<Assignment>> postAssignment({
    ...
    final String path = r'/assignments';
    final options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        // to string ??
