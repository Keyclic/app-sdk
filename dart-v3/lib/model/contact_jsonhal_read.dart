...
,
  ...
  static List<ContactJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<ContactJsonhalRead>[], (List<ContactJsonhalRead> previousValue, element) {
  ...
  static Map<String, ContactJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ContactJsonhalRead>{};
    }

    return json.entries.fold(<String, ContactJsonhalRead>{}, (Map<String, ContactJsonhalRead> previousValue, element) {
      final ContactJsonhalRead? object = ContactJsonhalRead.fromJson(element.value);
      if (object is ContactJsonhalRead) {
  ...
  static Map<String, List<ContactJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ContactJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ContactJsonhalRead>>(key, ContactJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'ContactJsonhalRead[links=$links, id=$id, createdAt=$createdAt, updatedAt=$updatedAt, contactPoint=$contactPoint, type=$type, embedded=$embedded]';
