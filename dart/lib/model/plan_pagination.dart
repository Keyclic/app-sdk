...
,
  ...
  static List<PlanPagination> listFromJson(Iterable? json) {
    ...
    return json.fold(<PlanPagination>[], (List<PlanPagination> previousValue, element) {
  ...
  static Map<String, PlanPagination> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, PlanPagination>{}, (Map<String, PlanPagination> previousValue, element) {
  ...
  static Map<String, List<PlanPagination>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PlanPagination>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PlanPagination>>(key, PlanPagination.listFromJson(value));
    });
  }

  @override
  String toString() => 'PlanPagination[limit=$limit, page=$page, pages=$pages, total=$total, links=$links, embedded=$embedded]';
