...
,
  ...
  static List<MemberContactPoint> listFromJson(Iterable? json) {
    ...
    return json.fold(<MemberContactPoint>[], (List<MemberContactPoint> previousValue, element) {
  ...
  static Map<String, MemberContactPoint> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, MemberContactPoint>{};
    }

    return json.entries.fold(<String, MemberContactPoint>{}, (Map<String, MemberContactPoint> previousValue, element) {
      final MemberContactPoint? object = MemberContactPoint.fromJson(element.value);
      if (object is MemberContactPoint) {
  ...
  static Map<String, List<MemberContactPoint>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<MemberContactPoint>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<MemberContactPoint>>(key, MemberContactPoint.listFromJson(value));
    });
  }

  @override
  String toString() => 'MemberContactPoint[description=$description, email=$email, familyName=$familyName, faxNumber=$faxNumber, givenName=$givenName, isOpen=$isOpen, name=$name, telephone=$telephone]';
