...
,
  ...
  static Map<String, Occupant> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Occupant>{}, (Map<String, Occupant> previousValue, element) {
  ...
  static Map<String, List<Occupant>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<Occupant>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<Occupant>>(key, Occupant.listFromJson(value));
    });
  }

  @override
  String toString() => 'Occupant[embedded=$embedded, links=$links, createdAt=$createdAt, id=$id, type=$type, updatedAt=$updatedAt]';
