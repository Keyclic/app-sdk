...
,
  ...
  static List<CategoryLinksType> listFromJson(Iterable? json) {
    if (json == null) {
      return <CategoryLinksType>[];
    }

    return json.fold(<CategoryLinksType>[], (List<CategoryLinksType> previousValue, element) {
  ...
  static Map<String, CategoryLinksType> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, CategoryLinksType>{};
    }

    return json.entries.fold(<String, CategoryLinksType>{}, (Map<String, CategoryLinksType> previousValue, element) {
      final CategoryLinksType? object = CategoryLinksType.fromJson(element.value);
      if (object is CategoryLinksType) {
  ...
  static Map<String, List<CategoryLinksType>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<CategoryLinksType>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<CategoryLinksType>>(key, CategoryLinksType.listFromJson(value));
    });
  }

  @override
  String toString() => 'CategoryLinksType[href=$href, iriTemplate=$iriTemplate]';
