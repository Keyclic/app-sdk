...
,
  ...
  static Map<String, Service> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Service>{}, (Map<String, Service> previousValue, element) {
  ...
  @override
  String toString() => 'Service[address=$address, contactPoint=$contactPoint, createdAt=$createdAt, description=$description, id=$id, name=$name, onCall=$onCall, type=$type, updatedAt=$updatedAt]';
