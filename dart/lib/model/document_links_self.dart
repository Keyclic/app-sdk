...
,
  ...
  static List<DocumentLinksSelf> listFromJson(Iterable? json) {
    ...
    return json.fold(<DocumentLinksSelf>[], (List<DocumentLinksSelf> previousValue, element) {
  ...
  static Map<String, DocumentLinksSelf> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, DocumentLinksSelf>{}, (Map<String, DocumentLinksSelf> previousValue, element) {
      final DocumentLinksSelf? object = DocumentLinksSelf.fromJson(element.value);
      if (object is DocumentLinksSelf) {
  ...
  static Map<String, List<DocumentLinksSelf>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<DocumentLinksSelf>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<DocumentLinksSelf>>(key, DocumentLinksSelf.listFromJson(value));
    });
  }

  @override
  String toString() => 'DocumentLinksSelf[href=$href, iriTemplate=$iriTemplate]';
