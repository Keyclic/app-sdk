...
,
  ...
  static List<FormJsonhalOrganizationPreferenceRead> listFromJson(Iterable? json) {
    if (json == null) {
      return <FormJsonhalOrganizationPreferenceRead>[];
    }

    return json.fold(<FormJsonhalOrganizationPreferenceRead>[], (List<FormJsonhalOrganizationPreferenceRead> previousValue, element) {
      final FormJsonhalOrganizationPreferenceRead? object = FormJsonhalOrganizationPreferenceRead.fromJson(element);
  ...
  static Map<String, FormJsonhalOrganizationPreferenceRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, FormJsonhalOrganizationPreferenceRead>{};
    }

    return json.entries.fold(<String, FormJsonhalOrganizationPreferenceRead>{}, (Map<String, FormJsonhalOrganizationPreferenceRead> previousValue, element) {
      final FormJsonhalOrganizationPreferenceRead? object = FormJsonhalOrganizationPreferenceRead.fromJson(element.value);
      if (object is FormJsonhalOrganizationPreferenceRead) {
  ...
  static Map<String, List<FormJsonhalOrganizationPreferenceRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<FormJsonhalOrganizationPreferenceRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<FormJsonhalOrganizationPreferenceRead>>(key, FormJsonhalOrganizationPreferenceRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'FormJsonhalOrganizationPreferenceRead[contract=$contract, hidden=$hidden, manualDispatch=$manualDispatch, required_=$required_]';
