...
,
  ...
  static List<ServiceOfferJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<ServiceOfferJsonhalRead>[], (List<ServiceOfferJsonhalRead> previousValue, element) {
      final ServiceOfferJsonhalRead? object = ServiceOfferJsonhalRead.fromJson(element);
  ...
  static Map<String, ServiceOfferJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ServiceOfferJsonhalRead>{};
    }

    return json.entries.fold(<String, ServiceOfferJsonhalRead>{}, (Map<String, ServiceOfferJsonhalRead> previousValue, element) {
      final ServiceOfferJsonhalRead? object = ServiceOfferJsonhalRead.fromJson(element.value);
      if (object is ServiceOfferJsonhalRead) {
  ...
  static Map<String, List<ServiceOfferJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ServiceOfferJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ServiceOfferJsonhalRead>>(key, ServiceOfferJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'ServiceOfferJsonhalRead[links=$links, name=$name, id=$id, createdAt=$createdAt, updatedAt=$updatedAt]';
