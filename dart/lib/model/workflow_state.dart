...
,
  ...
  static List<WorkflowState> listFromJson(Iterable? json) {
    ...
    return json.fold(<WorkflowState>[], (List<WorkflowState> previousValue, element) {
  ...
  static Map<String, WorkflowState> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, WorkflowState>{}, (Map<String, WorkflowState> previousValue, element) {
  ...
  static Map<String, List<WorkflowState>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<WorkflowState>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<WorkflowState>>(key, WorkflowState.listFromJson(value));
    });
  }

  @override
  String toString() => 'WorkflowState[allowAdd=$allowAdd, allowDispatch=$allowDispatch, backgroundColor=$backgroundColor, color=$color, description=$description, end=$end, id=$id, name=$name, progression=$progression, reference=$reference, type=$type]';
