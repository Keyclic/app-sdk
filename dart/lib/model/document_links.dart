...
,
  ...
  static List<DocumentLinks> listFromJson(Iterable? json) {
    ...
    return json.fold(<DocumentLinks>[], (List<DocumentLinks> previousValue, element) {
  ...
  static Map<String, DocumentLinks> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, DocumentLinks>{}, (Map<String, DocumentLinks> previousValue, element) {
  ...
  static Map<String, List<DocumentLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<DocumentLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<DocumentLinks>>(key, DocumentLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'DocumentLinks[createdBy=$createdBy, file=$file, procedure=$procedure, self=$self]';
