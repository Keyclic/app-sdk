...
,
  ...
  return OperationLinksReport(
                  href: json[r'href'],
        iriTemplate: OperationLinksReportIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<OperationLinksReport> listFromJson(Iterable? json) {
    ...
    return json.fold(<OperationLinksReport>[], (List<OperationLinksReport> previousValue, element) {
      final OperationLinksReport? object = OperationLinksReport.fromJson(element);
  ...
  static Map<String, OperationLinksReport> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OperationLinksReport>{}, (Map<String, OperationLinksReport> previousValue, element) {
      final OperationLinksReport? object = OperationLinksReport.fromJson(element.value);
      if (object is OperationLinksReport) {
  ...
  static Map<String, List<OperationLinksReport>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OperationLinksReport>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OperationLinksReport>>(key, OperationLinksReport.listFromJson(value));
    });
  }

  @override
  String toString() => 'OperationLinksReport[href=$href, iriTemplate=$iriTemplate]';
