...
,
  ...
  static List<PublicationJsonhalReadEmbedded> listFromJson(Iterable? json) {
    ...
    return json.fold(<PublicationJsonhalReadEmbedded>[], (List<PublicationJsonhalReadEmbedded> previousValue, element) {
      final PublicationJsonhalReadEmbedded? object = PublicationJsonhalReadEmbedded.fromJson(element);
  ...
  static Map<String, PublicationJsonhalReadEmbedded> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, PublicationJsonhalReadEmbedded>{};
    }

    return json.entries.fold(<String, PublicationJsonhalReadEmbedded>{}, (Map<String, PublicationJsonhalReadEmbedded> previousValue, element) {
      final PublicationJsonhalReadEmbedded? object = PublicationJsonhalReadEmbedded.fromJson(element.value);
      if (object is PublicationJsonhalReadEmbedded) {
  ...
  static Map<String, List<PublicationJsonhalReadEmbedded>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PublicationJsonhalReadEmbedded>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PublicationJsonhalReadEmbedded>>(key, PublicationJsonhalReadEmbedded.listFromJson(value));
    });
  }

  @override
  String toString() => 'PublicationJsonhalReadEmbedded[author=$author, place=$place]';
