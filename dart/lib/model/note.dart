...
,
  ...
  static Map<String, Note> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Note>{}, (Map<String, Note> previousValue, element) {
  ...
  @override
  String toString() => 'Note[links=$links, createdAt=$createdAt, id=$id, text=$text, type=$type, updatedAt=$updatedAt]';
