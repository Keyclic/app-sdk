...
,
  ...
  static List<BusinessActivity> listFromJson(Iterable? json) {
    ...
    return json.fold(<BusinessActivity>[], (List<BusinessActivity> previousValue, element) {
  ...
  static Map<String, BusinessActivity> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, BusinessActivity>{}, (Map<String, BusinessActivity> previousValue, element) {
  ...
  static Map<String, List<BusinessActivity>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<BusinessActivity>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<BusinessActivity>>(key, BusinessActivity.listFromJson(value));
    });
  }

  @override
  String toString() => 'BusinessActivity[links=$links, alternateName=$alternateName, createdAt=$createdAt, id=$id, metadataSchema=$metadataSchema, name=$name, type=$type, updatedAt=$updatedAt]';
  ...
  Map<String, dynamic> toJson([Iterable<String>? keys]) {
    ...
    contains(r'id')
        ...
        r'id':
          id,
    if (keys == null || keys.
    any((key) => RegExp(r'^metadataSchema\.').hasMatch(key))
    )
        r'metadataSchema':
            metadataSchema?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
