...
,
  ...
  static Map<String, PlaceLinks> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, PlaceLinks>{}, (Map<String, PlaceLinks> previousValue, element) {
  ...
  static Map<String, List<PlaceLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PlaceLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PlaceLinks>>(key, PlaceLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'PlaceLinks[children=$children, geo=$geo, organization=$organization, plans=$plans, self=$self]';
  ...
  Map<String, dynamic> toJson([Iterable<String>? keys]) {
    ...
    if (keys == null || keys.
    any((key) => RegExp(r'^plans\.').hasMatch(key))
    )
        r'plans':
            plans?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
