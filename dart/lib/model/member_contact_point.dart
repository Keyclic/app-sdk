...
class MemberContactPoint {
  ...
  @override
  String toString() {
    return 'MemberContactPoint[description=$description, email=$email, familyName=$familyName, faxNumber=$faxNumber, givenName=$givenName, isOpen=$isOpen, name=$name, telephone=$telephone, ]';
  }
}
