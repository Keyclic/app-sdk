...
class BusinessActivityApi {
  ...
  /// Also see [Retrieve all BusinessActivity resources. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  Future<Response<BusinessActivityPagination>> cgetBusinessActivities({
    ...
    final String path = r'/business-activities';
  ...
  /// Throws [DioError] if API call or serialization fails
  /// Keyclic API documentation.
  /// Also see [Retrieve one BusinessActivity resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  ...
  /// Throws [DioError] if API call or serialization fails
  /// Keyclic API documentation.
  /// Also see [Retrieve one Schema resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
