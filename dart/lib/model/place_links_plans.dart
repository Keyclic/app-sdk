...
,
  ...
  static List<PlaceLinksPlans> listFromJson(Iterable? json) {
    ...
    return json.fold(<PlaceLinksPlans>[], (List<PlaceLinksPlans> previousValue, element) {
  ...
  static Map<String, PlaceLinksPlans> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, PlaceLinksPlans>{}, (Map<String, PlaceLinksPlans> previousValue, element) {
  ...
  static Map<String, List<PlaceLinksPlans>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PlaceLinksPlans>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PlaceLinksPlans>>(key, PlaceLinksPlans.listFromJson(value));
    });
  }
