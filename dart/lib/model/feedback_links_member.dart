...
,
  ...
  return FeedbackLinksMember(
                  href: json[r'href'],
        iriTemplate: FeedbackLinksMemberIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<FeedbackLinksMember> listFromJson(Iterable? json) {
    ...
    return json.fold(<FeedbackLinksMember>[], (List<FeedbackLinksMember> previousValue, element) {
  ...
  static Map<String, FeedbackLinksMember> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, FeedbackLinksMember>{};
    }

    return json.entries.fold(<String, FeedbackLinksMember>{}, (Map<String, FeedbackLinksMember> previousValue, element) {
      final FeedbackLinksMember? object = FeedbackLinksMember.fromJson(element.value);
      if (object is FeedbackLinksMember) {
  ...
  static Map<String, List<FeedbackLinksMember>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<FeedbackLinksMember>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<FeedbackLinksMember>>(key, FeedbackLinksMember.listFromJson(value));
    });
  }

  @override
  String toString() => 'FeedbackLinksMember[href=$href, iriTemplate=$iriTemplate]';
