...
,
  ...
  static BookmarkLinks? fromJson(Object? json) {
  ...
  static List<BookmarkLinks> listFromJson(Iterable? json) {
    ...
    return json.fold(<BookmarkLinks>[], (List<BookmarkLinks> previousValue, element) {
  ...
  static Map<String, BookmarkLinks> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, BookmarkLinks>{}, (Map<String, BookmarkLinks> previousValue, element) {
  ...
  static Map<String, List<BookmarkLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<BookmarkLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<BookmarkLinks>>(key, BookmarkLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'BookmarkLinks[member=$member, place=$place, self=$self]';
