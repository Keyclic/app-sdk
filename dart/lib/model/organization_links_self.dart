...
,
  ...
  return OrganizationLinksSelf(
                  href: json[r'href'],
        iriTemplate: OrganizationLinksSelfIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<OrganizationLinksSelf> listFromJson(Iterable? json) {
    ...
    return json.fold(<OrganizationLinksSelf>[], (List<OrganizationLinksSelf> previousValue, element) {
      final OrganizationLinksSelf? object = OrganizationLinksSelf.fromJson(element);
  ...
  static Map<String, OrganizationLinksSelf> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OrganizationLinksSelf>{}, (Map<String, OrganizationLinksSelf> previousValue, element) {
      final OrganizationLinksSelf? object = OrganizationLinksSelf.fromJson(element.value);
      if (object is OrganizationLinksSelf) {
  ...
  static Map<String, List<OrganizationLinksSelf>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OrganizationLinksSelf>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OrganizationLinksSelf>>(key, OrganizationLinksSelf.listFromJson(value));
    });
  }

  @override
  String toString() => 'OrganizationLinksSelf[href=$href, iriTemplate=$iriTemplate]';
