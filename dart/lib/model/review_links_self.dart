...
,
  ...
  static List<ReviewLinksSelf> listFromJson(Iterable? json) {
    ...
    return json.fold(<ReviewLinksSelf>[], (List<ReviewLinksSelf> previousValue, element) {
  ...
  static Map<String, ReviewLinksSelf> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ReviewLinksSelf>{}, (Map<String, ReviewLinksSelf> previousValue, element) {
  ...
  static Map<String, List<ReviewLinksSelf>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReviewLinksSelf>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReviewLinksSelf>>(key, ReviewLinksSelf.listFromJson(value));
    });
  }
