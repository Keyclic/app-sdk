...
,
  ...
  static List<Contribution> listFromJson(Iterable? json) {
    ...
    return json.fold(<Contribution>[], (List<Contribution> previousValue, element) {
  ...
  static Map<String, Contribution> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Contribution>{}, (Map<String, Contribution> previousValue, element) {
  ...
  static Map<String, List<Contribution>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<Contribution>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<Contribution>>(key, Contribution.listFromJson(value));
    });
  }

  @override
  String toString() => 'Contribution[embedded=$embedded, links=$links, createdAt=$createdAt, id=$id, type=$type, updatedAt=$updatedAt]';
