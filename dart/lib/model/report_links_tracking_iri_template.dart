...
,
  ...
  static List<ReportLinksTrackingIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<ReportLinksTrackingIriTemplate>[], (List<ReportLinksTrackingIriTemplate> previousValue, element) {
      final ReportLinksTrackingIriTemplate? object = ReportLinksTrackingIriTemplate.fromJson(element);
  ...
  static Map<String, ReportLinksTrackingIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ReportLinksTrackingIriTemplate>{};
    }

    return json.entries.fold(<String, ReportLinksTrackingIriTemplate>{}, (Map<String, ReportLinksTrackingIriTemplate> previousValue, element) {
      final ReportLinksTrackingIriTemplate? object = ReportLinksTrackingIriTemplate.fromJson(element.value);
      if (object is ReportLinksTrackingIriTemplate) {
  ...
  static Map<String, List<ReportLinksTrackingIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReportLinksTrackingIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReportLinksTrackingIriTemplate>>(key, ReportLinksTrackingIriTemplate.listFromJson(value));
    });
  }
