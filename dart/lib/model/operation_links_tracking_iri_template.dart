...
,
  ...
  static List<OperationLinksTrackingIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<OperationLinksTrackingIriTemplate>[], (List<OperationLinksTrackingIriTemplate> previousValue, element) {
      final OperationLinksTrackingIriTemplate? object = OperationLinksTrackingIriTemplate.fromJson(element);
  ...
  static Map<String, OperationLinksTrackingIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, OperationLinksTrackingIriTemplate>{};
    }

    return json.entries.fold(<String, OperationLinksTrackingIriTemplate>{}, (Map<String, OperationLinksTrackingIriTemplate> previousValue, element) {
      final OperationLinksTrackingIriTemplate? object = OperationLinksTrackingIriTemplate.fromJson(element.value);
      if (object is OperationLinksTrackingIriTemplate) {
  ...
  static Map<String, List<OperationLinksTrackingIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OperationLinksTrackingIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OperationLinksTrackingIriTemplate>>(key, OperationLinksTrackingIriTemplate.listFromJson(value));
    });
  }
