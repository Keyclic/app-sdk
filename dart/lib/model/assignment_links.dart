...
,
  ...
  static List<AssignmentLinks> listFromJson(Iterable? json) {
    ...
    return json.fold(<AssignmentLinks>[], (List<AssignmentLinks> previousValue, element) {
  ...
  static Map<String, AssignmentLinks> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, AssignmentLinks>{}, (Map<String, AssignmentLinks> previousValue, element) {
  ...
  static Map<String, List<AssignmentLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<AssignmentLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<AssignmentLinks>>(key, AssignmentLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'AssignmentLinks[contract=$contract, member=$member, report=$report, self=$self, service=$service]';
