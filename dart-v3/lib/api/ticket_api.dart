...
class TicketApi {
    ...
    final queryParameters = <String, dynamic>{
      ...
      if (existsLeftSquareBracketDocumentsRightSquareBracket != null)
        r'exists[documents]': encodeQueryParameter(
            existsLeftSquareBracketDocumentsRightSquareBracket),
      if (existsLeftSquareBracketFeedbackPeriodGeoCoordinatesPeriodPointRightSquareBracket !=
          null)
  ...
  Future<Response<GetTicketGeoCollection200Response>> getTicketGeoCollection({
    ...
    try {
      responseData =
          await _apiClient.deserializeAsync<GetTicketGeoCollection200Response>(
              response.data!, 'GetTicketGeoCollection200Response');
    } catch (error, stackTrace) {
      throw DioException(
        error: error,
        requestOptions: response.requestOptions,
