...
,
  ...
  static List<AssetJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<AssetJsonhalRead>[], (List<AssetJsonhalRead> previousValue, element) {
  ...
  static Map<String, AssetJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, AssetJsonhalRead>{}, (Map<String, AssetJsonhalRead> previousValue, element) {
  ...
  static Map<String, List<AssetJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<AssetJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<AssetJsonhalRead>>(key, AssetJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'AssetJsonhalRead[links=$links, description=$description, name=$name, preferences=$preferences, id=$id, path=$path, address=$address, createdAt=$createdAt, updatedAt=$updatedAt]';
