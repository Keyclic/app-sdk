...
,
  ...
  static List<ServiceContactPoint> listFromJson(Iterable? json) {
    if (json == null) {
      return <ServiceContactPoint>[];
    }

    return json.fold(<ServiceContactPoint>[], (List<ServiceContactPoint> previousValue, element) {
  ...
  static Map<String, ServiceContactPoint> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ServiceContactPoint>{}, (Map<String, ServiceContactPoint> previousValue, element) {
      final ServiceContactPoint? object = ServiceContactPoint.fromJson(element.value);
      if (object is ServiceContactPoint) {
  ...
  static Map<String, List<ServiceContactPoint>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ServiceContactPoint>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ServiceContactPoint>>(key, ServiceContactPoint.listFromJson(value));
    });
  }

  @override
  String toString() => 'ServiceContactPoint[description=$description, email=$email, familyName=$familyName, faxNumber=$faxNumber, givenName=$givenName, isOpen=$isOpen, name=$name, telephone=$telephone]';
