...
,
  ...
  static List<TransitionState> listFromJson(Iterable? json) {
    ...
    return json.fold(<TransitionState>[], (List<TransitionState> previousValue, element) {
  ...
  static Map<String, TransitionState> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, TransitionState>{}, (Map<String, TransitionState> previousValue, element) {
  ...
  static Map<String, List<TransitionState>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<TransitionState>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<TransitionState>>(key, TransitionState.listFromJson(value));
    });
  }

  @override
  String toString() => 'TransitionState[allowAdd=$allowAdd, allowDispatch=$allowDispatch, backgroundColor=$backgroundColor, color=$color, description=$description, end=$end, id=$id, name=$name, progression=$progression, reference=$reference, type=$type]';
