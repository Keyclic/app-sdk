...
,
  ...
  bool operator ==(Object other) {
    ...
    return other is Application 
          ...
          && DeepCollectionEquality.unordered().equals(contactPoints, other.contactPoints)
  ...
  static List<Application> listFromJson(Iterable? json) {
    ...
    return json.fold(<Application>[], (List<Application> previousValue, element) {
  ...
  static Map<String, Application> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Application>{}, (Map<String, Application> previousValue, element) {
  ...
  static Map<String, List<Application>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<Application>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<Application>>(key, Application.listFromJson(value));
    });
  }

  @override
  String toString() => 'Application[links=$links, about=$about, agreement=$agreement, configuration=$configuration, contactPoints=$contactPoints, createdAt=$createdAt, id=$id, name=$name, token=$token, type=$type, updatedAt=$updatedAt, version=$version]';
