...
void main() {
  ...
  group('tests for ServiceApi', () {
    ...
    // Retrieves a Service resource.
    //
    //Future<ServiceJsonhalRead> getService(String identifier, String xKeyclicApp, { String acceptLanguage, DateTime xDateTime, String xKeyclicAppPlatform, String xKeyclicAppVersion }) async
