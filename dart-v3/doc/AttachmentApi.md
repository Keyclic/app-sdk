...
# **deleteAttachment**
> deleteAttachment(identifier, xKeyclicApp, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion)
...
try {
    api_instance.deleteAttachment(identifier, xKeyclicApp, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion);
} catch (e) {
...
# **getAttachment**
> AttachmentJsonhalRead getAttachment(identifier, xKeyclicApp, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion)
...
try {
    final result = api_instance.getAttachment(identifier, xKeyclicApp, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion);
    print(result);
} catch (e) {
...
# **getAttachments**
> GetAttachments200Response getAttachments(xKeyclicApp, page, limit, pagination, resourcePeriodIri, resourcePeriodIriLeftSquareBracketRightSquareBracket, attachedToPeriodIri, attachedToPeriodIriLeftSquareBracketRightSquareBracket, relation, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion)
...
try {
    final result = api_instance.getAttachments(xKeyclicApp, page, limit, pagination, resourcePeriodIri, resourcePeriodIriLeftSquareBracketRightSquareBracket, attachedToPeriodIri, attachedToPeriodIriLeftSquareBracketRightSquareBracket, relation, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion);
    print(result);
} catch (e) {
...
# **postAttachment**
> AttachmentJsonhalRead postAttachment(xKeyclicApp, attachmentCreateAttachmentCommandWrite, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion)
...
try {
    final result = api_instance.postAttachment(xKeyclicApp, attachmentCreateAttachmentCommandWrite, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion);
    print(result);
} catch (e) {
