...
,
  ...
  static List<TemplateData> listFromJson(Iterable? json) {
    ...
    return json.fold(<TemplateData>[], (List<TemplateData> previousValue, element) {
  ...
  static Map<String, TemplateData> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, TemplateData>{}, (Map<String, TemplateData> previousValue, element) {
  ...
  static Map<String, List<TemplateData>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<TemplateData>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<TemplateData>>(key, TemplateData.listFromJson(value));
    });
  }

  @override
  String toString() => 'TemplateData[body=$body, footer=$footer, header=$header, name=$name, organization=$organization, type=$type]';
