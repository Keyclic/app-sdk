...
,
  ...
  static List<RulePagination> listFromJson(Iterable? json) {
    if (json == null) {
      return <RulePagination>[];
    }

    return json.fold(<RulePagination>[], (List<RulePagination> previousValue, element) {
  ...
  static Map<String, RulePagination> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, RulePagination>{}, (Map<String, RulePagination> previousValue, element) {
  ...
  static Map<String, List<RulePagination>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<RulePagination>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<RulePagination>>(key, RulePagination.listFromJson(value));
    });
  }

  @override
  String toString() => 'RulePagination[limit=$limit, page=$page, pages=$pages, total=$total, links=$links, embedded=$embedded]';
