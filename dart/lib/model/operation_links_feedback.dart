...
,
  ...
  return OperationLinksFeedback(
                  href: json[r'href'],
        iriTemplate: OperationLinksFeedbackIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<OperationLinksFeedback> listFromJson(Iterable? json) {
    ...
    return json.fold(<OperationLinksFeedback>[], (List<OperationLinksFeedback> previousValue, element) {
      final OperationLinksFeedback? object = OperationLinksFeedback.fromJson(element);
  ...
  static Map<String, OperationLinksFeedback> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OperationLinksFeedback>{}, (Map<String, OperationLinksFeedback> previousValue, element) {
      final OperationLinksFeedback? object = OperationLinksFeedback.fromJson(element.value);
      if (object is OperationLinksFeedback) {
  ...
  static Map<String, List<OperationLinksFeedback>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OperationLinksFeedback>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OperationLinksFeedback>>(key, OperationLinksFeedback.listFromJson(value));
    });
  }

  @override
  String toString() => 'OperationLinksFeedback[href=$href, iriTemplate=$iriTemplate]';
