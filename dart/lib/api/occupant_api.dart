...
class OccupantApi {
  ...
  /// Parameters:
  /// * [xKeyclicApp]
  /// * [occupant] - The identifier of the resource.
  /// * [acceptLanguage]
  /// * [xDateTime]
  /// * [xKeyclicAppPlatform]
  /// * [xKeyclicAppVersion]
  ...
  /// Also see [Remove one Occupant resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  Future<Response<void>> deleteOccupant({
    ...
    final String path = r'/occupants/{occupant}'
        .replaceAll('{' r'occupant' '}', occupant.toString());
  ...
  /// Throws [DioError] if API call or serialization fails
  /// Keyclic API documentation.
  /// Also see [Retrieve one Occupant resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  ...
  /// Throws [DioError] if API call or serialization fails
  /// Keyclic API documentation.
  /// Also see [Create one Occupant resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  Future<Response<Occupant>> postOccupant({
    required String xKeyclicApp,
    required OccupantData occupantData,
    String? acceptLanguage,
    DateTime? xDateTime,
    String? xKeyclicAppPlatform,
    String? xKeyclicAppVersion,
