...
,
  ...
  static List<AssignmentLinksServiceIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<AssignmentLinksServiceIriTemplate>[], (List<AssignmentLinksServiceIriTemplate> previousValue, element) {
      final AssignmentLinksServiceIriTemplate? object = AssignmentLinksServiceIriTemplate.fromJson(element);
  ...
  static Map<String, AssignmentLinksServiceIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, AssignmentLinksServiceIriTemplate>{};
    }

    return json.entries.fold(<String, AssignmentLinksServiceIriTemplate>{}, (Map<String, AssignmentLinksServiceIriTemplate> previousValue, element) {
      final AssignmentLinksServiceIriTemplate? object = AssignmentLinksServiceIriTemplate.fromJson(element.value);
      if (object is AssignmentLinksServiceIriTemplate) {
  ...
  static Map<String, List<AssignmentLinksServiceIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<AssignmentLinksServiceIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<AssignmentLinksServiceIriTemplate>>(key, AssignmentLinksServiceIriTemplate.listFromJson(value));
    });
  }
