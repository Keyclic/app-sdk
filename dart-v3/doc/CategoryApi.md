...
final strategyLeftSquareBracketDispatcherBasedRightSquareBracketLeftSquareBracketPlaceRightSquareBracket = strategyLeftSquareBracketDispatcherBasedRightSquareBracketLeftSquareBracketPlaceRightSquareBracket_example; // String | Filter by dispatcher rules
final acceptLanguage = acceptLanguage_example; // String | 
final xDateTime = 2013-10-20T19:20:30+01:00; // DateTime | 
final xKeyclicAppPlatform = xKeyclicAppPlatform_example; // String | 
final xKeyclicAppVersion = xKeyclicAppVersion_example; // String | 
...
try {
    final result = api_instance.getCategoryCollection(xKeyclicApp, xOrganizationId, page, limit, pagination, search, enabled, leaf, level, levelLeftSquareBracketRightSquareBracket, strategyLeftSquareBracketDispatcherBasedRightSquareBracketLeftSquareBracketPlaceRightSquareBracket, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion);
    print(result);
} catch (e) {
 ...
 **strategyLeftSquareBracketDispatcherBasedRightSquareBracketLeftSquareBracketPlaceRightSquareBracket** | **String**| Filter by dispatcher rules | [optional] 
 **acceptLanguage** | **String**|  | [optional] [default to 'en-US']
 **xDateTime** | **DateTime**|  | [optional] 
 **xKeyclicAppPlatform** | **String**|  | [optional] 
 **xKeyclicAppVersion** | **String**|  | [optional] 
