...
,
  ...
  static List<MetricJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<MetricJsonhalRead>[], (List<MetricJsonhalRead> previousValue, element) {
  ...
  static Map<String, MetricJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, MetricJsonhalRead>{};
    }

    return json.entries.fold(<String, MetricJsonhalRead>{}, (Map<String, MetricJsonhalRead> previousValue, element) {
      final MetricJsonhalRead? object = MetricJsonhalRead.fromJson(element.value);
      if (object is MetricJsonhalRead) {
  ...
  static Map<String, List<MetricJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<MetricJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<MetricJsonhalRead>>(key, MetricJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'MetricJsonhalRead[links=$links, duration=$duration, name=$name]';
