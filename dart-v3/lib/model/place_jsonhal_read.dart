...
,
  ...
  static List<PlaceJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<PlaceJsonhalRead>[], (List<PlaceJsonhalRead> previousValue, element) {
  ...
  static Map<String, PlaceJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, PlaceJsonhalRead>{}, (Map<String, PlaceJsonhalRead> previousValue, element) {
  ...
  static Map<String, List<PlaceJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PlaceJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PlaceJsonhalRead>>(key, PlaceJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'PlaceJsonhalRead[links=$links, branchCode=$branchCode, id=$id, createdAt=$createdAt, updatedAt=$updatedAt, description=$description, name=$name, preferences=$preferences, path=$path, address=$address]';
