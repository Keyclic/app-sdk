...
class SectionApi {
  ...
  Future<Response<Section>> getSection({ 
    ...
    final String path = r'/sections/{section}'.replaceAll('{' r'section' '}', section.toString());
    ...
    try {
            responseData = await _apiClient.deserializeAsync<Section>(response.data!, 'Section');
