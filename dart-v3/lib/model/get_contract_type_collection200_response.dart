...
,
  ...
  return GetContractTypeCollection200Response(
        embedded: GetContractTypeCollection200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetContractTypeCollection200Response> listFromJson(Iterable? json) {
    if (json == null) {
      return <GetContractTypeCollection200Response>[];
    }

    return json.fold(<GetContractTypeCollection200Response>[], (List<GetContractTypeCollection200Response> previousValue, element) {
      final GetContractTypeCollection200Response? object = GetContractTypeCollection200Response.fromJson(element);
  ...
  static Map<String, GetContractTypeCollection200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetContractTypeCollection200Response>{};
    }

    return json.entries.fold(<String, GetContractTypeCollection200Response>{}, (Map<String, GetContractTypeCollection200Response> previousValue, element) {
      final GetContractTypeCollection200Response? object = GetContractTypeCollection200Response.fromJson(element.value);
      if (object is GetContractTypeCollection200Response) {
  ...
  static Map<String, List<GetContractTypeCollection200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetContractTypeCollection200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetContractTypeCollection200Response>>(key, GetContractTypeCollection200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetContractTypeCollection200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
