...
class TicketApi {
  ...
  Future<Response<void>> deleteTicket({ 
    ...
    final String path = r'/tickets/{identifier}'.replaceAll('{' r'identifier' '}', identifier.toString());
  ...
  Future<Response<TicketJsonhalRead>> getTicket({ 
    ...
    try {
            responseData = await _apiClient.deserializeAsync<TicketJsonhalRead>(response.data!, 'TicketJsonhalRead');
  ...
  Future<Response<GetTicketCollection200Response>> getTicketCollection({ 
    ...
    String? childrenPeriodScheduledAtLeftSquareBracketStrictlyBeforeRightSquareBracket,
    String? childrenPeriodScheduledAtLeftSquareBracketAfterRightSquareBracket,
    String? childrenPeriodScheduledAtLeftSquareBracketStrictlyAfterRightSquareBracket,
    ...
    bool? existsLeftSquareBracketFeedbackPeriodGeoCoordinatesPeriodPointRightSquareBracket,
    ...
    List<String>? assignmentsPeriodServicePeriodManagerLeftSquareBracketRightSquareBracket,
    String? category,
    ...
    List<String>? childrenPeriodAssignmentsPeriodMemberLeftSquareBracketRightSquareBracket,
    ...
    List<String>? treeLeftSquareBracketPlaceRightSquareBracketLeftSquareBracketAncestorsRightSquareBracketLeftSquareBracketRightSquareBracket,
    ...
    final queryParameters = <String, dynamic>{
      ...
      if (completed != null) r'completed':
        encodeQueryParameter(
        completed
        ),
      if (childrenPeriodScheduledAtLeftSquareBracketBeforeRightSquareBracket != null) r'children.scheduledAt[before]':
        encodeQueryParameter(
        childrenPeriodScheduledAtLeftSquareBracketBeforeRightSquareBracket
        ),
      if (childrenPeriodScheduledAtLeftSquareBracketStrictlyBeforeRightSquareBracket != null) r'children.scheduledAt[strictly_before]':
        encodeQueryParameter(
        childrenPeriodScheduledAtLeftSquareBracketStrictlyBeforeRightSquareBracket
        ),
      if (childrenPeriodScheduledAtLeftSquareBracketAfterRightSquareBracket != null) r'children.scheduledAt[after]':
        encodeQueryParameter(
        childrenPeriodScheduledAtLeftSquareBracketAfterRightSquareBracket
        ),
      if (childrenPeriodScheduledAtLeftSquareBracketStrictlyAfterRightSquareBracket != null) r'children.scheduledAt[strictly_after]':
        encodeQueryParameter(
        childrenPeriodScheduledAtLeftSquareBracketStrictlyAfterRightSquareBracket
        ),
      ...
      if (dueByLeftSquareBracketBeforeRightSquareBracket != null) r'dueBy[before]':
        encodeQueryParameter(
        dueByLeftSquareBracketBeforeRightSquareBracket
        ),
      if (dueByLeftSquareBracketStrictlyBeforeRightSquareBracket != null) r'dueBy[strictly_before]':
        encodeQueryParameter(
        dueByLeftSquareBracketStrictlyBeforeRightSquareBracket
        ),
      if (dueByLeftSquareBracketAfterRightSquareBracket != null) r'dueBy[after]':
        encodeQueryParameter(
        dueByLeftSquareBracketAfterRightSquareBracket
        ),
      if (dueByLeftSquareBracketStrictlyAfterRightSquareBracket != null) r'dueBy[strictly_after]':
        encodeQueryParameter(
        dueByLeftSquareBracketStrictlyAfterRightSquareBracket
        ),
      if (scheduledAtLeftSquareBracketBeforeRightSquareBracket != null) r'scheduledAt[before]':
        encodeQueryParameter(
        scheduledAtLeftSquareBracketBeforeRightSquareBracket
        ),
      if (scheduledAtLeftSquareBracketStrictlyBeforeRightSquareBracket != null) r'scheduledAt[strictly_before]':
        encodeQueryParameter(
        scheduledAtLeftSquareBracketStrictlyBeforeRightSquareBracket
        ),
      if (scheduledAtLeftSquareBracketAfterRightSquareBracket != null) r'scheduledAt[after]':
        encodeQueryParameter(
        scheduledAtLeftSquareBracketAfterRightSquareBracket
        ),
      if (scheduledAtLeftSquareBracketStrictlyAfterRightSquareBracket != null) r'scheduledAt[strictly_after]':
        encodeQueryParameter(
        scheduledAtLeftSquareBracketStrictlyAfterRightSquareBracket
        ),
      ...
      if (taskEquipments != null) r'task_equipments':
        encodeQueryParameter(
        taskEquipments
        ),
      if (taskEquipmentsLeftSquareBracketRightSquareBracket != null) r'task_equipments[]':
        encodeCollectionQueryParameter(
        taskEquipmentsLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      if (existsLeftSquareBracketArchivedAtRightSquareBracket != null) r'exists[archivedAt]':
        encodeQueryParameter(
        existsLeftSquareBracketArchivedAtRightSquareBracket
        ),
      if (existsLeftSquareBracketAssignmentsRightSquareBracket != null) r'exists[assignments]':
        encodeQueryParameter(
        existsLeftSquareBracketAssignmentsRightSquareBracket
        ),
      if (existsLeftSquareBracketDocumentsRightSquareBracket != null) r'exists[documents]':
        encodeQueryParameter(
        existsLeftSquareBracketDocumentsRightSquareBracket
        ),
      if (existsLeftSquareBracketFeedbackPeriodGeoCoordinatesPeriodPointRightSquareBracket != null) r'exists[feedback.geoCoordinates.point]':
        encodeQueryParameter(
        existsLeftSquareBracketFeedbackPeriodGeoCoordinatesPeriodPointRightSquareBracket
        ),
      if (existsLeftSquareBracketPriorityRightSquareBracket != null) r'exists[priority]':
        encodeQueryParameter(
        existsLeftSquareBracketPriorityRightSquareBracket
        ),
      ...
      if (operationStateAllLeftSquareBracketRightSquareBracket != null) r'operation_state_all[]':
        encodeCollectionQueryParameter(
        operationStateAllLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      if (orderLeftSquareBracketCategoryPeriodNameRightSquareBracket != null) r'order[category.name]':
        encodeQueryParameter(
        orderLeftSquareBracketCategoryPeriodNameRightSquareBracket
        ),
      ...
      if (orderLeftSquareBracketDueByRightSquareBracket != null) r'order[dueBy]':
        encodeQueryParameter(
        orderLeftSquareBracketDueByRightSquareBracket
        ),
      if (orderLeftSquareBracketPlacePeriodNameRightSquareBracket != null) r'order[place.name]':
        encodeQueryParameter(
        orderLeftSquareBracketPlacePeriodNameRightSquareBracket
        ),
      if (orderLeftSquareBracketPriorityPeriodPositionRightSquareBracket != null) r'order[priority.position]':
        encodeQueryParameter(
        orderLeftSquareBracketPriorityPeriodPositionRightSquareBracket
        ),
      if (orderLeftSquareBracketScheduledAtRightSquareBracket != null) r'order[scheduledAt]':
        encodeQueryParameter(
        orderLeftSquareBracketScheduledAtRightSquareBracket
        ),
      if (orderLeftSquareBracketStatePeriodNameRightSquareBracket != null) r'order[state.name]':
        encodeQueryParameter(
        orderLeftSquareBracketStatePeriodNameRightSquareBracket
        ),
      ...
      if (assignmentsPeriodMember != null) r'assignments.member':
        encodeQueryParameter(
        assignmentsPeriodMember
        ),
      if (assignmentsPeriodMemberLeftSquareBracketRightSquareBracket != null) r'assignments.member[]':
        encodeCollectionQueryParameter(
        assignmentsPeriodMemberLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      if (assignmentsPeriodService != null) r'assignments.service':
        encodeQueryParameter(
        assignmentsPeriodService
        ),
      if (assignmentsPeriodServiceLeftSquareBracketRightSquareBracket != null) r'assignments.service[]':
        encodeCollectionQueryParameter(
        assignmentsPeriodServiceLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      if (assignmentsPeriodServicePeriodManager != null) r'assignments.service.manager':
        encodeQueryParameter(
        assignmentsPeriodServicePeriodManager
        ),
      if (assignmentsPeriodServicePeriodManagerLeftSquareBracketRightSquareBracket != null) r'assignments.service.manager[]':
        encodeCollectionQueryParameter(
        assignmentsPeriodServicePeriodManagerLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      ...
      if (categoryLeftSquareBracketRightSquareBracket != null) r'category[]':
        encodeCollectionQueryParameter(
        categoryLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      if (categoryPeriodType != null) r'category.type':
        encodeQueryParameter(
        categoryPeriodType
        ),
      if (categoryPeriodTypeLeftSquareBracketRightSquareBracket != null) r'category.type[]':
        encodeCollectionQueryParameter(
        categoryPeriodTypeLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      if (childrenPeriodAssignmentsPeriodMember != null) r'children.assignments.member':
        encodeQueryParameter(
        childrenPeriodAssignmentsPeriodMember
        ),
      if (childrenPeriodAssignmentsPeriodMemberLeftSquareBracketRightSquareBracket != null) r'children.assignments.member[]':
        encodeCollectionQueryParameter(
        childrenPeriodAssignmentsPeriodMemberLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      if (childrenPeriodState != null) r'children.state':
        encodeQueryParameter(
        childrenPeriodState
        ),
      if (childrenPeriodStateLeftSquareBracketRightSquareBracket != null) r'children.state[]':
        encodeCollectionQueryParameter(
        childrenPeriodStateLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      if (createdBy != null) r'createdBy':
        encodeQueryParameter(
        createdBy
        ),
      if (createdByLeftSquareBracketRightSquareBracket != null) r'createdBy[]':
        encodeCollectionQueryParameter(
        createdByLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      if (equipments != null) r'equipments':
        encodeQueryParameter(
        equipments
        ),
      if (equipmentsLeftSquareBracketRightSquareBracket != null) r'equipments[]':
        encodeCollectionQueryParameter(
        equipmentsLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      if (feedbackPeriodBatch != null) r'feedback.batch':
        encodeQueryParameter(
        feedbackPeriodBatch
        ),
      if (feedbackPeriodBatchLeftSquareBracketRightSquareBracket != null) r'feedback.batch[]':
        encodeCollectionQueryParameter(
        feedbackPeriodBatchLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      if (feedbackPeriodMember != null) r'feedback.member':
        encodeQueryParameter(
        feedbackPeriodMember
        ),
      if (feedbackPeriodMemberLeftSquareBracketRightSquareBracket != null) r'feedback.member[]':
        encodeCollectionQueryParameter(
        feedbackPeriodMemberLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      if (feedbackPeriodVisibility != null) r'feedback.visibility':
        encodeQueryParameter(
        feedbackPeriodVisibility
        ),
      if (feedbackPeriodVisibilityLeftSquareBracketRightSquareBracket != null) r'feedback.visibility[]':
        encodeCollectionQueryParameter(
        feedbackPeriodVisibilityLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      ...
      if (phaseLeftSquareBracketRightSquareBracket != null) r'phase[]':
        encodeCollectionQueryParameter(
        phaseLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      ...
      if (placeLeftSquareBracketRightSquareBracket != null) r'place[]':
        encodeCollectionQueryParameter(
        placeLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      ...
      if (priorityLeftSquareBracketRightSquareBracket != null) r'priority[]':
        encodeCollectionQueryParameter(
        priorityLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      if (reviewsPeriodReviewRating != null) r'reviews.reviewRating':
        encodeQueryParameter(
        reviewsPeriodReviewRating
        ),
      if (reviewsPeriodReviewRatingLeftSquareBracketRightSquareBracket != null) r'reviews.reviewRating[]':
        encodeCollectionQueryParameter(
        reviewsPeriodReviewRatingLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      ...
      if (treeLeftSquareBracketPlaceRightSquareBracketLeftSquareBracketAncestorsRightSquareBracketLeftSquareBracketRightSquareBracket != null) r'tree[place][ancestors][]':
        encodeCollectionQueryParameter(
      ...
      if (treeLeftSquareBracketPlaceRightSquareBracketLeftSquareBracketDescendantsRightSquareBracketLeftSquareBracketRightSquareBracket != null) r'tree[place][descendants][]':
        encodeCollectionQueryParameter(
      ...
      if (treeLeftSquareBracketPlaceRightSquareBracketLeftSquareBracketNodeRightSquareBracketLeftSquareBracketRightSquareBracket != null) r'tree[place][node][]':
        encodeCollectionQueryParameter(
        treeLeftSquareBracketPlaceRightSquareBracketLeftSquareBracketNodeRightSquareBracketLeftSquareBracketRightSquareBracket,
        format: ListFormat.multi
        ),
      if (treeLeftSquareBracketPlaceRightSquareBracketLeftSquareBracketSubtreeRightSquareBracketLeftSquareBracketRightSquareBracket != null) r'tree[place][subtree][]':
        encodeCollectionQueryParameter(
    ...
    try {
            responseData = await _apiClient.deserializeAsync<GetTicketCollection200Response>(response.data!, 'GetTicketCollection200Response');
    } catch (error, stackTrace) {
      throw DioException(
        error: error,
        requestOptions: response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetTicketGeoCollection200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetTicketGeoCollection200Response>> getTicketGeoCollection({ 
    required String xKeyclicApp,
    required String xOrganizationId,
    int? page,
    int? limit,
    ...
    final String path = r'/tickets-geo';
    final options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        // to string ??
    ...
    GetTicketGeoCollection200Response responseData;

    try {
            responseData = await _apiClient.deserializeAsync<GetTicketGeoCollection200Response>(response.data!, 'GetTicketGeoCollection200Response');
    } catch (error, stackTrace) {
      throw DioException(
        error: error,
        requestOptions: response.requestOptions,
    ...
    return Response<GetTicketGeoCollection200Response>(
      data: responseData,
      headers: response.headers,
      isRedirect: response.isRedirect,
      requestOptions: response.requestOptions,
