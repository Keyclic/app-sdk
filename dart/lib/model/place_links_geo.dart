...
,
  ...
  static List<PlaceLinksGeo> listFromJson(Iterable? json) {
    ...
    return json.fold(<PlaceLinksGeo>[], (List<PlaceLinksGeo> previousValue, element) {
  ...
  static Map<String, PlaceLinksGeo> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, PlaceLinksGeo>{}, (Map<String, PlaceLinksGeo> previousValue, element) {
  ...
  static Map<String, List<PlaceLinksGeo>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PlaceLinksGeo>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PlaceLinksGeo>>(key, PlaceLinksGeo.listFromJson(value));
    });
  }
