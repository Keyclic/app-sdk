...
,
  ...
  return ExternalServiceLinksProvider(
                  href: json[r'href'],
        iriTemplate: ExternalServiceLinksProviderIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<ExternalServiceLinksProvider> listFromJson(Iterable? json) {
    ...
    return json.fold(<ExternalServiceLinksProvider>[], (List<ExternalServiceLinksProvider> previousValue, element) {
      final ExternalServiceLinksProvider? object = ExternalServiceLinksProvider.fromJson(element);
  ...
  static Map<String, ExternalServiceLinksProvider> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ExternalServiceLinksProvider>{};
    }

    return json.entries.fold(<String, ExternalServiceLinksProvider>{}, (Map<String, ExternalServiceLinksProvider> previousValue, element) {
      final ExternalServiceLinksProvider? object = ExternalServiceLinksProvider.fromJson(element.value);
      if (object is ExternalServiceLinksProvider) {
  ...
  static Map<String, List<ExternalServiceLinksProvider>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ExternalServiceLinksProvider>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ExternalServiceLinksProvider>>(key, ExternalServiceLinksProvider.listFromJson(value));
    });
  }

  @override
  String toString() => 'ExternalServiceLinksProvider[href=$href, iriTemplate=$iriTemplate]';
