# keyclic_sdk_api_platform.api.AssetTypeApi
...
# **getAssetType**
> AssetTypeJsonhalRead getAssetType(identifier, xKeyclicApp, xOrganizationId, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion)
...
final api_instance = AssetTypeApi();
...
try {
    final result = api_instance.getAssetType(identifier, xKeyclicApp, xOrganizationId, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion);
    print(result);
} catch (e) {
    print('Exception when calling AssetTypeApi->getAssetType: $e\n');
}
```
...
[**AssetTypeJsonhalRead**](AssetTypeJsonhalRead.md)
