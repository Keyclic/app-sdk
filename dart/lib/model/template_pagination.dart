...
,
  ...
  static List<TemplatePagination> listFromJson(Iterable? json) {
    ...
    return json.fold(<TemplatePagination>[], (List<TemplatePagination> previousValue, element) {
  ...
  static Map<String, TemplatePagination> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, TemplatePagination>{};
    }

    return json.entries.fold(<String, TemplatePagination>{}, (Map<String, TemplatePagination> previousValue, element) {
      final TemplatePagination? object = TemplatePagination.fromJson(element.value);
      if (object is TemplatePagination) {
  ...
  static Map<String, List<TemplatePagination>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<TemplatePagination>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<TemplatePagination>>(key, TemplatePagination.listFromJson(value));
    });
  }

  @override
  String toString() => 'TemplatePagination[limit=$limit, page=$page, pages=$pages, total=$total, links=$links, embedded=$embedded]';
