...
,
  ...
  static Map<String, RulePatch> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, RulePatch>{}, (Map<String, RulePatch> previousValue, element) {
  ...
  static Map<String, List<RulePatch>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<RulePatch>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<RulePatch>>(key, RulePatch.listFromJson(value));
    });
  }

  @override
  String toString() => 'RulePatch[category=$category, place=$place, service=$service]';
