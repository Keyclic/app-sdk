...
,
  ...
  return FeedbackLinksReport(
                  href: json[r'href'],
        iriTemplate: FeedbackLinksReportIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<FeedbackLinksReport> listFromJson(Iterable? json) {
    ...
    return json.fold(<FeedbackLinksReport>[], (List<FeedbackLinksReport> previousValue, element) {
  ...
  static Map<String, FeedbackLinksReport> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, FeedbackLinksReport>{};
    }

    return json.entries.fold(<String, FeedbackLinksReport>{}, (Map<String, FeedbackLinksReport> previousValue, element) {
      final FeedbackLinksReport? object = FeedbackLinksReport.fromJson(element.value);
      if (object is FeedbackLinksReport) {
  ...
  static Map<String, List<FeedbackLinksReport>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<FeedbackLinksReport>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<FeedbackLinksReport>>(key, FeedbackLinksReport.listFromJson(value));
    });
  }

  @override
  String toString() => 'FeedbackLinksReport[href=$href, iriTemplate=$iriTemplate]';
