...
,
  ...
  static MemberPagination? fromJson(Object? json) {
  ...
  static List<MemberPagination> listFromJson(Iterable? json) {
    if (json == null) {
      return <MemberPagination>[];
    }

    return json.fold(<MemberPagination>[], (List<MemberPagination> previousValue, element) {
  ...
  static Map<String, MemberPagination> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, MemberPagination>{}, (Map<String, MemberPagination> previousValue, element) {
  ...
  static Map<String, List<MemberPagination>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<MemberPagination>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<MemberPagination>>(key, MemberPagination.listFromJson(value));
    });
  }

  @override
  String toString() => 'MemberPagination[limit=$limit, page=$page, pages=$pages, total=$total, links=$links, embedded=$embedded]';
