...
,
  ...
  return CategoryJsonhalReadEmbedded(
        ...
        children: 
          CategoryJsonhalRead.listFromJson(json[r'children']),
    );
  }
  ...
  static List<CategoryJsonhalReadEmbedded> listFromJson(Iterable? json) {
    ...
    return json.fold(<CategoryJsonhalReadEmbedded>[], (List<CategoryJsonhalReadEmbedded> previousValue, element) {
      final CategoryJsonhalReadEmbedded? object = CategoryJsonhalReadEmbedded.fromJson(element);
  ...
  static Map<String, CategoryJsonhalReadEmbedded> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, CategoryJsonhalReadEmbedded>{};
    }

    return json.entries.fold(<String, CategoryJsonhalReadEmbedded>{}, (Map<String, CategoryJsonhalReadEmbedded> previousValue, element) {
      final CategoryJsonhalReadEmbedded? object = CategoryJsonhalReadEmbedded.fromJson(element.value);
      if (object is CategoryJsonhalReadEmbedded) {
  ...
  static Map<String, List<CategoryJsonhalReadEmbedded>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<CategoryJsonhalReadEmbedded>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<CategoryJsonhalReadEmbedded>>(key, CategoryJsonhalReadEmbedded.listFromJson(value));
    });
  }

  @override
  String toString() => 'CategoryJsonhalReadEmbedded[type=$type, children=$children]';
