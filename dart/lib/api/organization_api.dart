...
class OrganizationApi {
  ...
  Future<Response<ServicePagination>> cgetDispatchServicesByOrganization({ 
    ...
    final String path = r'/organizations/{organization}/dispatch-services'.replaceAll('{' r'organization' '}', organization.toString());
    ...
    try {
            responseData = await _apiClient.deserializeAsync<ServicePagination>(response.data!, 'ServicePagination');
  ...
  Future<Response<DocumentPagination>> cgetDocumentsByOrganization({ 
    ...
    final String path = r'/organizations/{organization}/documents'.replaceAll('{' r'organization' '}', organization.toString());
    final options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        // to string ??
  ...
  Future<Response<ExternalServicePagination>> cgetExternalServicesByOrganization({ 
    required String xKeyclicApp,
    required String organization,
    String? acceptLanguage,
    DateTime? xDateTime,
    ...
    final String path = r'/organizations/{organization}/external-services'.replaceAll('{' r'organization' '}', organization.toString());
    final options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        // to string ??
    ...
    try {
            responseData = await _apiClient.deserializeAsync<ExternalServicePagination>(response.data!, 'ExternalServicePagination');
    } catch (error, stackTrace) {
      throw DioException(
        error: error,
        requestOptions: response.requestOptions,
  ...
  Future<Response<InternalServicePagination>> cgetInternalServicesByOrganization({ 
    required String xKeyclicApp,
    required String organization,
    String? acceptLanguage,
    DateTime? xDateTime,
    ...
    final String path = r'/organizations/{organization}/internal-services'.replaceAll('{' r'organization' '}', organization.toString());
    final options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        // to string ??
    ...
    try {
            responseData = await _apiClient.deserializeAsync<InternalServicePagination>(response.data!, 'InternalServicePagination');
    } catch (error, stackTrace) {
      throw DioException(
        error: error,
        requestOptions: response.requestOptions,
  ...
  Future<Response<OperationPagination>> cgetOperationsByOrganization({ 
    ...
    final String path = r'/organizations/{organization}/operations'.replaceAll('{' r'organization' '}', organization.toString());
    final options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        // to string ??
  ...
  Future<Response<OrganizationPagination>> cgetOrganizations({ 
    ...
    final queryParameters = <String, dynamic>{
      ...
      if (disabledAt != null) r'disabledAt':
        encodeQueryParameter(
        disabledAt
        ),
    ...
    try {
            responseData = await _apiClient.deserializeAsync<OrganizationPagination>(response.data!, 'OrganizationPagination');
    } catch (error, stackTrace) {
      throw DioException(
        error: error,
        requestOptions: response.requestOptions,
  ...
  Future<Response<PlacePagination>> cgetPlacesByOrganization({ 
    ...
    final String path = r'/organizations/{organization}/places'.replaceAll('{' r'organization' '}', organization.toString());
    final options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        // to string ??
  ...
  Future<Response<ReportPagination>> cgetReportsByOrganization({ 
    ...
    final String path = r'/organizations/{organization}/reports'.replaceAll('{' r'organization' '}', organization.toString());
    final options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        // to string ??
    ...
    try {
            responseData = await _apiClient.deserializeAsync<ReportPagination>(response.data!, 'ReportPagination');
    } catch (error, stackTrace) {
      throw DioException(
        error: error,
        requestOptions: response.requestOptions,
  ...
  Future<Response<TemplatePagination>> cgetTemplatesByOrganization({ 
    ...
    final String path = r'/organizations/{organization}/templates'.replaceAll('{' r'organization' '}', organization.toString());
    final options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        // to string ??
    ...
    try {
            responseData = await _apiClient.deserializeAsync<TemplatePagination>(response.data!, 'TemplatePagination');
    } catch (error, stackTrace) {
      throw DioException(
        error: error,
        requestOptions: response.requestOptions,
  ...
  Future<Response<Chart>> getAnalyticByOrganization({ 
    ...
    final String path = r'/organizations/{organization}/analytics'.replaceAll('{' r'organization' '}', organization.toString());
    final options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        // to string ??
    ...
    final queryParameters = <String, dynamic>{
      ...
      if (optionsLeftSquareBracketPropertyRightSquareBracket != null) r'options[property]':
        encodeQueryParameter(
        optionsLeftSquareBracketPropertyRightSquareBracket
        ),
      if (optionsLeftSquareBracketSortRightSquareBracket != null) r'options[sort]':
        encodeQueryParameter(
        optionsLeftSquareBracketSortRightSquareBracket
        ),
    };
    ...
    try {
            responseData = await _apiClient.deserializeAsync<Chart>(response.data!, 'Chart');
    } catch (error, stackTrace) {
      throw DioException(
        error: error,
        requestOptions: response.requestOptions,
  ...
  Future<Response<Configuration>> getConfigurationByOrganization({ 
    ...
    final String path = r'/organizations/{organization}/configuration'.replaceAll('{' r'organization' '}', organization.toString());
    final options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        // to string ??
    ...
    try {
            responseData = await _apiClient.deserializeAsync<Configuration>(response.data!, 'Configuration');
    } catch (error, stackTrace) {
      throw DioException(
        error: error,
        requestOptions: response.requestOptions,
  ...
  Future<Response<Schema>> getFormByOrganization({ 
    ...
    final String path = r'/organizations/{organization}/form'.replaceAll('{' r'organization' '}', organization.toString());
    final options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        // to string ??
  ...
  Future<Response<Organization>> getOrganization({ 
    ...
    final String path = r'/organizations/{organization}'.replaceAll('{' r'organization' '}', organization.toString());
    final options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        // to string ??
    ...
    try {
            responseData = await _apiClient.deserializeAsync<Organization>(response.data!, 'Organization');
    } catch (error, stackTrace) {
      throw DioException(
        error: error,
        requestOptions: response.requestOptions,
