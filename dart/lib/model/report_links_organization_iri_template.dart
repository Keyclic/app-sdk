...
,
  ...
  static List<ReportLinksOrganizationIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<ReportLinksOrganizationIriTemplate>[], (List<ReportLinksOrganizationIriTemplate> previousValue, element) {
      final ReportLinksOrganizationIriTemplate? object = ReportLinksOrganizationIriTemplate.fromJson(element);
  ...
  static Map<String, ReportLinksOrganizationIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ReportLinksOrganizationIriTemplate>{};
    }

    return json.entries.fold(<String, ReportLinksOrganizationIriTemplate>{}, (Map<String, ReportLinksOrganizationIriTemplate> previousValue, element) {
      final ReportLinksOrganizationIriTemplate? object = ReportLinksOrganizationIriTemplate.fromJson(element.value);
      if (object is ReportLinksOrganizationIriTemplate) {
  ...
  static Map<String, List<ReportLinksOrganizationIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReportLinksOrganizationIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReportLinksOrganizationIriTemplate>>(key, ReportLinksOrganizationIriTemplate.listFromJson(value));
    });
  }
