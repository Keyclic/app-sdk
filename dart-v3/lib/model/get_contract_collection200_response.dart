...
,
  ...
  return GetContractCollection200Response(
        embedded: GetContractCollection200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetContractCollection200Response> listFromJson(Iterable? json) {
    if (json == null) {
      return <GetContractCollection200Response>[];
    }

    return json.fold(<GetContractCollection200Response>[], (List<GetContractCollection200Response> previousValue, element) {
      final GetContractCollection200Response? object = GetContractCollection200Response.fromJson(element);
  ...
  static Map<String, GetContractCollection200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetContractCollection200Response>{};
    }

    return json.entries.fold(<String, GetContractCollection200Response>{}, (Map<String, GetContractCollection200Response> previousValue, element) {
      final GetContractCollection200Response? object = GetContractCollection200Response.fromJson(element.value);
      if (object is GetContractCollection200Response) {
  ...
  static Map<String, List<GetContractCollection200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetContractCollection200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetContractCollection200Response>>(key, GetContractCollection200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetContractCollection200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
