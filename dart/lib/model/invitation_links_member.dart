...
,
  ...
  return InvitationLinksMember(
                  href: json[r'href'],
        iriTemplate: InvitationLinksMemberIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<InvitationLinksMember> listFromJson(Iterable? json) {
    ...
    return json.fold(<InvitationLinksMember>[], (List<InvitationLinksMember> previousValue, element) {
      final InvitationLinksMember? object = InvitationLinksMember.fromJson(element);
  ...
  static Map<String, InvitationLinksMember> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, InvitationLinksMember>{};
    }

    return json.entries.fold(<String, InvitationLinksMember>{}, (Map<String, InvitationLinksMember> previousValue, element) {
      final InvitationLinksMember? object = InvitationLinksMember.fromJson(element.value);
      if (object is InvitationLinksMember) {
  ...
  static Map<String, List<InvitationLinksMember>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<InvitationLinksMember>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<InvitationLinksMember>>(key, InvitationLinksMember.listFromJson(value));
    });
  }

  @override
  String toString() => 'InvitationLinksMember[href=$href, iriTemplate=$iriTemplate]';
