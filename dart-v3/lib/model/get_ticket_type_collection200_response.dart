...
,
  ...
  return GetTicketTypeCollection200Response(
        embedded: GetTicketTypeCollection200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetTicketTypeCollection200Response> listFromJson(Iterable? json) {
    if (json == null) {
      return <GetTicketTypeCollection200Response>[];
    }

    return json.fold(<GetTicketTypeCollection200Response>[], (List<GetTicketTypeCollection200Response> previousValue, element) {
      final GetTicketTypeCollection200Response? object = GetTicketTypeCollection200Response.fromJson(element);
  ...
  static Map<String, GetTicketTypeCollection200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetTicketTypeCollection200Response>{};
    }

    return json.entries.fold(<String, GetTicketTypeCollection200Response>{}, (Map<String, GetTicketTypeCollection200Response> previousValue, element) {
      final GetTicketTypeCollection200Response? object = GetTicketTypeCollection200Response.fromJson(element.value);
      if (object is GetTicketTypeCollection200Response) {
  ...
  static Map<String, List<GetTicketTypeCollection200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetTicketTypeCollection200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetTicketTypeCollection200Response>>(key, GetTicketTypeCollection200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetTicketTypeCollection200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
