...
,
  ...
  return GetBookmarkCollection200Response(
        embedded: GetBookmarkCollection200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetBookmarkCollection200Response> listFromJson(Iterable? json) {
    ...
    return json.fold(<GetBookmarkCollection200Response>[], (List<GetBookmarkCollection200Response> previousValue, element) {
      final GetBookmarkCollection200Response? object = GetBookmarkCollection200Response.fromJson(element);
  ...
  static Map<String, GetBookmarkCollection200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetBookmarkCollection200Response>{};
    }

    return json.entries.fold(<String, GetBookmarkCollection200Response>{}, (Map<String, GetBookmarkCollection200Response> previousValue, element) {
      final GetBookmarkCollection200Response? object = GetBookmarkCollection200Response.fromJson(element.value);
      if (object is GetBookmarkCollection200Response) {
  ...
  static Map<String, List<GetBookmarkCollection200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetBookmarkCollection200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetBookmarkCollection200Response>>(key, GetBookmarkCollection200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetBookmarkCollection200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
