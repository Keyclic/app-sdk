...
,
  ...
  static List<ReportPriority> listFromJson(Iterable? json) {
    ...
    return json.fold(<ReportPriority>[], (List<ReportPriority> previousValue, element) {
  ...
  static Map<String, ReportPriority> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ReportPriority>{}, (Map<String, ReportPriority> previousValue, element) {
  ...
  static Map<String, List<ReportPriority>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReportPriority>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReportPriority>>(key, ReportPriority.listFromJson(value));
    });
  }

  @override
  String toString() => 'ReportPriority[color=$color, id=$id, name=$name, position=$position, type=$type]';
