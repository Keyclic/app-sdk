...
,
  ...
  static List<PlaceLinksChildren> listFromJson(Iterable? json) {
    ...
    return json.fold(<PlaceLinksChildren>[], (List<PlaceLinksChildren> previousValue, element) {
  ...
  static Map<String, PlaceLinksChildren> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, PlaceLinksChildren>{};
    }

    return json.entries.fold(<String, PlaceLinksChildren>{}, (Map<String, PlaceLinksChildren> previousValue, element) {
      final PlaceLinksChildren? object = PlaceLinksChildren.fromJson(element.value);
      if (object is PlaceLinksChildren) {
  ...
  static Map<String, List<PlaceLinksChildren>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PlaceLinksChildren>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PlaceLinksChildren>>(key, PlaceLinksChildren.listFromJson(value));
    });
  }

  @override
  String toString() => 'PlaceLinksChildren[href=$href, iriTemplate=$iriTemplate]';
