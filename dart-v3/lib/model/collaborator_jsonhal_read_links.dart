...
,
  ...
  static List<CollaboratorJsonhalReadLinks> listFromJson(Iterable? json) {
    ...
    return json.fold(<CollaboratorJsonhalReadLinks>[], (List<CollaboratorJsonhalReadLinks> previousValue, element) {
      final CollaboratorJsonhalReadLinks? object = CollaboratorJsonhalReadLinks.fromJson(element);
  ...
  static Map<String, CollaboratorJsonhalReadLinks> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, CollaboratorJsonhalReadLinks>{};
    }

    return json.entries.fold(<String, CollaboratorJsonhalReadLinks>{}, (Map<String, CollaboratorJsonhalReadLinks> previousValue, element) {
      final CollaboratorJsonhalReadLinks? object = CollaboratorJsonhalReadLinks.fromJson(element.value);
      if (object is CollaboratorJsonhalReadLinks) {
  ...
  static Map<String, List<CollaboratorJsonhalReadLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<CollaboratorJsonhalReadLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<CollaboratorJsonhalReadLinks>>(key, CollaboratorJsonhalReadLinks.listFromJson(value));
    });
  }
