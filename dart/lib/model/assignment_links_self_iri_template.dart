...
,
  ...
  static List<AssignmentLinksSelfIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<AssignmentLinksSelfIriTemplate>[], (List<AssignmentLinksSelfIriTemplate> previousValue, element) {
      final AssignmentLinksSelfIriTemplate? object = AssignmentLinksSelfIriTemplate.fromJson(element);
  ...
  static Map<String, AssignmentLinksSelfIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, AssignmentLinksSelfIriTemplate>{};
    }

    return json.entries.fold(<String, AssignmentLinksSelfIriTemplate>{}, (Map<String, AssignmentLinksSelfIriTemplate> previousValue, element) {
      final AssignmentLinksSelfIriTemplate? object = AssignmentLinksSelfIriTemplate.fromJson(element.value);
      if (object is AssignmentLinksSelfIriTemplate) {
  ...
  static Map<String, List<AssignmentLinksSelfIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<AssignmentLinksSelfIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<AssignmentLinksSelfIriTemplate>>(key, AssignmentLinksSelfIriTemplate.listFromJson(value));
    });
  }
