...
,
  ...
  return PreferencesJsonhalOrganizationRead(
        archiving: ArchivingJsonhalOrganizationPreferenceRead.fromJson(json[r'archiving']),
        contract: ContractJsonhalOrganizationPreferenceRead.fromJson(json[r'contract']),
        equipment: EquipmentJsonhalOrganizationPreferenceRead.fromJson(json[r'equipment']),
        ...
        reference: ReferenceJsonhalOrganizationPreferenceRead.fromJson(json[r'reference']),
  ...
  static List<PreferencesJsonhalOrganizationRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<PreferencesJsonhalOrganizationRead>[], (List<PreferencesJsonhalOrganizationRead> previousValue, element) {
      final PreferencesJsonhalOrganizationRead? object = PreferencesJsonhalOrganizationRead.fromJson(element);
  ...
  static Map<String, PreferencesJsonhalOrganizationRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, PreferencesJsonhalOrganizationRead>{};
    }

    return json.entries.fold(<String, PreferencesJsonhalOrganizationRead>{}, (Map<String, PreferencesJsonhalOrganizationRead> previousValue, element) {
      final PreferencesJsonhalOrganizationRead? object = PreferencesJsonhalOrganizationRead.fromJson(element.value);
      if (object is PreferencesJsonhalOrganizationRead) {
  ...
  static Map<String, List<PreferencesJsonhalOrganizationRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PreferencesJsonhalOrganizationRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PreferencesJsonhalOrganizationRead>>(key, PreferencesJsonhalOrganizationRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'PreferencesJsonhalOrganizationRead[archiving=$archiving, contract=$contract, equipment=$equipment, feedbackParentPlace=$feedbackParentPlace, form=$form, offline=$offline, public=$public, reference=$reference, reverseGeocoding=$reverseGeocoding, review=$review, sla=$sla]';

  Map<String, dynamic> toJson([Iterable<String>? keys]) {
    return <String, dynamic>{
    if (keys == null || keys.
    any((key) => RegExp(r'^archiving\.').hasMatch(key))
    )
        r'archiving':
            archiving?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
    ...
    if (keys == null || keys.
    any((key) => RegExp(r'^equipment\.').hasMatch(key))
    )
        r'equipment':
            equipment?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
    ...
    if (keys == null || keys.
    contains(r'feedbackParentPlace')
    )
        r'feedbackParentPlace':
          feedbackParentPlace,
    if (keys == null || keys.
    any((key) => RegExp(r'^form\.').hasMatch(key))
    )
        r'form':
            form?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
    ...
    if (keys == null || keys.
    any((key) => RegExp(r'^sla\.').hasMatch(key))
    )
        r'sla':
            sla?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
