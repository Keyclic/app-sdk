...
,
  ...
  static Bookmark? fromJson(Object? json) {
  ...
  static List<Bookmark> listFromJson(Iterable? json) {
    if (json == null) {
      return <Bookmark>[];
    }
  ...
  static Map<String, Bookmark> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Bookmark>{}, (Map<String, Bookmark> previousValue, element) {
  ...
  static Map<String, List<Bookmark>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<Bookmark>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<Bookmark>>(key, Bookmark.listFromJson(value));
    });
  }

  @override
  String toString() => 'Bookmark[embedded=$embedded, links=$links, createdAt=$createdAt, id=$id, type=$type, updatedAt=$updatedAt]';
