...
,
  ...
  static List<OrganizationLinksLogoIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<OrganizationLinksLogoIriTemplate>[], (List<OrganizationLinksLogoIriTemplate> previousValue, element) {
      final OrganizationLinksLogoIriTemplate? object = OrganizationLinksLogoIriTemplate.fromJson(element);
  ...
  static Map<String, OrganizationLinksLogoIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, OrganizationLinksLogoIriTemplate>{};
    }

    return json.entries.fold(<String, OrganizationLinksLogoIriTemplate>{}, (Map<String, OrganizationLinksLogoIriTemplate> previousValue, element) {
      final OrganizationLinksLogoIriTemplate? object = OrganizationLinksLogoIriTemplate.fromJson(element.value);
      if (object is OrganizationLinksLogoIriTemplate) {
  ...
  static Map<String, List<OrganizationLinksLogoIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OrganizationLinksLogoIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OrganizationLinksLogoIriTemplate>>(key, OrganizationLinksLogoIriTemplate.listFromJson(value));
    });
  }
