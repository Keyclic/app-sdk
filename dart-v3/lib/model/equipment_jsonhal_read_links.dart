...
,
  ...
  static List<EquipmentJsonhalReadLinks> listFromJson(Iterable? json) {
    ...
    return json.fold(<EquipmentJsonhalReadLinks>[], (List<EquipmentJsonhalReadLinks> previousValue, element) {
      final EquipmentJsonhalReadLinks? object = EquipmentJsonhalReadLinks.fromJson(element);
  ...
  static Map<String, EquipmentJsonhalReadLinks> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, EquipmentJsonhalReadLinks>{};
    }

    return json.entries.fold(<String, EquipmentJsonhalReadLinks>{}, (Map<String, EquipmentJsonhalReadLinks> previousValue, element) {
      final EquipmentJsonhalReadLinks? object = EquipmentJsonhalReadLinks.fromJson(element.value);
      if (object is EquipmentJsonhalReadLinks) {
  ...
  static Map<String, List<EquipmentJsonhalReadLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<EquipmentJsonhalReadLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<EquipmentJsonhalReadLinks>>(key, EquipmentJsonhalReadLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'EquipmentJsonhalReadLinks[self=$self, brand=$brand, type=$type, parent=$parent, state=$state]';
  ...
  Map<String, dynamic> toJson([Iterable<String>? keys]) {
    ...
    if (keys == null || keys.
    any((key) => RegExp(r'^brand\.').hasMatch(key))
    )
        r'brand':
            brand?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
