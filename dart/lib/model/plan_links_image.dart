...
,
  ...
  static List<PlanLinksImage> listFromJson(Iterable? json) {
    if (json == null) {
      return <PlanLinksImage>[];
    }

    return json.fold(<PlanLinksImage>[], (List<PlanLinksImage> previousValue, element) {
  ...
  static Map<String, PlanLinksImage> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, PlanLinksImage>{}, (Map<String, PlanLinksImage> previousValue, element) {
  ...
  static Map<String, List<PlanLinksImage>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PlanLinksImage>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PlanLinksImage>>(key, PlanLinksImage.listFromJson(value));
    });
  }
