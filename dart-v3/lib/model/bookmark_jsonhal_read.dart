...
,
  ...
  static List<BookmarkJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<BookmarkJsonhalRead>[], (List<BookmarkJsonhalRead> previousValue, element) {
  ...
  static Map<String, BookmarkJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, BookmarkJsonhalRead>{};
    }

    return json.entries.fold(<String, BookmarkJsonhalRead>{}, (Map<String, BookmarkJsonhalRead> previousValue, element) {
      final BookmarkJsonhalRead? object = BookmarkJsonhalRead.fromJson(element.value);
      if (object is BookmarkJsonhalRead) {
  ...
  static Map<String, List<BookmarkJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<BookmarkJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<BookmarkJsonhalRead>>(key, BookmarkJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'BookmarkJsonhalRead[links=$links, id=$id, createdAt=$createdAt, updatedAt=$updatedAt, embedded=$embedded]';
