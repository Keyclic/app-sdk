...
,
  ...
  static List<PublicationEmbedded> listFromJson(Iterable? json) {
    ...
    return json.fold(<PublicationEmbedded>[], (List<PublicationEmbedded> previousValue, element) {
  ...
  static Map<String, PublicationEmbedded> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, PublicationEmbedded>{};
    }

    return json.entries.fold(<String, PublicationEmbedded>{}, (Map<String, PublicationEmbedded> previousValue, element) {
      final PublicationEmbedded? object = PublicationEmbedded.fromJson(element.value);
      if (object is PublicationEmbedded) {
  ...
  static Map<String, List<PublicationEmbedded>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PublicationEmbedded>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PublicationEmbedded>>(key, PublicationEmbedded.listFromJson(value));
    });
  }
