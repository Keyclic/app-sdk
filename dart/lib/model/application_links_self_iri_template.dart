...
,
  ...
  static List<ApplicationLinksSelfIriTemplate> listFromJson(Iterable? json) {
    if (json == null) {
      return <ApplicationLinksSelfIriTemplate>[];
    }

    return json.fold(<ApplicationLinksSelfIriTemplate>[], (List<ApplicationLinksSelfIriTemplate> previousValue, element) {
      final ApplicationLinksSelfIriTemplate? object = ApplicationLinksSelfIriTemplate.fromJson(element);
  ...
  static Map<String, ApplicationLinksSelfIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ApplicationLinksSelfIriTemplate>{}, (Map<String, ApplicationLinksSelfIriTemplate> previousValue, element) {
      final ApplicationLinksSelfIriTemplate? object = ApplicationLinksSelfIriTemplate.fromJson(element.value);
      if (object is ApplicationLinksSelfIriTemplate) {
  ...
  static Map<String, List<ApplicationLinksSelfIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ApplicationLinksSelfIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ApplicationLinksSelfIriTemplate>>(key, ApplicationLinksSelfIriTemplate.listFromJson(value));
    });
  }
