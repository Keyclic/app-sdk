...
,
  ...
  static List<SectionPagination> listFromJson(Iterable? json) {
    ...
    return json.fold(<SectionPagination>[], (List<SectionPagination> previousValue, element) {
  ...
  static Map<String, SectionPagination> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, SectionPagination>{}, (Map<String, SectionPagination> previousValue, element) {
      final SectionPagination? object = SectionPagination.fromJson(element.value);
      if (object is SectionPagination) {
  ...
  static Map<String, List<SectionPagination>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<SectionPagination>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<SectionPagination>>(key, SectionPagination.listFromJson(value));
    });
  }

  @override
  String toString() => 'SectionPagination[limit=$limit, page=$page, pages=$pages, total=$total, links=$links, embedded=$embedded]';
