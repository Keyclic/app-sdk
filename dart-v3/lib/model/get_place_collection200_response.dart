...
,
  ...
  return GetPlaceCollection200Response(
        embedded: GetPlaceCollection200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetPlaceCollection200Response> listFromJson(Iterable? json) {
    if (json == null) {
      return <GetPlaceCollection200Response>[];
    }

    return json.fold(<GetPlaceCollection200Response>[], (List<GetPlaceCollection200Response> previousValue, element) {
      final GetPlaceCollection200Response? object = GetPlaceCollection200Response.fromJson(element);
  ...
  static Map<String, GetPlaceCollection200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetPlaceCollection200Response>{};
    }

    return json.entries.fold(<String, GetPlaceCollection200Response>{}, (Map<String, GetPlaceCollection200Response> previousValue, element) {
      final GetPlaceCollection200Response? object = GetPlaceCollection200Response.fromJson(element.value);
      if (object is GetPlaceCollection200Response) {
  ...
  static Map<String, List<GetPlaceCollection200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetPlaceCollection200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetPlaceCollection200Response>>(key, GetPlaceCollection200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetPlaceCollection200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
