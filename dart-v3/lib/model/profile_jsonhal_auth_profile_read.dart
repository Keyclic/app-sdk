...
,
  ...
  bool operator ==(Object other) {
    ...
    return other is ProfileJsonhalAuthProfileRead 
          ...
          && DeepCollectionEquality.unordered().equals(connections, other.connections)
  ...
  static List<ProfileJsonhalAuthProfileRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<ProfileJsonhalAuthProfileRead>[], (List<ProfileJsonhalAuthProfileRead> previousValue, element) {
      final ProfileJsonhalAuthProfileRead? object = ProfileJsonhalAuthProfileRead.fromJson(element);
  ...
  static Map<String, ProfileJsonhalAuthProfileRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ProfileJsonhalAuthProfileRead>{};
    }

    return json.entries.fold(<String, ProfileJsonhalAuthProfileRead>{}, (Map<String, ProfileJsonhalAuthProfileRead> previousValue, element) {
      final ProfileJsonhalAuthProfileRead? object = ProfileJsonhalAuthProfileRead.fromJson(element.value);
      if (object is ProfileJsonhalAuthProfileRead) {
  ...
  static Map<String, List<ProfileJsonhalAuthProfileRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ProfileJsonhalAuthProfileRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ProfileJsonhalAuthProfileRead>>(key, ProfileJsonhalAuthProfileRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'ProfileJsonhalAuthProfileRead[links=$links, types=$types, connections=$connections, user=$user, firstConnection=$firstConnection]';
  ...
  Map<String, dynamic> toJson([Iterable<String>? keys]) {
    ...
    contains(r'types')
        ...
        r'types':
          types,
    if (keys == null || keys.
    contains(r'connections')
    )
        r'connections':
            connections,
    if (keys == null || keys.
    any((key) => RegExp(r'^user\.').hasMatch(key))
    )
        r'user':
            user?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
