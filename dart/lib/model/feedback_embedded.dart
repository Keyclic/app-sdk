...
,
  ...
  bool operator ==(Object other) {
    ...
    return other is FeedbackEmbedded 
          ...
          && DeepCollectionEquality.unordered().equals(stateTransitions, other.stateTransitions)
  ...
  static List<FeedbackEmbedded> listFromJson(Iterable? json) {
    ...
    return json.fold(<FeedbackEmbedded>[], (List<FeedbackEmbedded> previousValue, element) {
  ...
  static Map<String, FeedbackEmbedded> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, FeedbackEmbedded>{}, (Map<String, FeedbackEmbedded> previousValue, element) {
  ...
  static Map<String, List<FeedbackEmbedded>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<FeedbackEmbedded>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<FeedbackEmbedded>>(key, FeedbackEmbedded.listFromJson(value));
    });
  }

  @override
  String toString() => 'FeedbackEmbedded[category=$category, markers=$markers, member=$member, reporter=$reporter, stateTransitions=$stateTransitions, tracking=$tracking]';
