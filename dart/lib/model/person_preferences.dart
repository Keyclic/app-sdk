...
,
  ...
  static PersonPreferences? fromJson(Object? json) {
  ...
  static List<PersonPreferences> listFromJson(Iterable? json) {
    ...
    return json.fold(<PersonPreferences>[], (List<PersonPreferences> previousValue, element) {
  ...
  static Map<String, PersonPreferences> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, PersonPreferences>{}, (Map<String, PersonPreferences> previousValue, element) {
      final PersonPreferences? object = PersonPreferences.fromJson(element.value);
      if (object is PersonPreferences) {
  ...
  static Map<String, List<PersonPreferences>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PersonPreferences>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PersonPreferences>>(key, PersonPreferences.listFromJson(value));
    });
  }
