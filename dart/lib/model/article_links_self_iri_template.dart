...
,
  ...
  static ArticleLinksSelfIriTemplate? fromJson(Object? json) {
  ...
  static List<ArticleLinksSelfIriTemplate> listFromJson(Iterable? json) {
    if (json == null) {
      return <ArticleLinksSelfIriTemplate>[];
    }

    return json.fold(<ArticleLinksSelfIriTemplate>[], (List<ArticleLinksSelfIriTemplate> previousValue, element) {
      final ArticleLinksSelfIriTemplate? object = ArticleLinksSelfIriTemplate.fromJson(element);
  ...
  static Map<String, ArticleLinksSelfIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ArticleLinksSelfIriTemplate>{};
    }

    return json.entries.fold(<String, ArticleLinksSelfIriTemplate>{}, (Map<String, ArticleLinksSelfIriTemplate> previousValue, element) {
      final ArticleLinksSelfIriTemplate? object = ArticleLinksSelfIriTemplate.fromJson(element.value);
      if (object is ArticleLinksSelfIriTemplate) {
  ...
  static Map<String, List<ArticleLinksSelfIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ArticleLinksSelfIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ArticleLinksSelfIriTemplate>>(key, ArticleLinksSelfIriTemplate.listFromJson(value));
    });
  }
