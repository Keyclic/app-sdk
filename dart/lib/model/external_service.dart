...
,
  ...
  static List<ExternalService> listFromJson(Iterable? json) {
    ...
    return json.fold(<ExternalService>[], (List<ExternalService> previousValue, element) {
  ...
  static Map<String, ExternalService> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ExternalService>{}, (Map<String, ExternalService> previousValue, element) {
  ...
  static Map<String, List<ExternalService>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ExternalService>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ExternalService>>(key, ExternalService.listFromJson(value));
    });
  }

  @override
  String toString() => 'ExternalService[embedded=$embedded, links=$links, address=$address, contactPoint=$contactPoint, createdAt=$createdAt, description=$description, id=$id, name=$name, onCall=$onCall, type=$type, updatedAt=$updatedAt]';
