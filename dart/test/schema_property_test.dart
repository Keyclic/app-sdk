...
// tests for SchemaProperty
void main() {
  // final instance = SchemaProperty();

  group('test SchemaProperty', () {
    ...
    // List<String> enum_ (default value: const [])
    ...
    // int propertyOrder
    test('to test the property `propertyOrder`', () async {});
