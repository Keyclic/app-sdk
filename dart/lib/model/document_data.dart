...
,
  ...
  static List<DocumentData> listFromJson(Iterable? json) {
    if (json == null) {
      return <DocumentData>[];
    }

    return json.fold(<DocumentData>[], (List<DocumentData> previousValue, element) {
  ...
  static Map<String, DocumentData> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, DocumentData>{}, (Map<String, DocumentData> previousValue, element) {
  ...
  static Map<String, List<DocumentData>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<DocumentData>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<DocumentData>>(key, DocumentData.listFromJson(value));
    });
  }

  @override
  String toString() => 'DocumentData[container=$container, file=$file, permission=$permission, template=$template, type=$type]';
