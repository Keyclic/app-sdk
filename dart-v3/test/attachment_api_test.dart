...
void main() {
  ...
  group('tests for AttachmentApi', () {
    ...
    // Removes the Attachment resource.
    //
    //Future deleteAttachment(String identifier, String xKeyclicApp, { String acceptLanguage, DateTime xDateTime, String xKeyclicAppPlatform, String xKeyclicAppVersion }) async
    ...
    // Retrieves a Attachment resource.
    //
    //Future<AttachmentJsonhalRead> getAttachment(String identifier, String xKeyclicApp, { String acceptLanguage, DateTime xDateTime, String xKeyclicAppPlatform, String xKeyclicAppVersion }) async
    ...
    // Creates a Attachment resource.
    //
    //Future<AttachmentJsonhalRead> postAttachment(String xKeyclicApp, AttachmentCreateAttachmentCommandWrite attachmentCreateAttachmentCommandWrite, { String acceptLanguage, DateTime xDateTime, String xKeyclicAppPlatform, String xKeyclicAppVersion }) async
