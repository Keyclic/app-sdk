...
,
  ...
  static List<SignerLinksSelfIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<SignerLinksSelfIriTemplate>[], (List<SignerLinksSelfIriTemplate> previousValue, element) {
      final SignerLinksSelfIriTemplate? object = SignerLinksSelfIriTemplate.fromJson(element);
  ...
  static Map<String, SignerLinksSelfIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, SignerLinksSelfIriTemplate>{};
    }

    return json.entries.fold(<String, SignerLinksSelfIriTemplate>{}, (Map<String, SignerLinksSelfIriTemplate> previousValue, element) {
      final SignerLinksSelfIriTemplate? object = SignerLinksSelfIriTemplate.fromJson(element.value);
      if (object is SignerLinksSelfIriTemplate) {
  ...
  static Map<String, List<SignerLinksSelfIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<SignerLinksSelfIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<SignerLinksSelfIriTemplate>>(key, SignerLinksSelfIriTemplate.listFromJson(value));
    });
  }
