...
,
  ...
  static List<OccupantLinksPlace> listFromJson(Iterable? json) {
    ...
    return json.fold(<OccupantLinksPlace>[], (List<OccupantLinksPlace> previousValue, element) {
  ...
  static Map<String, OccupantLinksPlace> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OccupantLinksPlace>{}, (Map<String, OccupantLinksPlace> previousValue, element) {
      final OccupantLinksPlace? object = OccupantLinksPlace.fromJson(element.value);
      if (object is OccupantLinksPlace) {
  ...
  static Map<String, List<OccupantLinksPlace>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OccupantLinksPlace>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OccupantLinksPlace>>(key, OccupantLinksPlace.listFromJson(value));
    });
  }

  @override
  String toString() => 'OccupantLinksPlace[href=$href, iriTemplate=$iriTemplate]';
