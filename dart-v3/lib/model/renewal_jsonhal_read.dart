...
,
  ...
  static List<RenewalJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<RenewalJsonhalRead>[], (List<RenewalJsonhalRead> previousValue, element) {
  ...
  static Map<String, RenewalJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, RenewalJsonhalRead>{};
    }

    return json.entries.fold(<String, RenewalJsonhalRead>{}, (Map<String, RenewalJsonhalRead> previousValue, element) {
      final RenewalJsonhalRead? object = RenewalJsonhalRead.fromJson(element.value);
      if (object is RenewalJsonhalRead) {
  ...
  static Map<String, List<RenewalJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<RenewalJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<RenewalJsonhalRead>>(key, RenewalJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'RenewalJsonhalRead[duration=$duration, noticePeriod=$noticePeriod]';
