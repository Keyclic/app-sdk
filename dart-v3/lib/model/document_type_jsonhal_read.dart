...
,
  ...
  static List<DocumentTypeJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<DocumentTypeJsonhalRead>[], (List<DocumentTypeJsonhalRead> previousValue, element) {
      final DocumentTypeJsonhalRead? object = DocumentTypeJsonhalRead.fromJson(element);
  ...
  static Map<String, DocumentTypeJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, DocumentTypeJsonhalRead>{};
    }

    return json.entries.fold(<String, DocumentTypeJsonhalRead>{}, (Map<String, DocumentTypeJsonhalRead> previousValue, element) {
      final DocumentTypeJsonhalRead? object = DocumentTypeJsonhalRead.fromJson(element.value);
      if (object is DocumentTypeJsonhalRead) {
  ...
  static Map<String, List<DocumentTypeJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<DocumentTypeJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<DocumentTypeJsonhalRead>>(key, DocumentTypeJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'DocumentTypeJsonhalRead[links=$links, code=$code, permissions=$permissions, signed=$signed, id=$id, description=$description, name=$name]';
