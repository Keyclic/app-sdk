...
,
  ...
  return GetPublicationCollection200Response(
        embedded: GetPublicationCollection200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetPublicationCollection200Response> listFromJson(Iterable? json) {
    if (json == null) {
      return <GetPublicationCollection200Response>[];
    }

    return json.fold(<GetPublicationCollection200Response>[], (List<GetPublicationCollection200Response> previousValue, element) {
      final GetPublicationCollection200Response? object = GetPublicationCollection200Response.fromJson(element);
  ...
  static Map<String, GetPublicationCollection200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetPublicationCollection200Response>{};
    }

    return json.entries.fold(<String, GetPublicationCollection200Response>{}, (Map<String, GetPublicationCollection200Response> previousValue, element) {
      final GetPublicationCollection200Response? object = GetPublicationCollection200Response.fromJson(element.value);
      if (object is GetPublicationCollection200Response) {
  ...
  static Map<String, List<GetPublicationCollection200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetPublicationCollection200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetPublicationCollection200Response>>(key, GetPublicationCollection200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetPublicationCollection200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
