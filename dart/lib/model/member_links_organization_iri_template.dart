...
,
  ...
  static List<MemberLinksOrganizationIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<MemberLinksOrganizationIriTemplate>[], (List<MemberLinksOrganizationIriTemplate> previousValue, element) {
      final MemberLinksOrganizationIriTemplate? object = MemberLinksOrganizationIriTemplate.fromJson(element);
  ...
  static Map<String, MemberLinksOrganizationIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, MemberLinksOrganizationIriTemplate>{};
    }

    return json.entries.fold(<String, MemberLinksOrganizationIriTemplate>{}, (Map<String, MemberLinksOrganizationIriTemplate> previousValue, element) {
      final MemberLinksOrganizationIriTemplate? object = MemberLinksOrganizationIriTemplate.fromJson(element.value);
      if (object is MemberLinksOrganizationIriTemplate) {
  ...
  static Map<String, List<MemberLinksOrganizationIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<MemberLinksOrganizationIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<MemberLinksOrganizationIriTemplate>>(key, MemberLinksOrganizationIriTemplate.listFromJson(value));
    });
  }
