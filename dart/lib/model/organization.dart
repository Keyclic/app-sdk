...
,
  ...
  static List<Organization> listFromJson(Iterable? json) {
    ...
    return json.fold(<Organization>[], (List<Organization> previousValue, element) {
  ...
  static Map<String, Organization> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Organization>{}, (Map<String, Organization> previousValue, element) {
  ...
  static Map<String, List<Organization>> mapListFromJson(Map<String, dynamic>? json) {
    ...
    return json.map((key, value) {
      return MapEntry<String, List<Organization>>(key, Organization.listFromJson(value));
    });
  }

  @override
  String toString() => 'Organization[links=$links, address=$address, alternateName=$alternateName, archived=$archived, createdAt=$createdAt, description=$description, enabled=$enabled, endDate=$endDate, id=$id, name=$name, preferences=$preferences, startDate=$startDate, type=$type, updatedAt=$updatedAt]';
