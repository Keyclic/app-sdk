...
,
  ...
  bool operator ==(Object other) {
    ...
    return other is SignerLinksMemberIriTemplate 
  ...
  static List<SignerLinksMemberIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<SignerLinksMemberIriTemplate>[], (List<SignerLinksMemberIriTemplate> previousValue, element) {
      final SignerLinksMemberIriTemplate? object = SignerLinksMemberIriTemplate.fromJson(element);
  ...
  static Map<String, SignerLinksMemberIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, SignerLinksMemberIriTemplate>{};
    }

    return json.entries.fold(<String, SignerLinksMemberIriTemplate>{}, (Map<String, SignerLinksMemberIriTemplate> previousValue, element) {
      final SignerLinksMemberIriTemplate? object = SignerLinksMemberIriTemplate.fromJson(element.value);
      if (object is SignerLinksMemberIriTemplate) {
  ...
  static Map<String, List<SignerLinksMemberIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<SignerLinksMemberIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<SignerLinksMemberIriTemplate>>(key, SignerLinksMemberIriTemplate.listFromJson(value));
    });
  }
