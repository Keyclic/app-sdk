...
,
  ...
  static Map<String, Category> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Category>{}, (Map<String, Category> previousValue, element) {
  ...
  static Map<String, List<Category>> mapListFromJson(Map<String, dynamic>? json) {
    ...
    return json.map((key, value) {
      return MapEntry<String, List<Category>>(key, Category.listFromJson(value));
    });
  }

  @override
  String toString() => 'Category[embedded=$embedded, links=$links, createdAt=$createdAt, enabled=$enabled, id=$id, identificationNumber=$identificationNumber, name=$name, type=$type, updatedAt=$updatedAt]';
