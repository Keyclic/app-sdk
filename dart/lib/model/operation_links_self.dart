...
,
  ...
  static List<OperationLinksSelf> listFromJson(Iterable? json) {
    ...
    return json.fold(<OperationLinksSelf>[], (List<OperationLinksSelf> previousValue, element) {
  ...
  static Map<String, OperationLinksSelf> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OperationLinksSelf>{}, (Map<String, OperationLinksSelf> previousValue, element) {
      final OperationLinksSelf? object = OperationLinksSelf.fromJson(element.value);
      if (object is OperationLinksSelf) {
  ...
  static Map<String, List<OperationLinksSelf>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OperationLinksSelf>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OperationLinksSelf>>(key, OperationLinksSelf.listFromJson(value));
    });
  }

  @override
  String toString() => 'OperationLinksSelf[href=$href, iriTemplate=$iriTemplate]';
