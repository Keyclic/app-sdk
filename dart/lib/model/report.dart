...
,
  ...
  static List<Report> listFromJson(Iterable? json) {
    if (json == null) {
      return <Report>[];
    }
  ...
  static Map<String, Report> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Report>{}, (Map<String, Report> previousValue, element) {
  ...
  @override
  String toString() => 'Report[embedded=$embedded, links=$links, archived=$archived, createdAt=$createdAt, description=$description, dueBy=$dueBy, id=$id, identificationNumber=$identificationNumber, name=$name, phase=$phase, priority=$priority, reference=$reference, scheduledAt=$scheduledAt, tags=$tags, type=$type, updatedAt=$updatedAt]';
