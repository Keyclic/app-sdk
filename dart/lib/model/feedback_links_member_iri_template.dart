...
,
  ...
  bool operator ==(Object other) {
    ...
    return other is FeedbackLinksMemberIriTemplate 
  ...
  static List<FeedbackLinksMemberIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<FeedbackLinksMemberIriTemplate>[], (List<FeedbackLinksMemberIriTemplate> previousValue, element) {
      final FeedbackLinksMemberIriTemplate? object = FeedbackLinksMemberIriTemplate.fromJson(element);
  ...
  static Map<String, FeedbackLinksMemberIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, FeedbackLinksMemberIriTemplate>{};
    }

    return json.entries.fold(<String, FeedbackLinksMemberIriTemplate>{}, (Map<String, FeedbackLinksMemberIriTemplate> previousValue, element) {
      final FeedbackLinksMemberIriTemplate? object = FeedbackLinksMemberIriTemplate.fromJson(element.value);
      if (object is FeedbackLinksMemberIriTemplate) {
  ...
  static Map<String, List<FeedbackLinksMemberIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<FeedbackLinksMemberIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<FeedbackLinksMemberIriTemplate>>(key, FeedbackLinksMemberIriTemplate.listFromJson(value));
    });
  }
