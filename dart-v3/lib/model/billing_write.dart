...
,
  ...
  static List<BillingWrite> listFromJson(Iterable? json) {
    ...
    return json.fold(<BillingWrite>[], (List<BillingWrite> previousValue, element) {
  ...
  static Map<String, BillingWrite> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, BillingWrite>{}, (Map<String, BillingWrite> previousValue, element) {
  ...
  static Map<String, List<BillingWrite>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<BillingWrite>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<BillingWrite>>(key, BillingWrite.listFromJson(value));
    });
  }

  @override
  String toString() => 'BillingWrite[adjustedCost=$adjustedCost, initialCost=$initialCost, startDate=$startDate]';
