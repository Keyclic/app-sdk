...
,
  ...
  static List<ServicePagination> listFromJson(Iterable? json) {
    ...
    return json.fold(<ServicePagination>[], (List<ServicePagination> previousValue, element) {
  ...
  static Map<String, ServicePagination> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ServicePagination>{}, (Map<String, ServicePagination> previousValue, element) {
      final ServicePagination? object = ServicePagination.fromJson(element.value);
      if (object is ServicePagination) {
  ...
  static Map<String, List<ServicePagination>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ServicePagination>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ServicePagination>>(key, ServicePagination.listFromJson(value));
    });
  }

  @override
  String toString() => 'ServicePagination[limit=$limit, page=$page, pages=$pages, total=$total, links=$links, embedded=$embedded]';
