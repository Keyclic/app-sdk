...
,
  ...
  return OperationLinksOperator(
                  href: json[r'href'],
        iriTemplate: OperationLinksOperatorIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<OperationLinksOperator> listFromJson(Iterable? json) {
    ...
    return json.fold(<OperationLinksOperator>[], (List<OperationLinksOperator> previousValue, element) {
      final OperationLinksOperator? object = OperationLinksOperator.fromJson(element);
  ...
  static Map<String, OperationLinksOperator> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OperationLinksOperator>{}, (Map<String, OperationLinksOperator> previousValue, element) {
      final OperationLinksOperator? object = OperationLinksOperator.fromJson(element.value);
      if (object is OperationLinksOperator) {
  ...
  static Map<String, List<OperationLinksOperator>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OperationLinksOperator>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OperationLinksOperator>>(key, OperationLinksOperator.listFromJson(value));
    });
  }

  @override
  String toString() => 'OperationLinksOperator[href=$href, iriTemplate=$iriTemplate]';
