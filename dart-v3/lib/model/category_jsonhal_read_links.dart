...
,
  ...
  static List<CategoryJsonhalReadLinks> listFromJson(Iterable? json) {
    ...
    return json.fold(<CategoryJsonhalReadLinks>[], (List<CategoryJsonhalReadLinks> previousValue, element) {
      final CategoryJsonhalReadLinks? object = CategoryJsonhalReadLinks.fromJson(element);
  ...
  static Map<String, CategoryJsonhalReadLinks> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, CategoryJsonhalReadLinks>{};
    }

    return json.entries.fold(<String, CategoryJsonhalReadLinks>{}, (Map<String, CategoryJsonhalReadLinks> previousValue, element) {
      final CategoryJsonhalReadLinks? object = CategoryJsonhalReadLinks.fromJson(element.value);
      if (object is CategoryJsonhalReadLinks) {
  ...
  static Map<String, List<CategoryJsonhalReadLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<CategoryJsonhalReadLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<CategoryJsonhalReadLinks>>(key, CategoryJsonhalReadLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'CategoryJsonhalReadLinks[self=$self, organization=$organization, children=$children]';
