...
,
  ...
  static List<RoleJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<RoleJsonhalRead>[], (List<RoleJsonhalRead> previousValue, element) {
  ...
  static Map<String, RoleJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, RoleJsonhalRead>{}, (Map<String, RoleJsonhalRead> previousValue, element) {
  ...
  static Map<String, List<RoleJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<RoleJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<RoleJsonhalRead>>(key, RoleJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'RoleJsonhalRead[links=$links, id=$id, createdAt=$createdAt, updatedAt=$updatedAt, description=$description, name=$name, permissions=$permissions]';
