...
,
  ...
  static List<ReviewLinksSelfIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<ReviewLinksSelfIriTemplate>[], (List<ReviewLinksSelfIriTemplate> previousValue, element) {
      final ReviewLinksSelfIriTemplate? object = ReviewLinksSelfIriTemplate.fromJson(element);
  ...
  static Map<String, ReviewLinksSelfIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ReviewLinksSelfIriTemplate>{}, (Map<String, ReviewLinksSelfIriTemplate> previousValue, element) {
      final ReviewLinksSelfIriTemplate? object = ReviewLinksSelfIriTemplate.fromJson(element.value);
      if (object is ReviewLinksSelfIriTemplate) {
  ...
  static Map<String, List<ReviewLinksSelfIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReviewLinksSelfIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReviewLinksSelfIriTemplate>>(key, ReviewLinksSelfIriTemplate.listFromJson(value));
    });
  }
