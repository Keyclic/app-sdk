...
,
  ...
  static List<CollaboratorJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<CollaboratorJsonhalRead>[], (List<CollaboratorJsonhalRead> previousValue, element) {
      final CollaboratorJsonhalRead? object = CollaboratorJsonhalRead.fromJson(element);
  ...
  static Map<String, CollaboratorJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, CollaboratorJsonhalRead>{};
    }

    return json.entries.fold(<String, CollaboratorJsonhalRead>{}, (Map<String, CollaboratorJsonhalRead> previousValue, element) {
      final CollaboratorJsonhalRead? object = CollaboratorJsonhalRead.fromJson(element.value);
      if (object is CollaboratorJsonhalRead) {
  ...
  static Map<String, List<CollaboratorJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<CollaboratorJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<CollaboratorJsonhalRead>>(key, CollaboratorJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'CollaboratorJsonhalRead[links=$links, id=$id, createdAt=$createdAt, updatedAt=$updatedAt, contactPoint=$contactPoint, type=$type, embedded=$embedded]';
