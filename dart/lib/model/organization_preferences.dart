...
,
  ...
  static List<OrganizationPreferences> listFromJson(Iterable? json) {
    ...
    return json.fold(<OrganizationPreferences>[], (List<OrganizationPreferences> previousValue, element) {
      final OrganizationPreferences? object = OrganizationPreferences.fromJson(element);
  ...
  static Map<String, OrganizationPreferences> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OrganizationPreferences>{}, (Map<String, OrganizationPreferences> previousValue, element) {
      final OrganizationPreferences? object = OrganizationPreferences.fromJson(element.value);
      if (object is OrganizationPreferences) {
