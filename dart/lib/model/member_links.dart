...
,
  ...
  static List<MemberLinks> listFromJson(Iterable? json) {
    if (json == null) {
      return <MemberLinks>[];
    }

    return json.fold(<MemberLinks>[], (List<MemberLinks> previousValue, element) {
  ...
  static Map<String, MemberLinks> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, MemberLinks>{}, (Map<String, MemberLinks> previousValue, element) {
  ...
  static Map<String, List<MemberLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<MemberLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<MemberLinks>>(key, MemberLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'MemberLinks[organization=$organization, person=$person, self=$self]';
