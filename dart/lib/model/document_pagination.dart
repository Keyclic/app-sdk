...
,
  ...
  static List<DocumentPagination> listFromJson(Iterable? json) {
    ...
    return json.fold(<DocumentPagination>[], (List<DocumentPagination> previousValue, element) {
  ...
  static Map<String, DocumentPagination> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, DocumentPagination>{}, (Map<String, DocumentPagination> previousValue, element) {
      final DocumentPagination? object = DocumentPagination.fromJson(element.value);
      if (object is DocumentPagination) {
  ...
  static Map<String, List<DocumentPagination>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<DocumentPagination>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<DocumentPagination>>(key, DocumentPagination.listFromJson(value));
    });
  }

  @override
  String toString() => 'DocumentPagination[limit=$limit, page=$page, pages=$pages, total=$total, links=$links, embedded=$embedded]';
