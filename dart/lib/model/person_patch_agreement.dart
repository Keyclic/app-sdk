...
,
  ...
  static List<PersonPatchAgreement> listFromJson(Iterable? json) {
    ...
    return json.fold(<PersonPatchAgreement>[], (List<PersonPatchAgreement> previousValue, element) {
      final PersonPatchAgreement? object = PersonPatchAgreement.fromJson(element);
  ...
  static Map<String, PersonPatchAgreement> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, PersonPatchAgreement>{};
    }

    return json.entries.fold(<String, PersonPatchAgreement>{}, (Map<String, PersonPatchAgreement> previousValue, element) {
      final PersonPatchAgreement? object = PersonPatchAgreement.fromJson(element.value);
      if (object is PersonPatchAgreement) {
  ...
  static Map<String, List<PersonPatchAgreement>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PersonPatchAgreement>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PersonPatchAgreement>>(key, PersonPatchAgreement.listFromJson(value));
    });
  }

  @override
  String toString() => 'PersonPatchAgreement[privacyPolicy=$privacyPolicy, termsOfService=$termsOfService, olderThan=$olderThan]';
