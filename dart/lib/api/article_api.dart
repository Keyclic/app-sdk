...
class ArticleApi {
  ...
  Future<Response<Article>> getArticle({ 
    ...
    final String path = r'/articles/{article}'.replaceAll('{' r'article' '}', article.toString());
    ...
    try {
            responseData = await _apiClient.deserializeAsync<Article>(response.data!, 'Article');
