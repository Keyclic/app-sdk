...
,
  ...
  static List<PlaceEditPlaceCommandWriteEdit> listFromJson(Iterable? json) {
    ...
    return json.fold(<PlaceEditPlaceCommandWriteEdit>[], (List<PlaceEditPlaceCommandWriteEdit> previousValue, element) {
      final PlaceEditPlaceCommandWriteEdit? object = PlaceEditPlaceCommandWriteEdit.fromJson(element);
  ...
  static Map<String, PlaceEditPlaceCommandWriteEdit> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, PlaceEditPlaceCommandWriteEdit>{};
    }

    return json.entries.fold(<String, PlaceEditPlaceCommandWriteEdit>{}, (Map<String, PlaceEditPlaceCommandWriteEdit> previousValue, element) {
      final PlaceEditPlaceCommandWriteEdit? object = PlaceEditPlaceCommandWriteEdit.fromJson(element.value);
      if (object is PlaceEditPlaceCommandWriteEdit) {
  ...
  static Map<String, List<PlaceEditPlaceCommandWriteEdit>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PlaceEditPlaceCommandWriteEdit>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PlaceEditPlaceCommandWriteEdit>>(key, PlaceEditPlaceCommandWriteEdit.listFromJson(value));
    });
  }

  @override
  String toString() => 'PlaceEditPlaceCommandWriteEdit[address=$address, branchCode=$branchCode, description=$description, name=$name, preferences=$preferences]';
