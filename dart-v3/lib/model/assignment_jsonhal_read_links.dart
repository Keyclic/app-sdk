...
class AssignmentJsonhalReadLinks {
  ...
  static AssignmentJsonhalReadLinks? fromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return null;
    }
    ...
    return AssignmentJsonhalReadLinks(
      ...
      member:
          GetAssetTypeCollection200ResponseLinksFirst.fromJson(json[r'member']),
      service: GetAssetTypeCollection200ResponseLinksFirst.fromJson(
          json[r'service']),
    );
  }
  ...
  @override
  String toString() =>
      'AssignmentJsonhalReadLinks[self=$self, member=$member, service=$service]';
