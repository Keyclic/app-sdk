...
,
  ...
  static List<FeedbackPriority> listFromJson(Iterable? json) {
    ...
    return json.fold(<FeedbackPriority>[], (List<FeedbackPriority> previousValue, element) {
  ...
  static Map<String, FeedbackPriority> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, FeedbackPriority>{}, (Map<String, FeedbackPriority> previousValue, element) {
  ...
  static Map<String, List<FeedbackPriority>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<FeedbackPriority>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<FeedbackPriority>>(key, FeedbackPriority.listFromJson(value));
    });
  }

  @override
  String toString() => 'FeedbackPriority[color=$color, id=$id, name=$name, position=$position, type=$type]';
