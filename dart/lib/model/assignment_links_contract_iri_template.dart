...
,
  ...
  static List<AssignmentLinksContractIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<AssignmentLinksContractIriTemplate>[], (List<AssignmentLinksContractIriTemplate> previousValue, element) {
      final AssignmentLinksContractIriTemplate? object = AssignmentLinksContractIriTemplate.fromJson(element);
  ...
  static Map<String, AssignmentLinksContractIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, AssignmentLinksContractIriTemplate>{};
    }

    return json.entries.fold(<String, AssignmentLinksContractIriTemplate>{}, (Map<String, AssignmentLinksContractIriTemplate> previousValue, element) {
      final AssignmentLinksContractIriTemplate? object = AssignmentLinksContractIriTemplate.fromJson(element.value);
      if (object is AssignmentLinksContractIriTemplate) {
  ...
  static Map<String, List<AssignmentLinksContractIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<AssignmentLinksContractIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<AssignmentLinksContractIriTemplate>>(key, AssignmentLinksContractIriTemplate.listFromJson(value));
    });
  }
