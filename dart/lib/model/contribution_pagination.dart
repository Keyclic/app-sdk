...
,
  ...
  static List<ContributionPagination> listFromJson(Iterable? json) {
    ...
    return json.fold(<ContributionPagination>[], (List<ContributionPagination> previousValue, element) {
      final ContributionPagination? object = ContributionPagination.fromJson(element);
  ...
  static Map<String, ContributionPagination> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ContributionPagination>{};
    }

    return json.entries.fold(<String, ContributionPagination>{}, (Map<String, ContributionPagination> previousValue, element) {
      final ContributionPagination? object = ContributionPagination.fromJson(element.value);
      if (object is ContributionPagination) {
  ...
  static Map<String, List<ContributionPagination>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ContributionPagination>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ContributionPagination>>(key, ContributionPagination.listFromJson(value));
    });
  }

  @override
  String toString() => 'ContributionPagination[limit=$limit, page=$page, pages=$pages, total=$total, links=$links, embedded=$embedded]';
