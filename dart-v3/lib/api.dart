...
part 'model/get_note_collection200_response.dart';
part 'model/get_note_collection200_response_embedded.dart';
...
part 'model/note_create_note_command_write.dart';
part 'model/note_edit_note_command_write.dart';
part 'model/note_jsonhal_read.dart';
part 'model/note_jsonhal_read_links.dart';
