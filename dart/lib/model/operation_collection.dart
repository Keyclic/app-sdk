...
,
  ...
  return OperationCollection(
        items: 
          Operation.listFromJson(json[r'items']),
    );
  }
  ...
  static List<OperationCollection> listFromJson(Iterable? json) {
    ...
    return json.fold(<OperationCollection>[], (List<OperationCollection> previousValue, element) {
  ...
  static Map<String, OperationCollection> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OperationCollection>{}, (Map<String, OperationCollection> previousValue, element) {
      final OperationCollection? object = OperationCollection.fromJson(element.value);
      if (object is OperationCollection) {
  ...
  static Map<String, List<OperationCollection>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OperationCollection>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OperationCollection>>(key, OperationCollection.listFromJson(value));
    });
  }
