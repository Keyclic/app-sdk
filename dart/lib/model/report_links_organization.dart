...
,
  ...
  return ReportLinksOrganization(
                  href: json[r'href'],
        iriTemplate: ReportLinksOrganizationIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<ReportLinksOrganization> listFromJson(Iterable? json) {
    ...
    return json.fold(<ReportLinksOrganization>[], (List<ReportLinksOrganization> previousValue, element) {
      final ReportLinksOrganization? object = ReportLinksOrganization.fromJson(element);
  ...
  static Map<String, ReportLinksOrganization> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ReportLinksOrganization>{}, (Map<String, ReportLinksOrganization> previousValue, element) {
      final ReportLinksOrganization? object = ReportLinksOrganization.fromJson(element.value);
      if (object is ReportLinksOrganization) {
  ...
  static Map<String, List<ReportLinksOrganization>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReportLinksOrganization>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReportLinksOrganization>>(key, ReportLinksOrganization.listFromJson(value));
    });
  }

  @override
  String toString() => 'ReportLinksOrganization[href=$href, iriTemplate=$iriTemplate]';
