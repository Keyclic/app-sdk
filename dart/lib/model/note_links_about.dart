...
,
  ...
  static List<NoteLinksAbout> listFromJson(Iterable? json) {
    ...
    return json.fold(<NoteLinksAbout>[], (List<NoteLinksAbout> previousValue, element) {
  ...
  static Map<String, NoteLinksAbout> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, NoteLinksAbout>{}, (Map<String, NoteLinksAbout> previousValue, element) {
  ...
  static Map<String, List<NoteLinksAbout>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<NoteLinksAbout>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<NoteLinksAbout>>(key, NoteLinksAbout.listFromJson(value));
    });
  }
