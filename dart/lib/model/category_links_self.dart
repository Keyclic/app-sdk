...
,
  ...
  static List<CategoryLinksSelf> listFromJson(Iterable? json) {
    ...
    return json.fold(<CategoryLinksSelf>[], (List<CategoryLinksSelf> previousValue, element) {
  ...
  static Map<String, CategoryLinksSelf> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, CategoryLinksSelf>{}, (Map<String, CategoryLinksSelf> previousValue, element) {
      final CategoryLinksSelf? object = CategoryLinksSelf.fromJson(element.value);
      if (object is CategoryLinksSelf) {
  ...
  static Map<String, List<CategoryLinksSelf>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<CategoryLinksSelf>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<CategoryLinksSelf>>(key, CategoryLinksSelf.listFromJson(value));
    });
  }

  @override
  String toString() => 'CategoryLinksSelf[href=$href, iriTemplate=$iriTemplate]';
