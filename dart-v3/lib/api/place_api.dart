...
class PlaceApi {
  ...
  /// Parameters:
  /// * [xKeyclicApp] -
  /// * [placeCreatePlaceCommandWrite] - The new Place resource
  /// * [acceptLanguage] -
  /// * [xDateTime] -
  /// * [xKeyclicAppPlatform] -
  /// * [xKeyclicAppVersion] -
  ...
  Future<Response<PlaceJsonhalRead>> postPlace({
    required String xKeyclicApp,
    required PlaceCreatePlaceCommandWrite placeCreatePlaceCommandWrite,
    String? acceptLanguage,
    DateTime? xDateTime,
    String? xKeyclicAppPlatform,
    String? xKeyclicAppVersion,
    ...
    try {
      bodyData = placeCreatePlaceCommandWrite.toJson(bodyParameters);
    } catch (error, stackTrace) {
      throw DioException(
        error: error,
