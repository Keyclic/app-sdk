...
,
  ...
  static List<BusinessActivityPagination> listFromJson(Iterable? json) {
    if (json == null) {
      return <BusinessActivityPagination>[];
    }

    return json.fold(<BusinessActivityPagination>[], (List<BusinessActivityPagination> previousValue, element) {
      final BusinessActivityPagination? object = BusinessActivityPagination.fromJson(element);
  ...
  static Map<String, BusinessActivityPagination> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, BusinessActivityPagination>{}, (Map<String, BusinessActivityPagination> previousValue, element) {
      final BusinessActivityPagination? object = BusinessActivityPagination.fromJson(element.value);
      if (object is BusinessActivityPagination) {
  ...
  static Map<String, List<BusinessActivityPagination>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<BusinessActivityPagination>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<BusinessActivityPagination>>(key, BusinessActivityPagination.listFromJson(value));
    });
  }

  @override
  String toString() => 'BusinessActivityPagination[limit=$limit, page=$page, pages=$pages, total=$total, links=$links, embedded=$embedded]';
