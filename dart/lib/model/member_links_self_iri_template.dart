...
,
  ...
  static List<MemberLinksSelfIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<MemberLinksSelfIriTemplate>[], (List<MemberLinksSelfIriTemplate> previousValue, element) {
      final MemberLinksSelfIriTemplate? object = MemberLinksSelfIriTemplate.fromJson(element);
  ...
  static Map<String, MemberLinksSelfIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, MemberLinksSelfIriTemplate>{}, (Map<String, MemberLinksSelfIriTemplate> previousValue, element) {
      final MemberLinksSelfIriTemplate? object = MemberLinksSelfIriTemplate.fromJson(element.value);
      if (object is MemberLinksSelfIriTemplate) {
  ...
  static Map<String, List<MemberLinksSelfIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<MemberLinksSelfIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<MemberLinksSelfIriTemplate>>(key, MemberLinksSelfIriTemplate.listFromJson(value));
    });
  }
