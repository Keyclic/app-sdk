...
,
  ...
  static List<ReportLinksPlace> listFromJson(Iterable? json) {
    ...
    return json.fold(<ReportLinksPlace>[], (List<ReportLinksPlace> previousValue, element) {
  ...
  static Map<String, ReportLinksPlace> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ReportLinksPlace>{}, (Map<String, ReportLinksPlace> previousValue, element) {
  ...
  static Map<String, List<ReportLinksPlace>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReportLinksPlace>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReportLinksPlace>>(key, ReportLinksPlace.listFromJson(value));
    });
  }
