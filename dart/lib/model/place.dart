...
,
  ...
  static Map<String, Place> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Place>{}, (Map<String, Place> previousValue, element) {
  ...
  @override
  String toString() => 'Place[embedded=$embedded, links=$links, address=$address, branchCode=$branchCode, createdAt=$createdAt, description=$description, id=$id, name=$name, preferences=$preferences, type=$type, updatedAt=$updatedAt]';
