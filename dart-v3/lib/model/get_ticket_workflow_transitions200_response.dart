...
,
  ...
  return GetTicketWorkflowTransitions200Response(
        embedded: GetTicketWorkflowTransitions200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetTicketWorkflowTransitions200Response> listFromJson(Iterable? json) {
    if (json == null) {
      return <GetTicketWorkflowTransitions200Response>[];
    }

    return json.fold(<GetTicketWorkflowTransitions200Response>[], (List<GetTicketWorkflowTransitions200Response> previousValue, element) {
      final GetTicketWorkflowTransitions200Response? object = GetTicketWorkflowTransitions200Response.fromJson(element);
  ...
  static Map<String, GetTicketWorkflowTransitions200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetTicketWorkflowTransitions200Response>{};
    }

    return json.entries.fold(<String, GetTicketWorkflowTransitions200Response>{}, (Map<String, GetTicketWorkflowTransitions200Response> previousValue, element) {
      final GetTicketWorkflowTransitions200Response? object = GetTicketWorkflowTransitions200Response.fromJson(element.value);
      if (object is GetTicketWorkflowTransitions200Response) {
  ...
  static Map<String, List<GetTicketWorkflowTransitions200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetTicketWorkflowTransitions200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetTicketWorkflowTransitions200Response>>(key, GetTicketWorkflowTransitions200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetTicketWorkflowTransitions200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
