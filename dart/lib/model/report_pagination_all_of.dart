...
class ReportPaginationAllOf {
  ...
  factory ReportPaginationAllOf.fromJson(Map<String, dynamic> json) {
    if (json == null) {
      return null;
    }
  ...
  static List<ReportPaginationAllOf> listFromJson(List<dynamic> json) {
    return <ReportPaginationAllOf>[
      if (json is List)
        for (dynamic value in json) ReportPaginationAllOf.fromJson(value),
    ];
  }
    ...
    return <String, ReportPaginationAllOf>{
      if (json is Map)
        for (final entry in json.entries)
          entry.key: ReportPaginationAllOf.fromJson(entry.value),
    };
  }
