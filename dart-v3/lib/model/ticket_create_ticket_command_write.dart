...
,
  ...
  static List<TicketCreateTicketCommandWrite> listFromJson(Iterable? json) {
    ...
    return json.fold(<TicketCreateTicketCommandWrite>[], (List<TicketCreateTicketCommandWrite> previousValue, element) {
      final TicketCreateTicketCommandWrite? object = TicketCreateTicketCommandWrite.fromJson(element);
  ...
  static Map<String, TicketCreateTicketCommandWrite> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, TicketCreateTicketCommandWrite>{};
    }

    return json.entries.fold(<String, TicketCreateTicketCommandWrite>{}, (Map<String, TicketCreateTicketCommandWrite> previousValue, element) {
      final TicketCreateTicketCommandWrite? object = TicketCreateTicketCommandWrite.fromJson(element.value);
      if (object is TicketCreateTicketCommandWrite) {
  ...
  static Map<String, List<TicketCreateTicketCommandWrite>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<TicketCreateTicketCommandWrite>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<TicketCreateTicketCommandWrite>>(key, TicketCreateTicketCommandWrite.listFromJson(value));
    });
  }

  @override
  String toString() => 'TicketCreateTicketCommandWrite[description=$description, equipments=$equipments, member=$member, name=$name, parent=$parent, scheduledAt=$scheduledAt, type=$type]';
...
class TicketCreateTicketCommandWriteTypeEnum {
  ...
  static const operation = TicketCreateTicketCommandWriteTypeEnum._(r'Operation');
  ...
  static List<TicketCreateTicketCommandWriteTypeEnum> listFromJson(List<dynamic> json) {
    return json.map((value) {
      return TicketCreateTicketCommandWriteTypeEnum.fromJson(value);
    }).whereType<TicketCreateTicketCommandWriteTypeEnum>().toList();
  }
}
...
class TicketCreateTicketCommandWriteTypeEnumTypeTransformer {
  ...
  factory TicketCreateTicketCommandWriteTypeEnumTypeTransformer() => _instance ??= TicketCreateTicketCommandWriteTypeEnumTypeTransformer._();
  ...
  TicketCreateTicketCommandWriteTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    switch (data) {
      case r'Operation': return TicketCreateTicketCommandWriteTypeEnum.operation;
      case r'Task': return TicketCreateTicketCommandWriteTypeEnum.task;
      default:
        if (allowNull == false) {
