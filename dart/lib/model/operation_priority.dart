...
,
  ...
  static OperationPriority? fromJson(Object? json) {
  ...
  static List<OperationPriority> listFromJson(Iterable? json) {
    ...
    return json.fold(<OperationPriority>[], (List<OperationPriority> previousValue, element) {
  ...
  static Map<String, OperationPriority> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OperationPriority>{}, (Map<String, OperationPriority> previousValue, element) {
      final OperationPriority? object = OperationPriority.fromJson(element.value);
      if (object is OperationPriority) {
  ...
  static Map<String, List<OperationPriority>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OperationPriority>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OperationPriority>>(key, OperationPriority.listFromJson(value));
    });
  }

  @override
  String toString() => 'OperationPriority[color=$color, id=$id, name=$name, position=$position, type=$type]';
