...
class ExternalServiceApi {
  const ExternalServiceApi(this._apiClient);
  ...
  /// Also see [Remove one ExternalService resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  ...
  /// Throws [DioError] if API call or serialization fails
  /// Keyclic API documentation.
  /// Also see [Retrieve one ExternalService resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  ...
  /// Throws [DioError] if API call or serialization fails
  /// Keyclic API documentation.
  /// Also see [Edit one ExternalService resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  Future<Response<ExternalService>> patchExternalService({
    required String xKeyclicApp,
    required String externalService,
    required ExternalServicePatch externalServicePatch,
    String? acceptLanguage,
    DateTime? xDateTime,
    String? xKeyclicAppPlatform,
    String? xKeyclicAppVersion,
  ...
  /// Throws [DioError] if API call or serialization fails
  /// Keyclic API documentation.
  /// Also see [Create one ExternalService resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  Future<Response<ExternalService>> postExternalService({
    required String xKeyclicApp,
    required ExternalServiceData externalServiceData,
    String? acceptLanguage,
    DateTime? xDateTime,
    String? xKeyclicAppPlatform,
    String? xKeyclicAppVersion,
    ...
    final String path = r'/external-services';
    final options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        // to string ??
