...
,
  ...
  return FeedbackLinksTracking(
                  href: json[r'href'],
        iriTemplate: FeedbackLinksTrackingIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<FeedbackLinksTracking> listFromJson(Iterable? json) {
    ...
    return json.fold(<FeedbackLinksTracking>[], (List<FeedbackLinksTracking> previousValue, element) {
      final FeedbackLinksTracking? object = FeedbackLinksTracking.fromJson(element);
  ...
  static Map<String, FeedbackLinksTracking> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, FeedbackLinksTracking>{}, (Map<String, FeedbackLinksTracking> previousValue, element) {
      final FeedbackLinksTracking? object = FeedbackLinksTracking.fromJson(element.value);
      if (object is FeedbackLinksTracking) {
  ...
  static Map<String, List<FeedbackLinksTracking>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<FeedbackLinksTracking>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<FeedbackLinksTracking>>(key, FeedbackLinksTracking.listFromJson(value));
    });
  }

  @override
  String toString() => 'FeedbackLinksTracking[href=$href, iriTemplate=$iriTemplate]';
