...
,
  ...
  static AssignmentEmbedded? fromJson(Object? json) {
  ...
  static List<AssignmentEmbedded> listFromJson(Iterable? json) {
    if (json == null) {
      return <AssignmentEmbedded>[];
    }

    return json.fold(<AssignmentEmbedded>[], (List<AssignmentEmbedded> previousValue, element) {
  ...
  static Map<String, AssignmentEmbedded> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, AssignmentEmbedded>{};
    }

    return json.entries.fold(<String, AssignmentEmbedded>{}, (Map<String, AssignmentEmbedded> previousValue, element) {
      final AssignmentEmbedded? object = AssignmentEmbedded.fromJson(element.value);
      if (object is AssignmentEmbedded) {
  ...
  static Map<String, List<AssignmentEmbedded>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<AssignmentEmbedded>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<AssignmentEmbedded>>(key, AssignmentEmbedded.listFromJson(value));
    });
  }

  @override
  String toString() => 'AssignmentEmbedded[createdBy=$createdBy, service=$service]';
