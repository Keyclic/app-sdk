...
,
  ...
  static Map<String, Operation> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Operation>{}, (Map<String, Operation> previousValue, element) {
  ...
  static Map<String, List<Operation>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<Operation>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<Operation>>(key, Operation.listFromJson(value));
    });
  }

  @override
  String toString() => 'Operation[embedded=$embedded, links=$links, archived=$archived, createdAt=$createdAt, description=$description, dueBy=$dueBy, id=$id, identificationNumber=$identificationNumber, name=$name, priority=$priority, reference=$reference, scheduledAt=$scheduledAt, tags=$tags, type=$type, updatedAt=$updatedAt]';
