...
,
  ...
  return FeedbackLinks(
        businessActivity: FeedbackLinksBusinessActivity.fromJson(json[r'businessActivity']),
  ...
  static List<FeedbackLinks> listFromJson(Iterable? json) {
    ...
    return json.fold(<FeedbackLinks>[], (List<FeedbackLinks> previousValue, element) {
  ...
  static Map<String, FeedbackLinks> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, FeedbackLinks>{}, (Map<String, FeedbackLinks> previousValue, element) {
  ...
  static Map<String, List<FeedbackLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<FeedbackLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<FeedbackLinks>>(key, FeedbackLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'FeedbackLinks[businessActivity=$businessActivity, category=$category, images=$images, member=$member, plans=$plans, report=$report, reporter=$reporter, self=$self, tracking=$tracking]';
  ...
  Map<String, dynamic> toJson([Iterable<String>? keys]) {
    ...
    contains(r'plans')
        ...
        r'plans':
            plans,
    if (keys == null || keys.
    any((key) => RegExp(r'^report\.').hasMatch(key))
    )
        r'report':
            report?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
