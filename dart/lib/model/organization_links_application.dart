...
,
  ...
  return OrganizationLinksApplication(
                  href: json[r'href'],
        iriTemplate: OrganizationLinksApplicationIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<OrganizationLinksApplication> listFromJson(Iterable? json) {
    ...
    return json.fold(<OrganizationLinksApplication>[], (List<OrganizationLinksApplication> previousValue, element) {
      final OrganizationLinksApplication? object = OrganizationLinksApplication.fromJson(element);
  ...
  static Map<String, OrganizationLinksApplication> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, OrganizationLinksApplication>{};
    }

    return json.entries.fold(<String, OrganizationLinksApplication>{}, (Map<String, OrganizationLinksApplication> previousValue, element) {
      final OrganizationLinksApplication? object = OrganizationLinksApplication.fromJson(element.value);
      if (object is OrganizationLinksApplication) {
  ...
  static Map<String, List<OrganizationLinksApplication>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OrganizationLinksApplication>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OrganizationLinksApplication>>(key, OrganizationLinksApplication.listFromJson(value));
    });
  }

  @override
  String toString() => 'OrganizationLinksApplication[href=$href, iriTemplate=$iriTemplate]';
