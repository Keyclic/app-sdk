...
,
  ...
  return DocumentLinksProcedure(
                  href: json[r'href'],
        iriTemplate: DocumentLinksProcedureIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<DocumentLinksProcedure> listFromJson(Iterable? json) {
    ...
    return json.fold(<DocumentLinksProcedure>[], (List<DocumentLinksProcedure> previousValue, element) {
      final DocumentLinksProcedure? object = DocumentLinksProcedure.fromJson(element);
  ...
  static Map<String, DocumentLinksProcedure> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, DocumentLinksProcedure>{};
    }

    return json.entries.fold(<String, DocumentLinksProcedure>{}, (Map<String, DocumentLinksProcedure> previousValue, element) {
      final DocumentLinksProcedure? object = DocumentLinksProcedure.fromJson(element.value);
      if (object is DocumentLinksProcedure) {
  ...
  static Map<String, List<DocumentLinksProcedure>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<DocumentLinksProcedure>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<DocumentLinksProcedure>>(key, DocumentLinksProcedure.listFromJson(value));
    });
  }

  @override
  String toString() => 'DocumentLinksProcedure[href=$href, iriTemplate=$iriTemplate]';
