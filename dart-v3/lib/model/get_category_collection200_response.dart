...
,
  ...
  return GetCategoryCollection200Response(
        embedded: GetCategoryCollection200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetCategoryCollection200Response> listFromJson(Iterable? json) {
    ...
    return json.fold(<GetCategoryCollection200Response>[], (List<GetCategoryCollection200Response> previousValue, element) {
      final GetCategoryCollection200Response? object = GetCategoryCollection200Response.fromJson(element);
  ...
  static Map<String, GetCategoryCollection200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetCategoryCollection200Response>{};
    }

    return json.entries.fold(<String, GetCategoryCollection200Response>{}, (Map<String, GetCategoryCollection200Response> previousValue, element) {
      final GetCategoryCollection200Response? object = GetCategoryCollection200Response.fromJson(element.value);
      if (object is GetCategoryCollection200Response) {
  ...
  static Map<String, List<GetCategoryCollection200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetCategoryCollection200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetCategoryCollection200Response>>(key, GetCategoryCollection200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetCategoryCollection200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
