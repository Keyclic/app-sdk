...
,
  ...
  return PlaceLinksOrganization(
                  href: json[r'href'],
        iriTemplate: PlaceLinksOrganizationIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<PlaceLinksOrganization> listFromJson(Iterable? json) {
    ...
    return json.fold(<PlaceLinksOrganization>[], (List<PlaceLinksOrganization> previousValue, element) {
      final PlaceLinksOrganization? object = PlaceLinksOrganization.fromJson(element);
  ...
  static Map<String, PlaceLinksOrganization> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, PlaceLinksOrganization>{}, (Map<String, PlaceLinksOrganization> previousValue, element) {
      final PlaceLinksOrganization? object = PlaceLinksOrganization.fromJson(element.value);
      if (object is PlaceLinksOrganization) {
  ...
  static Map<String, List<PlaceLinksOrganization>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PlaceLinksOrganization>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PlaceLinksOrganization>>(key, PlaceLinksOrganization.listFromJson(value));
    });
  }

  @override
  String toString() => 'PlaceLinksOrganization[href=$href, iriTemplate=$iriTemplate]';
