...
,
  ...
  static List<AssignmentJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<AssignmentJsonhalRead>[], (List<AssignmentJsonhalRead> previousValue, element) {
      final AssignmentJsonhalRead? object = AssignmentJsonhalRead.fromJson(element);
  ...
  static Map<String, AssignmentJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, AssignmentJsonhalRead>{};
    }

    return json.entries.fold(<String, AssignmentJsonhalRead>{}, (Map<String, AssignmentJsonhalRead> previousValue, element) {
      final AssignmentJsonhalRead? object = AssignmentJsonhalRead.fromJson(element.value);
      if (object is AssignmentJsonhalRead) {
  ...
  static Map<String, List<AssignmentJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<AssignmentJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<AssignmentJsonhalRead>>(key, AssignmentJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'AssignmentJsonhalRead[links=$links, outOfContract=$outOfContract, id=$id]';
