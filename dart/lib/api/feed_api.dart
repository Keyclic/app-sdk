...
class FeedApi {
  ...
  /// Also see [Retrieve all Activity resources. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  ...
  /// Throws [DioError] if API call or serialization fails
  /// Keyclic API documentation.
  /// Also see [Create one Read resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
