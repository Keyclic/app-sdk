...
,
  ...
  return TicketJsonhalReadLinks(
        ...
        assignments: 
          GetPlaceCollection200ResponseLinksSelf.listFromJson(json[r'assignments']),
        equipments: 
          GetPlaceCollection200ResponseLinksSelf.listFromJson(json[r'equipments']),
        children: 
          GetPlaceCollection200ResponseLinksSelf.listFromJson(json[r'children']),
    );
  }
  ...
  static List<TicketJsonhalReadLinks> listFromJson(Iterable? json) {
    ...
    return json.fold(<TicketJsonhalReadLinks>[], (List<TicketJsonhalReadLinks> previousValue, element) {
      final TicketJsonhalReadLinks? object = TicketJsonhalReadLinks.fromJson(element);
  ...
  static Map<String, TicketJsonhalReadLinks> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, TicketJsonhalReadLinks>{};
    }

    return json.entries.fold(<String, TicketJsonhalReadLinks>{}, (Map<String, TicketJsonhalReadLinks> previousValue, element) {
      final TicketJsonhalReadLinks? object = TicketJsonhalReadLinks.fromJson(element.value);
      if (object is TicketJsonhalReadLinks) {
  ...
  static Map<String, List<TicketJsonhalReadLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<TicketJsonhalReadLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<TicketJsonhalReadLinks>>(key, TicketJsonhalReadLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'TicketJsonhalReadLinks[self=$self, organization=$organization, parent=$parent, assignments=$assignments, equipments=$equipments, children=$children]';
  ...
  Map<String, dynamic> toJson([Iterable<String>? keys]) {
    ...
    if (keys == null || keys.
    any((key) => RegExp(r'^parent\.').hasMatch(key))
    )
        r'parent':
            parent?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
