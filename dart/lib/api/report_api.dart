...
class ReportApi {
  ...
  Future<Response<AssignmentPagination>> cgetAssignmentsByReport({ 
    ...
    final String path = r'/reports/{report}/assignments'.replaceAll('{' r'report' '}', report.toString());
  ...
  Future<Response<DocumentPagination>> cgetDocumentsByReport({ 
    ...
    final String path = r'/reports/{report}/documents'.replaceAll('{' r'report' '}', report.toString());
    final options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        // to string ??
  ...
  Future<Response<NotePagination>> cgetNotesByTask({ 
    ...
    final String path = r'/tasks/{task}/notes'.replaceAll('{' r'task' '}', task.toString());
    final options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        // to string ??
    ...
    try {
            responseData = await _apiClient.deserializeAsync<NotePagination>(response.data!, 'NotePagination');
    } catch (error, stackTrace) {
      throw DioException(
        error: error,
        requestOptions: response.requestOptions,
  ...
  Future<Response<OperationPagination>> cgetOperationsByReport({ 
    ...
    final String path = r'/reports/{report}/operations'.replaceAll('{' r'report' '}', report.toString());
    final options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        // to string ??
  ...
  Future<Response<Report>> getReport({ 
    ...
    final String path = r'/reports/{report}'.replaceAll('{' r'report' '}', report.toString());
    final options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        // to string ??
    ...
    try {
            responseData = await _apiClient.deserializeAsync<Report>(response.data!, 'Report');
    } catch (error, stackTrace) {
      throw DioException(
        error: error,
        requestOptions: response.requestOptions,
  ...
  Future<Response<Tracking>> getTrackingByReport({ 
    ...
    final String path = r'/reports/{report}/tracking'.replaceAll('{' r'report' '}', report.toString());
    final options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        // to string ??
  ...
  Future<Response<Report>> postWorkflowByReport({ 
    ...
    final String path = r'/reports/{report}/workflow'.replaceAll('{' r'report' '}', report.toString());
    final options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        // to string ??
