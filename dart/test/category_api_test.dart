...
void main() {
  ...
  group('tests for CategoryApi', () {
    ...
    //
    //Future<Category> patchCategory(String xKeyclicApp, String category, CategoryPatch categoryPatch, { String acceptLanguage, DateTime xDateTime, String xKeyclicAppPlatform, String xKeyclicAppVersion }) async
    test('test patchCategory', () async {});

    // Create one Category resource.
    //
    //Future<Category> postCategory(String xKeyclicApp, CategoryData categoryData, { String acceptLanguage, DateTime xDateTime, String xKeyclicAppPlatform, String xKeyclicAppVersion }) async
    test('test postCategory', () async {});
  });
}
