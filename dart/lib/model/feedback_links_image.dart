...
class FeedbackLinksImage {
  ...
  static Map<String, FeedbackLinksImage> mapFromJson(
    ...
    final map = json.map((key, value) => MapEntry<String, FeedbackLinksImage?>(
        key, FeedbackLinksImage.fromJson(value)))
      ..removeWhere((_, value) => value != null);

    return map as Map<String, FeedbackLinksImage>;
  }
