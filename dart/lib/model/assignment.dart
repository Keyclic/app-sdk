...
,
  ...
  static Map<String, Assignment> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Assignment>{}, (Map<String, Assignment> previousValue, element) {
  ...
  static Map<String, List<Assignment>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<Assignment>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<Assignment>>(key, Assignment.listFromJson(value));
    });
  }

  @override
  String toString() => 'Assignment[embedded=$embedded, links=$links, createdAt=$createdAt, id=$id, outOfContract=$outOfContract, type=$type, updatedAt=$updatedAt]';
