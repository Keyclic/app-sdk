...
,
  ...
  static List<FeedbackLinksCategoryIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<FeedbackLinksCategoryIriTemplate>[], (List<FeedbackLinksCategoryIriTemplate> previousValue, element) {
      final FeedbackLinksCategoryIriTemplate? object = FeedbackLinksCategoryIriTemplate.fromJson(element);
  ...
  static Map<String, FeedbackLinksCategoryIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, FeedbackLinksCategoryIriTemplate>{};
    }

    return json.entries.fold(<String, FeedbackLinksCategoryIriTemplate>{}, (Map<String, FeedbackLinksCategoryIriTemplate> previousValue, element) {
      final FeedbackLinksCategoryIriTemplate? object = FeedbackLinksCategoryIriTemplate.fromJson(element.value);
      if (object is FeedbackLinksCategoryIriTemplate) {
  ...
  static Map<String, List<FeedbackLinksCategoryIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<FeedbackLinksCategoryIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<FeedbackLinksCategoryIriTemplate>>(key, FeedbackLinksCategoryIriTemplate.listFromJson(value));
    });
  }
