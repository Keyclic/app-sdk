...
,
  ...
  static List<PersonJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<PersonJsonhalRead>[], (List<PersonJsonhalRead> previousValue, element) {
  ...
  static Map<String, PersonJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, PersonJsonhalRead>{};
    }

    return json.entries.fold(<String, PersonJsonhalRead>{}, (Map<String, PersonJsonhalRead> previousValue, element) {
      final PersonJsonhalRead? object = PersonJsonhalRead.fromJson(element.value);
      if (object is PersonJsonhalRead) {
  ...
  static Map<String, List<PersonJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PersonJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PersonJsonhalRead>>(key, PersonJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'PersonJsonhalRead[links=$links, id=$id, image=$image, jobTitle=$jobTitle, optIn=$optIn, telephone=$telephone, email=$email, username=$username, enabled=$enabled, familyName=$familyName, givenName=$givenName, createdAt=$createdAt, updatedAt=$updatedAt, type=$type]';
