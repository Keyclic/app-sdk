...
,
  ...
  static List<Checkpoint> listFromJson(Iterable? json) {
    if (json == null) {
      return <Checkpoint>[];
    }
  ...
  static Map<String, Checkpoint> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Checkpoint>{}, (Map<String, Checkpoint> previousValue, element) {
  ...
  static Map<String, List<Checkpoint>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<Checkpoint>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<Checkpoint>>(key, Checkpoint.listFromJson(value));
    });
  }

  @override
  String toString() => 'Checkpoint[createdAt=$createdAt, data=$data, state=$state, links=$links, embedded=$embedded]';
