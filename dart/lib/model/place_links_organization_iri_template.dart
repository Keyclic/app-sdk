...
,
  ...
  static List<PlaceLinksOrganizationIriTemplate> listFromJson(Iterable? json) {
    if (json == null) {
      return <PlaceLinksOrganizationIriTemplate>[];
    }

    return json.fold(<PlaceLinksOrganizationIriTemplate>[], (List<PlaceLinksOrganizationIriTemplate> previousValue, element) {
      final PlaceLinksOrganizationIriTemplate? object = PlaceLinksOrganizationIriTemplate.fromJson(element);
  ...
  static Map<String, PlaceLinksOrganizationIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, PlaceLinksOrganizationIriTemplate>{};
    }

    return json.entries.fold(<String, PlaceLinksOrganizationIriTemplate>{}, (Map<String, PlaceLinksOrganizationIriTemplate> previousValue, element) {
      final PlaceLinksOrganizationIriTemplate? object = PlaceLinksOrganizationIriTemplate.fromJson(element.value);
      if (object is PlaceLinksOrganizationIriTemplate) {
  ...
  static Map<String, List<PlaceLinksOrganizationIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PlaceLinksOrganizationIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PlaceLinksOrganizationIriTemplate>>(key, PlaceLinksOrganizationIriTemplate.listFromJson(value));
    });
  }
