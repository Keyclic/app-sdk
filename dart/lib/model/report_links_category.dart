...
,
  ...
  return ReportLinksCategory(
                  href: json[r'href'],
        iriTemplate: ReportLinksCategoryIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<ReportLinksCategory> listFromJson(Iterable? json) {
    ...
    return json.fold(<ReportLinksCategory>[], (List<ReportLinksCategory> previousValue, element) {
  ...
  static Map<String, ReportLinksCategory> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ReportLinksCategory>{}, (Map<String, ReportLinksCategory> previousValue, element) {
      final ReportLinksCategory? object = ReportLinksCategory.fromJson(element.value);
      if (object is ReportLinksCategory) {
  ...
  static Map<String, List<ReportLinksCategory>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReportLinksCategory>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReportLinksCategory>>(key, ReportLinksCategory.listFromJson(value));
    });
  }

  @override
  String toString() => 'ReportLinksCategory[href=$href, iriTemplate=$iriTemplate]';
