...
,
  ...
  static List<NotePagination> listFromJson(Iterable? json) {
    ...
    return json.fold(<NotePagination>[], (List<NotePagination> previousValue, element) {
  ...
  static Map<String, NotePagination> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, NotePagination>{}, (Map<String, NotePagination> previousValue, element) {
  ...
  static Map<String, List<NotePagination>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<NotePagination>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<NotePagination>>(key, NotePagination.listFromJson(value));
    });
  }

  @override
  String toString() => 'NotePagination[limit=$limit, page=$page, pages=$pages, total=$total, links=$links, embedded=$embedded]';
