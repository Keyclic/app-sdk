...
,
  ...
  return ReportLinksChildren(
                  href: json[r'href'],
        iriTemplate: ReportLinksChildrenIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<ReportLinksChildren> listFromJson(Iterable? json) {
    if (json == null) {
      return <ReportLinksChildren>[];
    }

    return json.fold(<ReportLinksChildren>[], (List<ReportLinksChildren> previousValue, element) {
  ...
  static Map<String, ReportLinksChildren> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ReportLinksChildren>{};
    }

    return json.entries.fold(<String, ReportLinksChildren>{}, (Map<String, ReportLinksChildren> previousValue, element) {
      final ReportLinksChildren? object = ReportLinksChildren.fromJson(element.value);
      if (object is ReportLinksChildren) {
  ...
  static Map<String, List<ReportLinksChildren>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReportLinksChildren>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReportLinksChildren>>(key, ReportLinksChildren.listFromJson(value));
    });
  }

  @override
  String toString() => 'ReportLinksChildren[href=$href, iriTemplate=$iriTemplate]';
