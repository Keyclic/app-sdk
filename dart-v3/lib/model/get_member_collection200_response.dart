...
,
  ...
  return GetMemberCollection200Response(
        embedded: GetMemberCollection200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetMemberCollection200Response> listFromJson(Iterable? json) {
    ...
    return json.fold(<GetMemberCollection200Response>[], (List<GetMemberCollection200Response> previousValue, element) {
      final GetMemberCollection200Response? object = GetMemberCollection200Response.fromJson(element);
  ...
  static Map<String, GetMemberCollection200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetMemberCollection200Response>{};
    }

    return json.entries.fold(<String, GetMemberCollection200Response>{}, (Map<String, GetMemberCollection200Response> previousValue, element) {
      final GetMemberCollection200Response? object = GetMemberCollection200Response.fromJson(element.value);
      if (object is GetMemberCollection200Response) {
  ...
  static Map<String, List<GetMemberCollection200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetMemberCollection200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetMemberCollection200Response>>(key, GetMemberCollection200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetMemberCollection200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
