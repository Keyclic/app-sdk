...
,
  ...
  static List<BookmarkJsonhalReadEmbedded> listFromJson(Iterable? json) {
    ...
    return json.fold(<BookmarkJsonhalReadEmbedded>[], (List<BookmarkJsonhalReadEmbedded> previousValue, element) {
      final BookmarkJsonhalReadEmbedded? object = BookmarkJsonhalReadEmbedded.fromJson(element);
  ...
  static Map<String, BookmarkJsonhalReadEmbedded> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, BookmarkJsonhalReadEmbedded>{};
    }

    return json.entries.fold(<String, BookmarkJsonhalReadEmbedded>{}, (Map<String, BookmarkJsonhalReadEmbedded> previousValue, element) {
      final BookmarkJsonhalReadEmbedded? object = BookmarkJsonhalReadEmbedded.fromJson(element.value);
      if (object is BookmarkJsonhalReadEmbedded) {
  ...
  static Map<String, List<BookmarkJsonhalReadEmbedded>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<BookmarkJsonhalReadEmbedded>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<BookmarkJsonhalReadEmbedded>>(key, BookmarkJsonhalReadEmbedded.listFromJson(value));
    });
  }

  @override
  String toString() => 'BookmarkJsonhalReadEmbedded[place=$place, member=$member]';
