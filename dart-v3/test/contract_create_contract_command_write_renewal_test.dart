...
// tests for ContractCreateContractCommandWriteRenewal
void main() {
  // final instance = ContractCreateContractCommandWriteRenewal();

  group('test ContractCreateContractCommandWriteRenewal', () {
    ...
    // String noticePeriod
    test('to test the property `noticePeriod`', () async {});
  });
}
