...
,
  ...
  static List<GetAuthTokenRequest> listFromJson(Iterable? json) {
    ...
    return json.fold(<GetAuthTokenRequest>[], (List<GetAuthTokenRequest> previousValue, element) {
  ...
  static Map<String, GetAuthTokenRequest> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetAuthTokenRequest>{};
    }

    return json.entries.fold(<String, GetAuthTokenRequest>{}, (Map<String, GetAuthTokenRequest> previousValue, element) {
      final GetAuthTokenRequest? object = GetAuthTokenRequest.fromJson(element.value);
      if (object is GetAuthTokenRequest) {
  ...
  static Map<String, List<GetAuthTokenRequest>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetAuthTokenRequest>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetAuthTokenRequest>>(key, GetAuthTokenRequest.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetAuthTokenRequest[grantType=$grantType, idToken=$idToken]';

  Map<String, dynamic> toJson([Iterable<String>? keys]) {
    return <String, dynamic>{
    if (keys == null || keys.
    contains(r'grantType')
    )
        r'grantType':
          grantType,
    if (keys == null || keys.
...
class GetAuthTokenRequestGrantTypeEnum {
  ...
  static const externalAuth = GetAuthTokenRequestGrantTypeEnum._(r'external_auth');
  ...
  static List<GetAuthTokenRequestGrantTypeEnum> listFromJson(List<dynamic> json) {
    return json.map((value) {
      return GetAuthTokenRequestGrantTypeEnum.fromJson(value);
    }).whereType<GetAuthTokenRequestGrantTypeEnum>().toList();
  }
}
...
class GetAuthTokenRequestGrantTypeEnumTypeTransformer {
  ...
  factory GetAuthTokenRequestGrantTypeEnumTypeTransformer() => _instance ??= GetAuthTokenRequestGrantTypeEnumTypeTransformer._();
  ...
  GetAuthTokenRequestGrantTypeEnum? decode(dynamic data, {bool allowNull = true}) {
    switch (data) {
      case r'external_auth': return GetAuthTokenRequestGrantTypeEnum.externalAuth;
      default:
        if (allowNull == false) {
