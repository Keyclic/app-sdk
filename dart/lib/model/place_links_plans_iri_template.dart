...
,
  ...
  static List<PlaceLinksPlansIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<PlaceLinksPlansIriTemplate>[], (List<PlaceLinksPlansIriTemplate> previousValue, element) {
      final PlaceLinksPlansIriTemplate? object = PlaceLinksPlansIriTemplate.fromJson(element);
  ...
  static Map<String, PlaceLinksPlansIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, PlaceLinksPlansIriTemplate>{};
    }

    return json.entries.fold(<String, PlaceLinksPlansIriTemplate>{}, (Map<String, PlaceLinksPlansIriTemplate> previousValue, element) {
      final PlaceLinksPlansIriTemplate? object = PlaceLinksPlansIriTemplate.fromJson(element.value);
      if (object is PlaceLinksPlansIriTemplate) {
  ...
  static Map<String, List<PlaceLinksPlansIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PlaceLinksPlansIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PlaceLinksPlansIriTemplate>>(key, PlaceLinksPlansIriTemplate.listFromJson(value));
    });
  }
