...
,
  ...
  static List<PlaceLinksGeoIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<PlaceLinksGeoIriTemplate>[], (List<PlaceLinksGeoIriTemplate> previousValue, element) {
      final PlaceLinksGeoIriTemplate? object = PlaceLinksGeoIriTemplate.fromJson(element);
  ...
  static Map<String, PlaceLinksGeoIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, PlaceLinksGeoIriTemplate>{};
    }

    return json.entries.fold(<String, PlaceLinksGeoIriTemplate>{}, (Map<String, PlaceLinksGeoIriTemplate> previousValue, element) {
      final PlaceLinksGeoIriTemplate? object = PlaceLinksGeoIriTemplate.fromJson(element.value);
      if (object is PlaceLinksGeoIriTemplate) {
  ...
  static Map<String, List<PlaceLinksGeoIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PlaceLinksGeoIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PlaceLinksGeoIriTemplate>>(key, PlaceLinksGeoIriTemplate.listFromJson(value));
    });
  }
