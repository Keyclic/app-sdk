...
,
  ...
  return OrganizationLinksBusinessActivity(
                  href: json[r'href'],
        iriTemplate: OrganizationLinksBusinessActivityIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<OrganizationLinksBusinessActivity> listFromJson(Iterable? json) {
    ...
    return json.fold(<OrganizationLinksBusinessActivity>[], (List<OrganizationLinksBusinessActivity> previousValue, element) {
      final OrganizationLinksBusinessActivity? object = OrganizationLinksBusinessActivity.fromJson(element);
  ...
  static Map<String, OrganizationLinksBusinessActivity> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OrganizationLinksBusinessActivity>{}, (Map<String, OrganizationLinksBusinessActivity> previousValue, element) {
      final OrganizationLinksBusinessActivity? object = OrganizationLinksBusinessActivity.fromJson(element.value);
      if (object is OrganizationLinksBusinessActivity) {
  ...
  static Map<String, List<OrganizationLinksBusinessActivity>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OrganizationLinksBusinessActivity>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OrganizationLinksBusinessActivity>>(key, OrganizationLinksBusinessActivity.listFromJson(value));
    });
  }

  @override
  String toString() => 'OrganizationLinksBusinessActivity[href=$href, iriTemplate=$iriTemplate]';
