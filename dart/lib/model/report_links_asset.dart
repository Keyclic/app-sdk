...
,
  ...
  static List<ReportLinksAsset> listFromJson(Iterable? json) {
    ...
    return json.fold(<ReportLinksAsset>[], (List<ReportLinksAsset> previousValue, element) {
  ...
  static Map<String, ReportLinksAsset> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ReportLinksAsset>{}, (Map<String, ReportLinksAsset> previousValue, element) {
  ...
  static Map<String, List<ReportLinksAsset>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReportLinksAsset>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReportLinksAsset>>(key, ReportLinksAsset.listFromJson(value));
    });
  }
