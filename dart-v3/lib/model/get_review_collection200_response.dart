...
,
  ...
  return GetReviewCollection200Response(
        embedded: GetReviewCollection200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetReviewCollection200Response> listFromJson(Iterable? json) {
    ...
    return json.fold(<GetReviewCollection200Response>[], (List<GetReviewCollection200Response> previousValue, element) {
      final GetReviewCollection200Response? object = GetReviewCollection200Response.fromJson(element);
  ...
  static Map<String, GetReviewCollection200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetReviewCollection200Response>{};
    }

    return json.entries.fold(<String, GetReviewCollection200Response>{}, (Map<String, GetReviewCollection200Response> previousValue, element) {
      final GetReviewCollection200Response? object = GetReviewCollection200Response.fromJson(element.value);
      if (object is GetReviewCollection200Response) {
  ...
  static Map<String, List<GetReviewCollection200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetReviewCollection200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetReviewCollection200Response>>(key, GetReviewCollection200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetReviewCollection200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
