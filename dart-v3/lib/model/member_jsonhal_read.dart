...
,
  ...
  static List<MemberJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<MemberJsonhalRead>[], (List<MemberJsonhalRead> previousValue, element) {
  ...
  static Map<String, MemberJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, MemberJsonhalRead>{};
    }

    return json.entries.fold(<String, MemberJsonhalRead>{}, (Map<String, MemberJsonhalRead> previousValue, element) {
      final MemberJsonhalRead? object = MemberJsonhalRead.fromJson(element.value);
      if (object is MemberJsonhalRead) {
  ...
  static Map<String, List<MemberJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<MemberJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<MemberJsonhalRead>>(key, MemberJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'MemberJsonhalRead[links=$links, contactPoint=$contactPoint, id=$id, createdAt=$createdAt, updatedAt=$updatedAt, type=$type, embedded=$embedded]';
