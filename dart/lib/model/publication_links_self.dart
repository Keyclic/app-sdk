...
,
  ...
  return PublicationLinksSelf(
                  href: json[r'href'],
        iriTemplate: PublicationLinksSelfIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<PublicationLinksSelf> listFromJson(Iterable? json) {
    ...
    return json.fold(<PublicationLinksSelf>[], (List<PublicationLinksSelf> previousValue, element) {
      final PublicationLinksSelf? object = PublicationLinksSelf.fromJson(element);
  ...
  static Map<String, PublicationLinksSelf> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, PublicationLinksSelf>{}, (Map<String, PublicationLinksSelf> previousValue, element) {
      final PublicationLinksSelf? object = PublicationLinksSelf.fromJson(element.value);
      if (object is PublicationLinksSelf) {
  ...
  static Map<String, List<PublicationLinksSelf>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PublicationLinksSelf>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PublicationLinksSelf>>(key, PublicationLinksSelf.listFromJson(value));
    });
  }

  @override
  String toString() => 'PublicationLinksSelf[href=$href, iriTemplate=$iriTemplate]';
