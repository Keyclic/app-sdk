...
class ReviewRequestApi {
  ...
  /// Parameters:
  /// * [xKeyclicApp]
  /// * [reviewRequest] - The identifier of the resource.
  /// * [acceptLanguage]
  /// * [xDateTime]
  /// * [xKeyclicAppPlatform]
  /// * [xKeyclicAppVersion]
  ...
  /// Also see [Retrieve one ReviewRequest resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  Future<Response<ReviewRequest>> getReviewRequest({
    required String xKeyclicApp,
    required String reviewRequest,
    ...
    final String path = r'/review-requests/{reviewRequest}'
        .replaceAll('{' r'reviewRequest' '}', reviewRequest.toString());
