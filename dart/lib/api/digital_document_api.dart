...
class DigitalDocumentApi {
  ...
  Future<Response<FeedbackPagination>> cgetFeedbackByDigitalDocument({ 
    ...
    final String path = r'/digital-documents/{digitalDocument}/feedbacks'.replaceAll('{' r'digitalDocument' '}', digitalDocument.toString());
  ...
  Future<Response<void>> deleteDigitalDocument({ 
    ...
    final String path = r'/digital-documents/{digitalDocument}'.replaceAll('{' r'digitalDocument' '}', digitalDocument.toString());
    final options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        // to string ??
