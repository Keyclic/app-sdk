...
,
  ...
  bool operator ==(Object other) {
    ...
    return other is ReportLinksAssetIriTemplate 
  ...
  static List<ReportLinksAssetIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<ReportLinksAssetIriTemplate>[], (List<ReportLinksAssetIriTemplate> previousValue, element) {
      final ReportLinksAssetIriTemplate? object = ReportLinksAssetIriTemplate.fromJson(element);
  ...
  static Map<String, ReportLinksAssetIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ReportLinksAssetIriTemplate>{};
    }

    return json.entries.fold(<String, ReportLinksAssetIriTemplate>{}, (Map<String, ReportLinksAssetIriTemplate> previousValue, element) {
      final ReportLinksAssetIriTemplate? object = ReportLinksAssetIriTemplate.fromJson(element.value);
      if (object is ReportLinksAssetIriTemplate) {
  ...
  static Map<String, List<ReportLinksAssetIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReportLinksAssetIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReportLinksAssetIriTemplate>>(key, ReportLinksAssetIriTemplate.listFromJson(value));
    });
  }
