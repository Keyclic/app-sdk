...
class ServiceApi {
  ...
  Future<Response> getServiceWithHttpInfo(
    String xKeyclicApp,
    String service, {
    String acceptLanguage,
    DateTime xDateTime,
    ...
    if (service == null) {
      throw ApiException(
          HttpStatus.badRequest, 'Missing required param: service');
    }
  ...
  Future<Service> getService(
    ...
    final response = await getServiceWithHttpInfo(
      xKeyclicApp,
      service,
    ...
    if (response.body == null || response.statusCode == HttpStatus.noContent) {
      return Future<Service>.value(null);
    }
