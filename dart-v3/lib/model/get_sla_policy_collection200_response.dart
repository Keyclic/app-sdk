...
,
  ...
  return GetSlaPolicyCollection200Response(
        embedded: GetSlaPolicyCollection200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetSlaPolicyCollection200Response> listFromJson(Iterable? json) {
    ...
    return json.fold(<GetSlaPolicyCollection200Response>[], (List<GetSlaPolicyCollection200Response> previousValue, element) {
      final GetSlaPolicyCollection200Response? object = GetSlaPolicyCollection200Response.fromJson(element);
  ...
  static Map<String, GetSlaPolicyCollection200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetSlaPolicyCollection200Response>{};
    }

    return json.entries.fold(<String, GetSlaPolicyCollection200Response>{}, (Map<String, GetSlaPolicyCollection200Response> previousValue, element) {
      final GetSlaPolicyCollection200Response? object = GetSlaPolicyCollection200Response.fromJson(element.value);
      if (object is GetSlaPolicyCollection200Response) {
  ...
  static Map<String, List<GetSlaPolicyCollection200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetSlaPolicyCollection200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetSlaPolicyCollection200Response>>(key, GetSlaPolicyCollection200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetSlaPolicyCollection200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
