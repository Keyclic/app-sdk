...
,
  ...
  static List<WarrantyWrite> listFromJson(Iterable? json) {
    ...
    return json.fold(<WarrantyWrite>[], (List<WarrantyWrite> previousValue, element) {
  ...
  static Map<String, WarrantyWrite> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, WarrantyWrite>{}, (Map<String, WarrantyWrite> previousValue, element) {
  ...
  static Map<String, List<WarrantyWrite>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<WarrantyWrite>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<WarrantyWrite>>(key, WarrantyWrite.listFromJson(value));
    });
  }

  @override
  String toString() => 'WarrantyWrite[duration=$duration, startDate=$startDate]';
