...
class ServicePostalAddress {
  ...
  static List<ServicePostalAddress> listFromJson(List<dynamic>? json) {
    ...
    return json
        ...
        .whereType<ServicePostalAddress>()
        .toList();
  }
  ...
  static Map<String, ServicePostalAddress> mapFromJson(
    ...
    final map = json.map((key, value) =>
        MapEntry<String, ServicePostalAddress?>(
            key, ServicePostalAddress.fromJson(value)))
      ..removeWhere((_, value) => value != null);

    return map as Map<String, ServicePostalAddress>;
  }
