...
,
  ...
  static List<OccupantLinksPlaceIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<OccupantLinksPlaceIriTemplate>[], (List<OccupantLinksPlaceIriTemplate> previousValue, element) {
      final OccupantLinksPlaceIriTemplate? object = OccupantLinksPlaceIriTemplate.fromJson(element);
  ...
  static Map<String, OccupantLinksPlaceIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OccupantLinksPlaceIriTemplate>{}, (Map<String, OccupantLinksPlaceIriTemplate> previousValue, element) {
      final OccupantLinksPlaceIriTemplate? object = OccupantLinksPlaceIriTemplate.fromJson(element.value);
      if (object is OccupantLinksPlaceIriTemplate) {
  ...
  static Map<String, List<OccupantLinksPlaceIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OccupantLinksPlaceIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OccupantLinksPlaceIriTemplate>>(key, OccupantLinksPlaceIriTemplate.listFromJson(value));
    });
  }
