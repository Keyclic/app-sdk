...
,
  ...
  return ReportLinksWorkflow(
                  href: json[r'href'],
        iriTemplate: ReportLinksWorkflowIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<ReportLinksWorkflow> listFromJson(Iterable? json) {
    ...
    return json.fold(<ReportLinksWorkflow>[], (List<ReportLinksWorkflow> previousValue, element) {
  ...
  static Map<String, ReportLinksWorkflow> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ReportLinksWorkflow>{};
    }

    return json.entries.fold(<String, ReportLinksWorkflow>{}, (Map<String, ReportLinksWorkflow> previousValue, element) {
      final ReportLinksWorkflow? object = ReportLinksWorkflow.fromJson(element.value);
      if (object is ReportLinksWorkflow) {
  ...
  static Map<String, List<ReportLinksWorkflow>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReportLinksWorkflow>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReportLinksWorkflow>>(key, ReportLinksWorkflow.listFromJson(value));
    });
  }

  @override
  String toString() => 'ReportLinksWorkflow[href=$href, iriTemplate=$iriTemplate]';
