...
,
  ...
  static List<NoteLinksAuthorIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<NoteLinksAuthorIriTemplate>[], (List<NoteLinksAuthorIriTemplate> previousValue, element) {
      final NoteLinksAuthorIriTemplate? object = NoteLinksAuthorIriTemplate.fromJson(element);
  ...
  static Map<String, NoteLinksAuthorIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, NoteLinksAuthorIriTemplate>{};
    }

    return json.entries.fold(<String, NoteLinksAuthorIriTemplate>{}, (Map<String, NoteLinksAuthorIriTemplate> previousValue, element) {
      final NoteLinksAuthorIriTemplate? object = NoteLinksAuthorIriTemplate.fromJson(element.value);
      if (object is NoteLinksAuthorIriTemplate) {
  ...
  static Map<String, List<NoteLinksAuthorIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<NoteLinksAuthorIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<NoteLinksAuthorIriTemplate>>(key, NoteLinksAuthorIriTemplate.listFromJson(value));
    });
  }
