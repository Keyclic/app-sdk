...
class ExportApi {
  ...
  Future<Response> getExportWithHttpInfo(
    String xKeyclicApp,
    String export_, {
    String acceptLanguage,
    DateTime xDateTime,
    ...
    if (export_ == null) {
      throw ApiException(
          HttpStatus.badRequest, 'Missing required param: export_');
    }

    final path = r'/exports/{export}'
  ...
  Future<ModelExport> getExport(
    ...
    final response = await getExportWithHttpInfo(
      xKeyclicApp,
      export_,
