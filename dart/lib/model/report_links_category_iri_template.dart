...
,
  ...
  static List<ReportLinksCategoryIriTemplate> listFromJson(Iterable? json) {
    if (json == null) {
      return <ReportLinksCategoryIriTemplate>[];
    }

    return json.fold(<ReportLinksCategoryIriTemplate>[], (List<ReportLinksCategoryIriTemplate> previousValue, element) {
      final ReportLinksCategoryIriTemplate? object = ReportLinksCategoryIriTemplate.fromJson(element);
  ...
  static Map<String, ReportLinksCategoryIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ReportLinksCategoryIriTemplate>{};
    }

    return json.entries.fold(<String, ReportLinksCategoryIriTemplate>{}, (Map<String, ReportLinksCategoryIriTemplate> previousValue, element) {
      final ReportLinksCategoryIriTemplate? object = ReportLinksCategoryIriTemplate.fromJson(element.value);
      if (object is ReportLinksCategoryIriTemplate) {
  ...
  static Map<String, List<ReportLinksCategoryIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReportLinksCategoryIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReportLinksCategoryIriTemplate>>(key, ReportLinksCategoryIriTemplate.listFromJson(value));
    });
  }
