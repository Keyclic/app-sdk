...
,
  ...
  static List<InternalServicePagination> listFromJson(Iterable? json) {
    if (json == null) {
      return <InternalServicePagination>[];
    }

    return json.fold(<InternalServicePagination>[], (List<InternalServicePagination> previousValue, element) {
      final InternalServicePagination? object = InternalServicePagination.fromJson(element);
  ...
  static Map<String, InternalServicePagination> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, InternalServicePagination>{};
    }

    return json.entries.fold(<String, InternalServicePagination>{}, (Map<String, InternalServicePagination> previousValue, element) {
      final InternalServicePagination? object = InternalServicePagination.fromJson(element.value);
      if (object is InternalServicePagination) {
  ...
  static Map<String, List<InternalServicePagination>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<InternalServicePagination>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<InternalServicePagination>>(key, InternalServicePagination.listFromJson(value));
    });
  }

  @override
  String toString() => 'InternalServicePagination[limit=$limit, page=$page, pages=$pages, total=$total, links=$links, embedded=$embedded]';
