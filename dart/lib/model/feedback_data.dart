...
class FeedbackData {
  ...
  @override
  String toString() =>
      'FeedbackData[batch=$batch, businessActivity=$businessActivity, category=$category, description=$description, geo=$geo, metadata=$metadata, place=$place, reporter=$reporter, visibility=$visibility]';
