...
,
  ...
  static List<ExternalServicePagination> listFromJson(Iterable? json) {
    ...
    return json.fold(<ExternalServicePagination>[], (List<ExternalServicePagination> previousValue, element) {
      final ExternalServicePagination? object = ExternalServicePagination.fromJson(element);
  ...
  static Map<String, ExternalServicePagination> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ExternalServicePagination>{};
    }

    return json.entries.fold(<String, ExternalServicePagination>{}, (Map<String, ExternalServicePagination> previousValue, element) {
      final ExternalServicePagination? object = ExternalServicePagination.fromJson(element.value);
      if (object is ExternalServicePagination) {
  ...
  static Map<String, List<ExternalServicePagination>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ExternalServicePagination>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ExternalServicePagination>>(key, ExternalServicePagination.listFromJson(value));
    });
  }

  @override
  String toString() => 'ExternalServicePagination[limit=$limit, page=$page, pages=$pages, total=$total, links=$links, embedded=$embedded]';
