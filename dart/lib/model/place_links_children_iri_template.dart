...
,
  ...
  static List<PlaceLinksChildrenIriTemplate> listFromJson(Iterable? json) {
    if (json == null) {
      return <PlaceLinksChildrenIriTemplate>[];
    }

    return json.fold(<PlaceLinksChildrenIriTemplate>[], (List<PlaceLinksChildrenIriTemplate> previousValue, element) {
      final PlaceLinksChildrenIriTemplate? object = PlaceLinksChildrenIriTemplate.fromJson(element);
  ...
  static Map<String, PlaceLinksChildrenIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, PlaceLinksChildrenIriTemplate>{};
    }

    return json.entries.fold(<String, PlaceLinksChildrenIriTemplate>{}, (Map<String, PlaceLinksChildrenIriTemplate> previousValue, element) {
      final PlaceLinksChildrenIriTemplate? object = PlaceLinksChildrenIriTemplate.fromJson(element.value);
      if (object is PlaceLinksChildrenIriTemplate) {
  ...
  static Map<String, List<PlaceLinksChildrenIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PlaceLinksChildrenIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PlaceLinksChildrenIriTemplate>>(key, PlaceLinksChildrenIriTemplate.listFromJson(value));
    });
  }
