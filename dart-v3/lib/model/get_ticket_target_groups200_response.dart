...
,
  ...
  return GetTicketTargetGroups200Response(
        embedded: GetTicketTargetGroups200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetTicketTargetGroups200Response> listFromJson(Iterable? json) {
    ...
    return json.fold(<GetTicketTargetGroups200Response>[], (List<GetTicketTargetGroups200Response> previousValue, element) {
      final GetTicketTargetGroups200Response? object = GetTicketTargetGroups200Response.fromJson(element);
  ...
  static Map<String, GetTicketTargetGroups200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetTicketTargetGroups200Response>{};
    }

    return json.entries.fold(<String, GetTicketTargetGroups200Response>{}, (Map<String, GetTicketTargetGroups200Response> previousValue, element) {
      final GetTicketTargetGroups200Response? object = GetTicketTargetGroups200Response.fromJson(element.value);
      if (object is GetTicketTargetGroups200Response) {
  ...
  static Map<String, List<GetTicketTargetGroups200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetTicketTargetGroups200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetTicketTargetGroups200Response>>(key, GetTicketTargetGroups200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetTicketTargetGroups200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
