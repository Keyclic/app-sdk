...
,
  ...
  return IntegrationJsonhalRead(
        links: IntegrationJsonhalReadLinks.fromJson(json[r'_links']),
            inputs:
              json[r'inputs'] == null ? null : Map<String, Object?>.from(json[r'inputs']),
                  id: json[r'id'],
  ...
  static List<IntegrationJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<IntegrationJsonhalRead>[], (List<IntegrationJsonhalRead> previousValue, element) {
      final IntegrationJsonhalRead? object = IntegrationJsonhalRead.fromJson(element);
  ...
  static Map<String, IntegrationJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, IntegrationJsonhalRead>{};
    }

    return json.entries.fold(<String, IntegrationJsonhalRead>{}, (Map<String, IntegrationJsonhalRead> previousValue, element) {
      final IntegrationJsonhalRead? object = IntegrationJsonhalRead.fromJson(element.value);
      if (object is IntegrationJsonhalRead) {
  ...
  static Map<String, List<IntegrationJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<IntegrationJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<IntegrationJsonhalRead>>(key, IntegrationJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'IntegrationJsonhalRead[links=$links, inputs=$inputs, id=$id, createdAt=$createdAt, updatedAt=$updatedAt, name=$name]';
