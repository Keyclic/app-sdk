...
,
  ...
  static List<PersonPatch> listFromJson(Iterable? json) {
    ...
    return json.fold(<PersonPatch>[], (List<PersonPatch> previousValue, element) {
  ...
  static Map<String, PersonPatch> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, PersonPatch>{}, (Map<String, PersonPatch> previousValue, element) {
  ...
  static Map<String, List<PersonPatch>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PersonPatch>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PersonPatch>>(key, PersonPatch.listFromJson(value));
    });
  }

  @override
  String toString() => 'PersonPatch[agreement=$agreement, givenName=$givenName, familyName=$familyName, email=$email, jobTitle=$jobTitle, image=$image, optIn=$optIn, preferences=$preferences, telephone=$telephone]';
