...
,
  ...
  static List<OccupantLinksSelf> listFromJson(Iterable? json) {
    ...
    return json.fold(<OccupantLinksSelf>[], (List<OccupantLinksSelf> previousValue, element) {
  ...
  static Map<String, OccupantLinksSelf> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OccupantLinksSelf>{}, (Map<String, OccupantLinksSelf> previousValue, element) {
      final OccupantLinksSelf? object = OccupantLinksSelf.fromJson(element.value);
      if (object is OccupantLinksSelf) {
  ...
  static Map<String, List<OccupantLinksSelf>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OccupantLinksSelf>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OccupantLinksSelf>>(key, OccupantLinksSelf.listFromJson(value));
    });
  }

  @override
  String toString() => 'OccupantLinksSelf[href=$href, iriTemplate=$iriTemplate]';
