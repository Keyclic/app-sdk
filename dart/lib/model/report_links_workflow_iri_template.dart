...
,
  ...
  bool operator ==(Object other) {
    ...
    return other is ReportLinksWorkflowIriTemplate 
  ...
  static List<ReportLinksWorkflowIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<ReportLinksWorkflowIriTemplate>[], (List<ReportLinksWorkflowIriTemplate> previousValue, element) {
      final ReportLinksWorkflowIriTemplate? object = ReportLinksWorkflowIriTemplate.fromJson(element);
  ...
  static Map<String, ReportLinksWorkflowIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ReportLinksWorkflowIriTemplate>{};
    }

    return json.entries.fold(<String, ReportLinksWorkflowIriTemplate>{}, (Map<String, ReportLinksWorkflowIriTemplate> previousValue, element) {
      final ReportLinksWorkflowIriTemplate? object = ReportLinksWorkflowIriTemplate.fromJson(element.value);
      if (object is ReportLinksWorkflowIriTemplate) {
  ...
  static Map<String, List<ReportLinksWorkflowIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReportLinksWorkflowIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReportLinksWorkflowIriTemplate>>(key, ReportLinksWorkflowIriTemplate.listFromJson(value));
    });
  }
