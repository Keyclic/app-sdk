...
,
  ...
  static List<OperationEmbedded> listFromJson(Iterable? json) {
    ...
    return json.fold(<OperationEmbedded>[], (List<OperationEmbedded> previousValue, element) {
  ...
  static Map<String, OperationEmbedded> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OperationEmbedded>{}, (Map<String, OperationEmbedded> previousValue, element) {
      final OperationEmbedded? object = OperationEmbedded.fromJson(element.value);
      if (object is OperationEmbedded) {
  ...
  static Map<String, List<OperationEmbedded>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OperationEmbedded>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OperationEmbedded>>(key, OperationEmbedded.listFromJson(value));
    });
  }

  @override
  String toString() => 'OperationEmbedded[createdBy=$createdBy, documentTypes=$documentTypes, documents=$documents, operator_=$operator_, targetGroups=$targetGroups, workflow=$workflow]';
