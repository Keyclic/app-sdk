...
,
  ...
  static SectionLinksSelf? fromJson(Object? json) {
  ...
  static List<SectionLinksSelf> listFromJson(Iterable? json) {
    ...
    return json.fold(<SectionLinksSelf>[], (List<SectionLinksSelf> previousValue, element) {
  ...
  static Map<String, SectionLinksSelf> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, SectionLinksSelf>{}, (Map<String, SectionLinksSelf> previousValue, element) {
  ...
  static Map<String, List<SectionLinksSelf>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<SectionLinksSelf>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<SectionLinksSelf>>(key, SectionLinksSelf.listFromJson(value));
    });
  }
