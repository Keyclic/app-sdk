...
,
  ...
  static List<BookmarkLinksSelfIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<BookmarkLinksSelfIriTemplate>[], (List<BookmarkLinksSelfIriTemplate> previousValue, element) {
      final BookmarkLinksSelfIriTemplate? object = BookmarkLinksSelfIriTemplate.fromJson(element);
  ...
  static Map<String, BookmarkLinksSelfIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, BookmarkLinksSelfIriTemplate>{};
    }

    return json.entries.fold(<String, BookmarkLinksSelfIriTemplate>{}, (Map<String, BookmarkLinksSelfIriTemplate> previousValue, element) {
      final BookmarkLinksSelfIriTemplate? object = BookmarkLinksSelfIriTemplate.fromJson(element.value);
      if (object is BookmarkLinksSelfIriTemplate) {
  ...
  static Map<String, List<BookmarkLinksSelfIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<BookmarkLinksSelfIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<BookmarkLinksSelfIriTemplate>>(key, BookmarkLinksSelfIriTemplate.listFromJson(value));
    });
  }
