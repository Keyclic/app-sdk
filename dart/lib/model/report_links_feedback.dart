...
,
  ...
  return ReportLinksFeedback(
                  href: json[r'href'],
        iriTemplate: ReportLinksFeedbackIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<ReportLinksFeedback> listFromJson(Iterable? json) {
    ...
    return json.fold(<ReportLinksFeedback>[], (List<ReportLinksFeedback> previousValue, element) {
  ...
  static Map<String, ReportLinksFeedback> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ReportLinksFeedback>{}, (Map<String, ReportLinksFeedback> previousValue, element) {
      final ReportLinksFeedback? object = ReportLinksFeedback.fromJson(element.value);
      if (object is ReportLinksFeedback) {
  ...
  static Map<String, List<ReportLinksFeedback>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReportLinksFeedback>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReportLinksFeedback>>(key, ReportLinksFeedback.listFromJson(value));
    });
  }

  @override
  String toString() => 'ReportLinksFeedback[href=$href, iriTemplate=$iriTemplate]';
