...
class TemplateApi {
  ...
  /// Also see [Remove one Template resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  ...
  /// Throws [DioError] if API call or serialization fails
  /// Keyclic API documentation.
  /// Also see [Retrieve one Template resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  ...
  /// Throws [DioError] if API call or serialization fails
  /// Keyclic API documentation.
  /// Also see [Edit one Template resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  Future<Response<Template>> patchTemplate({
    ...
    try {
      bodyData = templatePatch.toJson();
      // bodyData = jsonEncode(templatePatch);
      // bodyData = jsonDecode(jsonEncode(templatePatch));
    } catch (error, stackTrace) {
      throw DioError(
  ...
  /// Throws [DioError] if API call or serialization fails
  /// Keyclic API documentation.
  /// Also see [Create one Template resource. Documentation](http://docs.keyclic.com/fr/master/overview.html)
  Future<Response<Template>> postTemplate({
    ...
    try {
      bodyData = templateData.toJson();
      // bodyData = jsonEncode(templateData);
      // bodyData = jsonDecode(jsonEncode(templateData));
    } catch (error, stackTrace) {
      throw DioError(
        requestOptions: options.compose(
          _apiClient.dio.options,
