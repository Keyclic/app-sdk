...
,
  ...
  return ArticleLinksSection(
                  href: json[r'href'],
        iriTemplate: ArticleLinksSectionIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<ArticleLinksSection> listFromJson(Iterable? json) {
    if (json == null) {
      return <ArticleLinksSection>[];
    }

    return json.fold(<ArticleLinksSection>[], (List<ArticleLinksSection> previousValue, element) {
  ...
  static Map<String, ArticleLinksSection> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ArticleLinksSection>{};
    }

    return json.entries.fold(<String, ArticleLinksSection>{}, (Map<String, ArticleLinksSection> previousValue, element) {
      final ArticleLinksSection? object = ArticleLinksSection.fromJson(element.value);
      if (object is ArticleLinksSection) {
  ...
  static Map<String, List<ArticleLinksSection>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ArticleLinksSection>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ArticleLinksSection>>(key, ArticleLinksSection.listFromJson(value));
    });
  }

  @override
  String toString() => 'ArticleLinksSection[href=$href, iriTemplate=$iriTemplate]';
