...
class AssetTypeApi {
  ...
  Future<Response<AssetTypeJsonhalRead>> getAssetType({ 
    ...
    final String path = r'/asset-types/{identifier}'.replaceAll('{' r'identifier' '}', identifier.toString());
    ...
    try {
            responseData = await _apiClient.deserializeAsync<AssetTypeJsonhalRead>(response.data!, 'AssetTypeJsonhalRead');
  ...
  Future<Response<GetAssetTypeCollection200Response>> getAssetTypeCollection({ 
    ...
    try {
            responseData = await _apiClient.deserializeAsync<GetAssetTypeCollection200Response>(response.data!, 'GetAssetTypeCollection200Response');
    } catch (error, stackTrace) {
      throw DioException(
        error: error,
        requestOptions: response.requestOptions,
