...
,
  ...
  static Map<String, RuleLinks> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, RuleLinks>{}, (Map<String, RuleLinks> previousValue, element) {
  ...
  static Map<String, List<RuleLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<RuleLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<RuleLinks>>(key, RuleLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'RuleLinks[category=$category, place=$place, self=$self, service=$service]';
