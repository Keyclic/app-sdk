...
,
  ...
  static List<OrganizationLinksSelfIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<OrganizationLinksSelfIriTemplate>[], (List<OrganizationLinksSelfIriTemplate> previousValue, element) {
      final OrganizationLinksSelfIriTemplate? object = OrganizationLinksSelfIriTemplate.fromJson(element);
  ...
  static Map<String, OrganizationLinksSelfIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, OrganizationLinksSelfIriTemplate>{};
    }

    return json.entries.fold(<String, OrganizationLinksSelfIriTemplate>{}, (Map<String, OrganizationLinksSelfIriTemplate> previousValue, element) {
      final OrganizationLinksSelfIriTemplate? object = OrganizationLinksSelfIriTemplate.fromJson(element.value);
      if (object is OrganizationLinksSelfIriTemplate) {
  ...
  static Map<String, List<OrganizationLinksSelfIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OrganizationLinksSelfIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OrganizationLinksSelfIriTemplate>>(key, OrganizationLinksSelfIriTemplate.listFromJson(value));
    });
  }
