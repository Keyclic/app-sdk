...
,
  ...
  return BookmarkLinksMember(
                  href: json[r'href'],
        iriTemplate: BookmarkLinksMemberIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<BookmarkLinksMember> listFromJson(Iterable? json) {
    if (json == null) {
      return <BookmarkLinksMember>[];
    }

    return json.fold(<BookmarkLinksMember>[], (List<BookmarkLinksMember> previousValue, element) {
  ...
  static Map<String, BookmarkLinksMember> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, BookmarkLinksMember>{};
    }

    return json.entries.fold(<String, BookmarkLinksMember>{}, (Map<String, BookmarkLinksMember> previousValue, element) {
      final BookmarkLinksMember? object = BookmarkLinksMember.fromJson(element.value);
      if (object is BookmarkLinksMember) {
  ...
  static Map<String, List<BookmarkLinksMember>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<BookmarkLinksMember>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<BookmarkLinksMember>>(key, BookmarkLinksMember.listFromJson(value));
    });
  }

  @override
  String toString() => 'BookmarkLinksMember[href=$href, iriTemplate=$iriTemplate]';
