...
,
  ...
  static Map<String, Workflow> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Workflow>{}, (Map<String, Workflow> previousValue, element) {
  ...
  static Map<String, List<Workflow>> mapListFromJson(Map<String, dynamic>? json) {
    ...
    return json.map((key, value) {
      return MapEntry<String, List<Workflow>>(key, Workflow.listFromJson(value));
    });
  }

  @override
  String toString() => 'Workflow[links=$links, createdAt=$createdAt, description=$description, end=$end, id=$id, name=$name, start=$start, states=$states, transitions=$transitions, type=$type, updatedAt=$updatedAt]';
