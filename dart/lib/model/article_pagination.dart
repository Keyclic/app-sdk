...
,
  ...
  static List<ArticlePagination> listFromJson(Iterable? json) {
    if (json == null) {
      return <ArticlePagination>[];
    }

    return json.fold(<ArticlePagination>[], (List<ArticlePagination> previousValue, element) {
  ...
  static Map<String, ArticlePagination> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ArticlePagination>{}, (Map<String, ArticlePagination> previousValue, element) {
      final ArticlePagination? object = ArticlePagination.fromJson(element.value);
      if (object is ArticlePagination) {
  ...
  static Map<String, List<ArticlePagination>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ArticlePagination>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ArticlePagination>>(key, ArticlePagination.listFromJson(value));
    });
  }

  @override
  String toString() => 'ArticlePagination[limit=$limit, page=$page, pages=$pages, total=$total, links=$links, embedded=$embedded]';
