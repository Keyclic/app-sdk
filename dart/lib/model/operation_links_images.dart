...
,
  ...
  return OperationLinksImages(
                  href: json[r'href'],
        iriTemplate: OperationLinksImagesIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<OperationLinksImages> listFromJson(Iterable? json) {
    ...
    return json.fold(<OperationLinksImages>[], (List<OperationLinksImages> previousValue, element) {
      final OperationLinksImages? object = OperationLinksImages.fromJson(element);
  ...
  static Map<String, OperationLinksImages> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, OperationLinksImages>{};
    }

    return json.entries.fold(<String, OperationLinksImages>{}, (Map<String, OperationLinksImages> previousValue, element) {
      final OperationLinksImages? object = OperationLinksImages.fromJson(element.value);
      if (object is OperationLinksImages) {
  ...
  static Map<String, List<OperationLinksImages>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OperationLinksImages>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OperationLinksImages>>(key, OperationLinksImages.listFromJson(value));
    });
  }

  @override
  String toString() => 'OperationLinksImages[href=$href, iriTemplate=$iriTemplate]';
