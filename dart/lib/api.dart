...
part 'model/article_pagination_all_of.dart';
...
part 'model/assignment_links_contract.dart';
part 'model/assignment_links_contract_iri_template.dart';
part 'model/assignment_links_contract_iri_template_mapping.dart';
part 'model/assignment_links_member.dart';
part 'model/assignment_links_member_iri_template.dart';
part 'model/assignment_links_member_iri_template_mapping.dart';
...
part 'model/bookmark_pagination_all_of.dart';
...
part 'model/business_activity_pagination_all_of.dart';
...
part 'model/category_pagination_all_of.dart';
...
part 'model/contribution_pagination_all_of.dart';
...
part 'model/document_pagination_all_of.dart';
...
part 'model/external_service_pagination_all_of.dart';
...
part 'model/feedback_pagination_all_of.dart';
...
part 'model/internal_service_pagination_all_of.dart';
...
part 'model/member_pagination_all_of.dart';
part 'model/member_patch.dart';
part 'model/member_patch_contact_point.dart';
part 'model/member_type_role.dart';
part 'model/message_data.dart';
part 'model/metric.dart';
part 'model/model_export.dart';
part 'model/node_path.dart';
part 'model/note.dart';
part 'model/note_collection.dart';
part 'model/note_links.dart';
part 'model/note_links_about.dart';
part 'model/note_links_about_iri_template.dart';
part 'model/note_links_author.dart';
part 'model/note_links_author_iri_template.dart';
part 'model/note_links_self.dart';
part 'model/note_links_self_iri_template.dart';
part 'model/note_links_self_iri_template_mapping.dart';
part 'model/note_pagination.dart';
part 'model/note_pagination_all_of.dart';
part 'model/note_patch.dart';
...
part 'model/occupant_pagination_all_of.dart';
...
part 'model/operation_links_assignments.dart';
part 'model/operation_links_assignments_iri_template.dart';
part 'model/operation_links_assignments_iri_template_mapping.dart';
...
part 'model/operation_pagination_all_of.dart';
...
part 'model/organization_pagination_all_of.dart';
...
part 'model/place_pagination_all_of.dart';
...
part 'model/plan_pagination_all_of.dart';
...
part 'model/publication_pagination_all_of.dart';
...
part 'model/report_links_asset.dart';
part 'model/report_links_asset_iri_template.dart';
part 'model/report_links_assignment.dart';
part 'model/report_links_assignment_iri_template.dart';
...
part 'model/report_pagination_all_of.dart';
...
part 'model/review_pagination_all_of.dart';
...
part 'model/review_request_pagination_all_of.dart';
...
part 'model/rule_links_category.dart';
part 'model/rule_links_category_iri_template.dart';
part 'model/rule_links_place.dart';
part 'model/rule_links_place_iri_template.dart';
...
part 'model/section_pagination_all_of.dart';
...
part 'model/service_pagination_all_of.dart';
...
part 'model/signer_pagination_all_of.dart';
...
part 'model/template_pagination_all_of.dart';
