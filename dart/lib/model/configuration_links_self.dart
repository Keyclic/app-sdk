...
,
  ...
  return ConfigurationLinksSelf(
                  href: json[r'href'],
        iriTemplate: ConfigurationLinksSelfIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<ConfigurationLinksSelf> listFromJson(Iterable? json) {
    ...
    return json.fold(<ConfigurationLinksSelf>[], (List<ConfigurationLinksSelf> previousValue, element) {
      final ConfigurationLinksSelf? object = ConfigurationLinksSelf.fromJson(element);
  ...
  static Map<String, ConfigurationLinksSelf> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ConfigurationLinksSelf>{};
    }

    return json.entries.fold(<String, ConfigurationLinksSelf>{}, (Map<String, ConfigurationLinksSelf> previousValue, element) {
      final ConfigurationLinksSelf? object = ConfigurationLinksSelf.fromJson(element.value);
      if (object is ConfigurationLinksSelf) {
  ...
  static Map<String, List<ConfigurationLinksSelf>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ConfigurationLinksSelf>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ConfigurationLinksSelf>>(key, ConfigurationLinksSelf.listFromJson(value));
    });
  }

  @override
  String toString() => 'ConfigurationLinksSelf[href=$href, iriTemplate=$iriTemplate]';
