...
,
  ...
  static List<ConfigurationPlaceType> listFromJson(Iterable? json) {
    ...
    return json.fold(<ConfigurationPlaceType>[], (List<ConfigurationPlaceType> previousValue, element) {
      final ConfigurationPlaceType? object = ConfigurationPlaceType.fromJson(element);
  ...
  static Map<String, ConfigurationPlaceType> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ConfigurationPlaceType>{};
    }

    return json.entries.fold(<String, ConfigurationPlaceType>{}, (Map<String, ConfigurationPlaceType> previousValue, element) {
      final ConfigurationPlaceType? object = ConfigurationPlaceType.fromJson(element.value);
      if (object is ConfigurationPlaceType) {
  ...
  static Map<String, List<ConfigurationPlaceType>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ConfigurationPlaceType>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ConfigurationPlaceType>>(key, ConfigurationPlaceType.listFromJson(value));
    });
  }

  @override
  String toString() => 'ConfigurationPlaceType[id=$id, type=$type, workflow=$workflow]';
