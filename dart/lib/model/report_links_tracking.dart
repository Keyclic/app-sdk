...
,
  ...
  static ReportLinksTracking? fromJson(Object? json) {
  ...
  return ReportLinksTracking(
                  href: json[r'href'],
        iriTemplate: ReportLinksTrackingIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<ReportLinksTracking> listFromJson(Iterable? json) {
    if (json == null) {
      return <ReportLinksTracking>[];
    }

    return json.fold(<ReportLinksTracking>[], (List<ReportLinksTracking> previousValue, element) {
  ...
  static Map<String, ReportLinksTracking> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ReportLinksTracking>{}, (Map<String, ReportLinksTracking> previousValue, element) {
      final ReportLinksTracking? object = ReportLinksTracking.fromJson(element.value);
      if (object is ReportLinksTracking) {
  ...
  static Map<String, List<ReportLinksTracking>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReportLinksTracking>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReportLinksTracking>>(key, ReportLinksTracking.listFromJson(value));
    });
  }

  @override
  String toString() => 'ReportLinksTracking[href=$href, iriTemplate=$iriTemplate]';
