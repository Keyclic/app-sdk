...
,
  ...
  static List<ProcedureLinksSelf> listFromJson(Iterable? json) {
    if (json == null) {
      return <ProcedureLinksSelf>[];
    }

    return json.fold(<ProcedureLinksSelf>[], (List<ProcedureLinksSelf> previousValue, element) {
  ...
  static Map<String, ProcedureLinksSelf> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ProcedureLinksSelf>{};
    }

    return json.entries.fold(<String, ProcedureLinksSelf>{}, (Map<String, ProcedureLinksSelf> previousValue, element) {
      final ProcedureLinksSelf? object = ProcedureLinksSelf.fromJson(element.value);
      if (object is ProcedureLinksSelf) {
  ...
  static Map<String, List<ProcedureLinksSelf>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ProcedureLinksSelf>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ProcedureLinksSelf>>(key, ProcedureLinksSelf.listFromJson(value));
    });
  }

  @override
  String toString() => 'ProcedureLinksSelf[href=$href, iriTemplate=$iriTemplate]';
