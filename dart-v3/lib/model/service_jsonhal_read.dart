...
,
  ...
  static List<ServiceJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<ServiceJsonhalRead>[], (List<ServiceJsonhalRead> previousValue, element) {
  ...
  static Map<String, ServiceJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ServiceJsonhalRead>{};
    }

    return json.entries.fold(<String, ServiceJsonhalRead>{}, (Map<String, ServiceJsonhalRead> previousValue, element) {
      final ServiceJsonhalRead? object = ServiceJsonhalRead.fromJson(element.value);
      if (object is ServiceJsonhalRead) {
  ...
  static Map<String, List<ServiceJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ServiceJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ServiceJsonhalRead>>(key, ServiceJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'ServiceJsonhalRead[links=$links, contactPoint=$contactPoint, description=$description, name=$name, onCall=$onCall, id=$id, address=$address, createdAt=$createdAt, updatedAt=$updatedAt, type=$type, embedded=$embedded]';
  ...
  Map<String, dynamic> toJson([Iterable<String>? keys]) {
    ...
    contains(r'description')
        ...
        r'name':
          name,
    if (keys == null || keys.
    any((key) => RegExp(r'^onCall\.').hasMatch(key))
    )
        r'onCall':
            onCall?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
