...
void main() {
  ...
  group('tests for MemberApi', () {
    ...
    // Retrieves a Member resource.
    //
    //Future<MemberJsonhalRead> getMember(String identifier, String xKeyclicApp, { String acceptLanguage, DateTime xDateTime, String xKeyclicAppPlatform, String xKeyclicAppVersion }) async
