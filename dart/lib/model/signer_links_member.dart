...
,
  ...
  static List<SignerLinksMember> listFromJson(Iterable? json) {
    ...
    return json.fold(<SignerLinksMember>[], (List<SignerLinksMember> previousValue, element) {
  ...
  static Map<String, SignerLinksMember> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, SignerLinksMember>{};
    }

    return json.entries.fold(<String, SignerLinksMember>{}, (Map<String, SignerLinksMember> previousValue, element) {
      final SignerLinksMember? object = SignerLinksMember.fromJson(element.value);
      if (object is SignerLinksMember) {
  ...
  static Map<String, List<SignerLinksMember>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<SignerLinksMember>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<SignerLinksMember>>(key, SignerLinksMember.listFromJson(value));
    });
  }

  @override
  String toString() => 'SignerLinksMember[href=$href, iriTemplate=$iriTemplate]';
