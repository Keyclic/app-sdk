...
,
  ...
  return GetServiceCollection200Response(
        embedded: GetServiceCollection200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetServiceCollection200Response> listFromJson(Iterable? json) {
    ...
    return json.fold(<GetServiceCollection200Response>[], (List<GetServiceCollection200Response> previousValue, element) {
      final GetServiceCollection200Response? object = GetServiceCollection200Response.fromJson(element);
  ...
  static Map<String, GetServiceCollection200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetServiceCollection200Response>{};
    }

    return json.entries.fold(<String, GetServiceCollection200Response>{}, (Map<String, GetServiceCollection200Response> previousValue, element) {
      final GetServiceCollection200Response? object = GetServiceCollection200Response.fromJson(element.value);
      if (object is GetServiceCollection200Response) {
  ...
  static Map<String, List<GetServiceCollection200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetServiceCollection200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetServiceCollection200Response>>(key, GetServiceCollection200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetServiceCollection200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
