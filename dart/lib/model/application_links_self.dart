...
,
  ...
  return ApplicationLinksSelf(
                  href: json[r'href'],
        iriTemplate: ApplicationLinksSelfIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<ApplicationLinksSelf> listFromJson(Iterable? json) {
    ...
    return json.fold(<ApplicationLinksSelf>[], (List<ApplicationLinksSelf> previousValue, element) {
      final ApplicationLinksSelf? object = ApplicationLinksSelf.fromJson(element);
  ...
  static Map<String, ApplicationLinksSelf> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ApplicationLinksSelf>{}, (Map<String, ApplicationLinksSelf> previousValue, element) {
      final ApplicationLinksSelf? object = ApplicationLinksSelf.fromJson(element.value);
      if (object is ApplicationLinksSelf) {
  ...
  static Map<String, List<ApplicationLinksSelf>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ApplicationLinksSelf>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ApplicationLinksSelf>>(key, ApplicationLinksSelf.listFromJson(value));
    });
  }

  @override
  String toString() => 'ApplicationLinksSelf[href=$href, iriTemplate=$iriTemplate]';
