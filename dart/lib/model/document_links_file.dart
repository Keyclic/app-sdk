...
,
  ...
  static List<DocumentLinksFile> listFromJson(Iterable? json) {
    if (json == null) {
      return <DocumentLinksFile>[];
    }

    return json.fold(<DocumentLinksFile>[], (List<DocumentLinksFile> previousValue, element) {
  ...
  static Map<String, DocumentLinksFile> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, DocumentLinksFile>{}, (Map<String, DocumentLinksFile> previousValue, element) {
      final DocumentLinksFile? object = DocumentLinksFile.fromJson(element.value);
      if (object is DocumentLinksFile) {
  ...
  static Map<String, List<DocumentLinksFile>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<DocumentLinksFile>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<DocumentLinksFile>>(key, DocumentLinksFile.listFromJson(value));
    });
  }

  @override
  String toString() => 'DocumentLinksFile[href=$href, iriTemplate=$iriTemplate]';
