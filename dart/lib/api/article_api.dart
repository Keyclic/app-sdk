...
class ArticleApi {
  ...
  Future<Response> getArticleWithHttpInfo(
    String xKeyclicApp,
    String article, {
    String acceptLanguage,
    DateTime xDateTime,
    ...
    if (article == null) {
      throw ApiException(
          HttpStatus.badRequest, 'Missing required param: article');
    }

    final path = r'/articles/{article}'
  ...
  Future<Article> getArticle(
    ...
    final response = await getArticleWithHttpInfo(
      xKeyclicApp,
      article,
    ...
    if (response.body == null || response.statusCode == HttpStatus.noContent) {
      return Future<Article>.value(null);
    }
