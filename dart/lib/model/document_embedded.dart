...
,
  ...
  return DocumentEmbedded(
            container:
              json[r'container'] == null ? null : Map<String, Object?>.from(json[r'container']),
  ...
  static List<DocumentEmbedded> listFromJson(Iterable? json) {
    ...
    return json.fold(<DocumentEmbedded>[], (List<DocumentEmbedded> previousValue, element) {
  ...
  static Map<String, DocumentEmbedded> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, DocumentEmbedded>{}, (Map<String, DocumentEmbedded> previousValue, element) {
  ...
  static Map<String, List<DocumentEmbedded>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<DocumentEmbedded>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<DocumentEmbedded>>(key, DocumentEmbedded.listFromJson(value));
    });
  }

  @override
  String toString() => 'DocumentEmbedded[container=$container, createdBy=$createdBy, signers=$signers, stateTransitions=$stateTransitions, type=$type]';

  Map<String, dynamic> toJson([Iterable<String>? keys]) {
    return <String, dynamic>{
    if (keys == null || keys.
    contains(r'container')
    )
        r'container':
            container,
    if (keys == null || keys.
