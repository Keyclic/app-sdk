...
,
  ...
  static List<WorkflowLinksSelf> listFromJson(Iterable? json) {
    ...
    return json.fold(<WorkflowLinksSelf>[], (List<WorkflowLinksSelf> previousValue, element) {
  ...
  static Map<String, WorkflowLinksSelf> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, WorkflowLinksSelf>{}, (Map<String, WorkflowLinksSelf> previousValue, element) {
      final WorkflowLinksSelf? object = WorkflowLinksSelf.fromJson(element.value);
      if (object is WorkflowLinksSelf) {
  ...
  static Map<String, List<WorkflowLinksSelf>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<WorkflowLinksSelf>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<WorkflowLinksSelf>>(key, WorkflowLinksSelf.listFromJson(value));
    });
  }

  @override
  String toString() => 'WorkflowLinksSelf[href=$href, iriTemplate=$iriTemplate]';
