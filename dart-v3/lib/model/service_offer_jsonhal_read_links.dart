...
,
  ...
  return ServiceOfferJsonhalReadLinks(
        ...
        service: GetPlaceCollection200ResponseLinksSelf.fromJson(json[r'service']),
    );
  }
  ...
  static List<ServiceOfferJsonhalReadLinks> listFromJson(Iterable? json) {
    ...
    return json.fold(<ServiceOfferJsonhalReadLinks>[], (List<ServiceOfferJsonhalReadLinks> previousValue, element) {
      final ServiceOfferJsonhalReadLinks? object = ServiceOfferJsonhalReadLinks.fromJson(element);
  ...
  static Map<String, ServiceOfferJsonhalReadLinks> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ServiceOfferJsonhalReadLinks>{};
    }

    return json.entries.fold(<String, ServiceOfferJsonhalReadLinks>{}, (Map<String, ServiceOfferJsonhalReadLinks> previousValue, element) {
      final ServiceOfferJsonhalReadLinks? object = ServiceOfferJsonhalReadLinks.fromJson(element.value);
      if (object is ServiceOfferJsonhalReadLinks) {
  ...
  static Map<String, List<ServiceOfferJsonhalReadLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ServiceOfferJsonhalReadLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ServiceOfferJsonhalReadLinks>>(key, ServiceOfferJsonhalReadLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'ServiceOfferJsonhalReadLinks[self=$self, service=$service]';
