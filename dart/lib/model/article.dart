...
,
  ...
  static Map<String, Article> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Article>{}, (Map<String, Article> previousValue, element) {
  ...
  @override
  String toString() => 'Article[links=$links, createdAt=$createdAt, id=$id, name=$name, text=$text, type=$type, updatedAt=$updatedAt]';
