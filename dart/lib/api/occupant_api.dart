...
class OccupantApi {
  ...
  Future<Response<void>> deleteOccupant({ 
    ...
    final String path = r'/occupants/{occupant}'.replaceAll('{' r'occupant' '}', occupant.toString());
  ...
  Future<Response<Occupant>> postOccupant({ 
    ...
    try {
            responseData = await _apiClient.deserializeAsync<Occupant>(response.data!, 'Occupant');
    } catch (error, stackTrace) {
      throw DioException(
        error: error,
