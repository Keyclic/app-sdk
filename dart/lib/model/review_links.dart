...
,
  ...
  static List<ReviewLinks> listFromJson(Iterable? json) {
    ...
    return json.fold(<ReviewLinks>[], (List<ReviewLinks> previousValue, element) {
  ...
  static Map<String, ReviewLinks> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ReviewLinks>{}, (Map<String, ReviewLinks> previousValue, element) {
  ...
  static Map<String, List<ReviewLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReviewLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReviewLinks>>(key, ReviewLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'ReviewLinks[author=$author, itemReviewed=$itemReviewed, self=$self]';
