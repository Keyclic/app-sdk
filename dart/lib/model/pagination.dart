...
,
  ...
  static List<Pagination> listFromJson(Iterable? json) {
    if (json == null) {
      return <Pagination>[];
    }
  ...
  static Map<String, Pagination> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Pagination>{}, (Map<String, Pagination> previousValue, element) {
  ...
  static Map<String, List<Pagination>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<Pagination>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<Pagination>>(key, Pagination.listFromJson(value));
    });
  }

  @override
  String toString() => 'Pagination[limit=$limit, page=$page, pages=$pages, total=$total, links=$links]';
