...
// tests for GetIntegrationLinkCollection200Response
void main() {
  // final instance = GetIntegrationLinkCollection200Response();

  group('test GetIntegrationLinkCollection200Response', () {
