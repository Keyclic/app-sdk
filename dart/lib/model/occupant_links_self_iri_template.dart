...
,
  ...
  static List<OccupantLinksSelfIriTemplate> listFromJson(Iterable? json) {
    if (json == null) {
      return <OccupantLinksSelfIriTemplate>[];
    }

    return json.fold(<OccupantLinksSelfIriTemplate>[], (List<OccupantLinksSelfIriTemplate> previousValue, element) {
      final OccupantLinksSelfIriTemplate? object = OccupantLinksSelfIriTemplate.fromJson(element);
  ...
  static Map<String, OccupantLinksSelfIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OccupantLinksSelfIriTemplate>{}, (Map<String, OccupantLinksSelfIriTemplate> previousValue, element) {
      final OccupantLinksSelfIriTemplate? object = OccupantLinksSelfIriTemplate.fromJson(element.value);
      if (object is OccupantLinksSelfIriTemplate) {
  ...
  static Map<String, List<OccupantLinksSelfIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OccupantLinksSelfIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OccupantLinksSelfIriTemplate>>(key, OccupantLinksSelfIriTemplate.listFromJson(value));
    });
  }
