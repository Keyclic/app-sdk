...
class EquipmentEditEquipmentCommandData {
  ...
  @override
  String toString() =>
      'EquipmentEditEquipmentCommandData[brand=$brand, commissioningDate=$commissioningDate, description=$description, lifetime=$lifetime, model=$model, mpn=$mpn, name=$name, serialNumber=$serialNumber, state=$state, type=$type]';
