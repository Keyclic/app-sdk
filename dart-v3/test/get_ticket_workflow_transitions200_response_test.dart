...
// tests for GetTicketWorkflowTransitions200Response
void main() {
  // final instance = GetTicketWorkflowTransitions200Response();

  group('test GetTicketWorkflowTransitions200Response', () {
