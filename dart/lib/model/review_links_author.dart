...
,
  ...
  static List<ReviewLinksAuthor> listFromJson(Iterable? json) {
    ...
    return json.fold(<ReviewLinksAuthor>[], (List<ReviewLinksAuthor> previousValue, element) {
  ...
  static Map<String, ReviewLinksAuthor> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ReviewLinksAuthor>{}, (Map<String, ReviewLinksAuthor> previousValue, element) {
      final ReviewLinksAuthor? object = ReviewLinksAuthor.fromJson(element.value);
      if (object is ReviewLinksAuthor) {
  ...
  static Map<String, List<ReviewLinksAuthor>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReviewLinksAuthor>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReviewLinksAuthor>>(key, ReviewLinksAuthor.listFromJson(value));
    });
  }

  @override
  String toString() => 'ReviewLinksAuthor[href=$href, iriTemplate=$iriTemplate]';
