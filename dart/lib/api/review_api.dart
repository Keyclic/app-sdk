...
class ReviewApi {
  ...
  Future<Response> getReviewWithHttpInfo(
    String xKeyclicApp,
    String review, {
    String acceptLanguage,
    DateTime xDateTime,
    ...
    if (review == null) {
      throw ApiException(
          HttpStatus.badRequest, 'Missing required param: review');
    }

    final path = r'/reviews/{review}'
  ...
  Future<Review> getReview(
    ...
    final response = await getReviewWithHttpInfo(
      xKeyclicApp,
      review,
    ...
    if (response.body == null || response.statusCode == HttpStatus.noContent) {
      return Future<Review>.value(null);
    }
  ...
  /// * [String] xKeyclicApp (required):
  ///
  /// * [ReviewData] reviewData (required):
  ///
  /// * [String] acceptLanguage:
  ///
  /// * [DateTime] xDateTime:
  ...
  ///
  /// * [String] xKeyclicAppVersion:
  Future<Response> postReviewWithHttpInfo(
    String xKeyclicApp,
    ...
    if (reviewData == null) {
      throw ApiException(
          HttpStatus.badRequest, 'Missing required param: reviewData');
    }
  ...
  Future<Review> postReview(
    ...
    final response = await postReviewWithHttpInfo(
      xKeyclicApp,
      reviewData,
      acceptLanguage: acceptLanguage,
      xDateTime: xDateTime,
