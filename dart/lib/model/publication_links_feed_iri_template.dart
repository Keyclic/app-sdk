...
,
  ...
  static List<PublicationLinksFeedIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<PublicationLinksFeedIriTemplate>[], (List<PublicationLinksFeedIriTemplate> previousValue, element) {
      final PublicationLinksFeedIriTemplate? object = PublicationLinksFeedIriTemplate.fromJson(element);
  ...
  static Map<String, PublicationLinksFeedIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, PublicationLinksFeedIriTemplate>{};
    }

    return json.entries.fold(<String, PublicationLinksFeedIriTemplate>{}, (Map<String, PublicationLinksFeedIriTemplate> previousValue, element) {
      final PublicationLinksFeedIriTemplate? object = PublicationLinksFeedIriTemplate.fromJson(element.value);
      if (object is PublicationLinksFeedIriTemplate) {
  ...
  static Map<String, List<PublicationLinksFeedIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PublicationLinksFeedIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PublicationLinksFeedIriTemplate>>(key, PublicationLinksFeedIriTemplate.listFromJson(value));
    });
  }
