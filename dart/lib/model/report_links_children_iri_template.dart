...
,
  ...
  static List<ReportLinksChildrenIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<ReportLinksChildrenIriTemplate>[], (List<ReportLinksChildrenIriTemplate> previousValue, element) {
      final ReportLinksChildrenIriTemplate? object = ReportLinksChildrenIriTemplate.fromJson(element);
  ...
  static Map<String, ReportLinksChildrenIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ReportLinksChildrenIriTemplate>{};
    }

    return json.entries.fold(<String, ReportLinksChildrenIriTemplate>{}, (Map<String, ReportLinksChildrenIriTemplate> previousValue, element) {
      final ReportLinksChildrenIriTemplate? object = ReportLinksChildrenIriTemplate.fromJson(element.value);
      if (object is ReportLinksChildrenIriTemplate) {
  ...
  static Map<String, List<ReportLinksChildrenIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReportLinksChildrenIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReportLinksChildrenIriTemplate>>(key, ReportLinksChildrenIriTemplate.listFromJson(value));
    });
  }
