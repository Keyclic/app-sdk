...
,
  ...
  static ConfigurationOperationType? fromJson(Object? json) {
  ...
  static List<ConfigurationOperationType> listFromJson(Iterable? json) {
    ...
    return json.fold(<ConfigurationOperationType>[], (List<ConfigurationOperationType> previousValue, element) {
      final ConfigurationOperationType? object = ConfigurationOperationType.fromJson(element);
  ...
  static Map<String, ConfigurationOperationType> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, ConfigurationOperationType>{};
    }

    return json.entries.fold(<String, ConfigurationOperationType>{}, (Map<String, ConfigurationOperationType> previousValue, element) {
      final ConfigurationOperationType? object = ConfigurationOperationType.fromJson(element.value);
      if (object is ConfigurationOperationType) {
  ...
  static Map<String, List<ConfigurationOperationType>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ConfigurationOperationType>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ConfigurationOperationType>>(key, ConfigurationOperationType.listFromJson(value));
    });
  }

  @override
  String toString() => 'ConfigurationOperationType[id=$id, type=$type, workflow=$workflow]';
