# keyclic_sdk_api_platform.api.ServiceApi
...
------------- | ------------- | -------------
[**getService**](ServiceApi.md#getservice) | **GET** /services/{identifier} | Retrieves a Service resource.
[**getServiceCollection**](ServiceApi.md#getservicecollection) | **GET** /services | Retrieves the collection of Service resources.


# **getService**
> ServiceJsonhalRead getService(identifier, xKeyclicApp, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion)
...
final identifier = identifier_example; // String | Service identifier
...
try {
    final result = api_instance.getService(identifier, xKeyclicApp, acceptLanguage, xDateTime, xKeyclicAppPlatform, xKeyclicAppVersion);
    print(result);
} catch (e) {
...
[**ServiceJsonhalRead**](ServiceJsonhalRead.md)
...
[**GetServiceCollection200Response**](GetServiceCollection200Response.md)
