...
,
  ...
  static ReportPagination? fromJson(Object? json) {
  ...
  static List<ReportPagination> listFromJson(Iterable? json) {
    if (json == null) {
      return <ReportPagination>[];
    }

    return json.fold(<ReportPagination>[], (List<ReportPagination> previousValue, element) {
  ...
  static Map<String, ReportPagination> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ReportPagination>{}, (Map<String, ReportPagination> previousValue, element) {
  ...
  static Map<String, List<ReportPagination>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReportPagination>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReportPagination>>(key, ReportPagination.listFromJson(value));
    });
  }

  @override
  String toString() => 'ReportPagination[limit=$limit, page=$page, pages=$pages, total=$total, links=$links, embedded=$embedded]';
