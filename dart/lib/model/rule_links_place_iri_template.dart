...
,
  ...
  static List<RuleLinksPlaceIriTemplate> listFromJson(Iterable? json) {
    if (json == null) {
      return <RuleLinksPlaceIriTemplate>[];
    }

    return json.fold(<RuleLinksPlaceIriTemplate>[], (List<RuleLinksPlaceIriTemplate> previousValue, element) {
      final RuleLinksPlaceIriTemplate? object = RuleLinksPlaceIriTemplate.fromJson(element);
  ...
  static Map<String, RuleLinksPlaceIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, RuleLinksPlaceIriTemplate>{};
    }

    return json.entries.fold(<String, RuleLinksPlaceIriTemplate>{}, (Map<String, RuleLinksPlaceIriTemplate> previousValue, element) {
      final RuleLinksPlaceIriTemplate? object = RuleLinksPlaceIriTemplate.fromJson(element.value);
      if (object is RuleLinksPlaceIriTemplate) {
  ...
  static Map<String, List<RuleLinksPlaceIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<RuleLinksPlaceIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<RuleLinksPlaceIriTemplate>>(key, RuleLinksPlaceIriTemplate.listFromJson(value));
    });
  }
