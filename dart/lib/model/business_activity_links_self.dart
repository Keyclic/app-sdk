...
,
  ...
  return BusinessActivityLinksSelf(
                  href: json[r'href'],
        iriTemplate: BusinessActivityLinksSelfIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<BusinessActivityLinksSelf> listFromJson(Iterable? json) {
    ...
    return json.fold(<BusinessActivityLinksSelf>[], (List<BusinessActivityLinksSelf> previousValue, element) {
      final BusinessActivityLinksSelf? object = BusinessActivityLinksSelf.fromJson(element);
  ...
  static Map<String, BusinessActivityLinksSelf> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, BusinessActivityLinksSelf>{}, (Map<String, BusinessActivityLinksSelf> previousValue, element) {
      final BusinessActivityLinksSelf? object = BusinessActivityLinksSelf.fromJson(element.value);
      if (object is BusinessActivityLinksSelf) {
  ...
  static Map<String, List<BusinessActivityLinksSelf>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<BusinessActivityLinksSelf>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<BusinessActivityLinksSelf>>(key, BusinessActivityLinksSelf.listFromJson(value));
    });
  }

  @override
  String toString() => 'BusinessActivityLinksSelf[href=$href, iriTemplate=$iriTemplate]';
