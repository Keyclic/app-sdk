...
,
  ...
  static List<CategoryJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<CategoryJsonhalRead>[], (List<CategoryJsonhalRead> previousValue, element) {
  ...
  static Map<String, CategoryJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, CategoryJsonhalRead>{};
    }

    return json.entries.fold(<String, CategoryJsonhalRead>{}, (Map<String, CategoryJsonhalRead> previousValue, element) {
      final CategoryJsonhalRead? object = CategoryJsonhalRead.fromJson(element.value);
      if (object is CategoryJsonhalRead) {
  ...
  static Map<String, List<CategoryJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<CategoryJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<CategoryJsonhalRead>>(key, CategoryJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'CategoryJsonhalRead[links=$links, name=$name, id=$id, enabled=$enabled, identificationNumber=$identificationNumber, path=$path, createdAt=$createdAt, updatedAt=$updatedAt, embedded=$embedded]';
