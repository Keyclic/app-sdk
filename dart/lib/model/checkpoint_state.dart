...
,
  ...
  static List<CheckpointState> listFromJson(Iterable? json) {
    ...
    return json.fold(<CheckpointState>[], (List<CheckpointState> previousValue, element) {
  ...
  static Map<String, CheckpointState> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, CheckpointState>{}, (Map<String, CheckpointState> previousValue, element) {
  ...
  static Map<String, List<CheckpointState>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<CheckpointState>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<CheckpointState>>(key, CheckpointState.listFromJson(value));
    });
  }

  @override
  String toString() => 'CheckpointState[allowAdd=$allowAdd, allowDispatch=$allowDispatch, backgroundColor=$backgroundColor, color=$color, description=$description, end=$end, id=$id, name=$name, progression=$progression, reference=$reference, type=$type]';
