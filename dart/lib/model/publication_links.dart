...
,
  ...
  return PublicationLinks(
        ...
        organization: PublicationLinksOrganization.fromJson(json[r'organization']),
  ...
  static List<PublicationLinks> listFromJson(Iterable? json) {
    ...
    return json.fold(<PublicationLinks>[], (List<PublicationLinks> previousValue, element) {
  ...
  static Map<String, PublicationLinks> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, PublicationLinks>{}, (Map<String, PublicationLinks> previousValue, element) {
  ...
  static Map<String, List<PublicationLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PublicationLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PublicationLinks>>(key, PublicationLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'PublicationLinks[author=$author, feed=$feed, organization=$organization, self=$self]';
  ...
  Map<String, dynamic> toJson([Iterable<String>? keys]) {
    ...
    if (keys == null || keys.
    any((key) => RegExp(r'^feed\.').hasMatch(key))
    )
        r'feed':
            feed?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
