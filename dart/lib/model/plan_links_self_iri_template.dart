...
,
  ...
  static PlanLinksSelfIriTemplate? fromJson(Object? json) {
  ...
  static List<PlanLinksSelfIriTemplate> listFromJson(Iterable? json) {
    if (json == null) {
      return <PlanLinksSelfIriTemplate>[];
    }

    return json.fold(<PlanLinksSelfIriTemplate>[], (List<PlanLinksSelfIriTemplate> previousValue, element) {
      final PlanLinksSelfIriTemplate? object = PlanLinksSelfIriTemplate.fromJson(element);
  ...
  static Map<String, PlanLinksSelfIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, PlanLinksSelfIriTemplate>{};
    }

    return json.entries.fold(<String, PlanLinksSelfIriTemplate>{}, (Map<String, PlanLinksSelfIriTemplate> previousValue, element) {
      final PlanLinksSelfIriTemplate? object = PlanLinksSelfIriTemplate.fromJson(element.value);
      if (object is PlanLinksSelfIriTemplate) {
  ...
  static Map<String, List<PlanLinksSelfIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PlanLinksSelfIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PlanLinksSelfIriTemplate>>(key, PlanLinksSelfIriTemplate.listFromJson(value));
    });
  }
