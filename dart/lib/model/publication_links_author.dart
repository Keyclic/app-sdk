...
,
  ...
  return PublicationLinksAuthor(
                  href: json[r'href'],
        iriTemplate: PublicationLinksAuthorIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<PublicationLinksAuthor> listFromJson(Iterable? json) {
    ...
    return json.fold(<PublicationLinksAuthor>[], (List<PublicationLinksAuthor> previousValue, element) {
      final PublicationLinksAuthor? object = PublicationLinksAuthor.fromJson(element);
  ...
  static Map<String, PublicationLinksAuthor> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, PublicationLinksAuthor>{}, (Map<String, PublicationLinksAuthor> previousValue, element) {
      final PublicationLinksAuthor? object = PublicationLinksAuthor.fromJson(element.value);
      if (object is PublicationLinksAuthor) {
  ...
  static Map<String, List<PublicationLinksAuthor>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PublicationLinksAuthor>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PublicationLinksAuthor>>(key, PublicationLinksAuthor.listFromJson(value));
    });
  }

  @override
  String toString() => 'PublicationLinksAuthor[href=$href, iriTemplate=$iriTemplate]';
