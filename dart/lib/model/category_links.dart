...
,
  ...
  static List<CategoryLinks> listFromJson(Iterable? json) {
    ...
    return json.fold(<CategoryLinks>[], (List<CategoryLinks> previousValue, element) {
  ...
  static Map<String, CategoryLinks> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, CategoryLinks>{}, (Map<String, CategoryLinks> previousValue, element) {
  ...
  static Map<String, List<CategoryLinks>> mapListFromJson(Map<String, dynamic>? json) {
    ...
    return json.map((key, value) {
      return MapEntry<String, List<CategoryLinks>>(key, CategoryLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'CategoryLinks[organization=$organization, self=$self, type=$type]';
