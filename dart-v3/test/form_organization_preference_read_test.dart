...
// tests for FormOrganizationPreferenceRead
void main() {
  // final instance = FormOrganizationPreferenceRead();

  group('test FormOrganizationPreferenceRead', () {
    ...
    // bool manualDispatch (default value: true)
