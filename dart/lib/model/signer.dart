...
,
  ...
  static Map<String, Signer> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, Signer>{}, (Map<String, Signer> previousValue, element) {
  ...
  @override
  String toString() => 'Signer[embedded=$embedded, links=$links, id=$id, signature=$signature, state=$state, type=$type]';
  ...
  Map<String, dynamic> toJson([Iterable<String>? keys]) {
    ...
    contains(r'id')
        ...
        r'id':
          id,
    if (keys == null || keys.
    any((key) => RegExp(r'^signature\.').hasMatch(key))
    )
        r'signature':
            signature?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
...
class SignerStateEnum {
  ...
  static List<SignerStateEnum> listFromJson(List<dynamic> json) {
    ...
    }).whereType<SignerStateEnum>().toList();
  }
}
...
class SignerStateEnumTypeTransformer {
  ...
  factory SignerStateEnumTypeTransformer() => _instance ??= SignerStateEnumTypeTransformer._();
  ...
  SignerStateEnum? decode(dynamic data, {bool allowNull = true}) {
    switch (data) {
      case r'DONE': return SignerStateEnum.DONE;
      case r'PENDING': return SignerStateEnum.PENDING;
      case r'REFUSED': return SignerStateEnum.REFUSED;
      default:
        if (allowNull == false) {
