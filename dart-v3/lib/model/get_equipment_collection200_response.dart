...
,
  ...
  return GetEquipmentCollection200Response(
        embedded: GetEquipmentCollection200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetEquipmentCollection200Response> listFromJson(Iterable? json) {
    if (json == null) {
      return <GetEquipmentCollection200Response>[];
    }

    return json.fold(<GetEquipmentCollection200Response>[], (List<GetEquipmentCollection200Response> previousValue, element) {
      final GetEquipmentCollection200Response? object = GetEquipmentCollection200Response.fromJson(element);
  ...
  static Map<String, GetEquipmentCollection200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetEquipmentCollection200Response>{};
    }

    return json.entries.fold(<String, GetEquipmentCollection200Response>{}, (Map<String, GetEquipmentCollection200Response> previousValue, element) {
      final GetEquipmentCollection200Response? object = GetEquipmentCollection200Response.fromJson(element.value);
      if (object is GetEquipmentCollection200Response) {
  ...
  static Map<String, List<GetEquipmentCollection200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetEquipmentCollection200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetEquipmentCollection200Response>>(key, GetEquipmentCollection200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetEquipmentCollection200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
