...
,
  ...
  return AssignmentLinksSelf(
                  href: json[r'href'],
        iriTemplate: AssignmentLinksSelfIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<AssignmentLinksSelf> listFromJson(Iterable? json) {
    if (json == null) {
      return <AssignmentLinksSelf>[];
    }

    return json.fold(<AssignmentLinksSelf>[], (List<AssignmentLinksSelf> previousValue, element) {
  ...
  static Map<String, AssignmentLinksSelf> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, AssignmentLinksSelf>{};
    }

    return json.entries.fold(<String, AssignmentLinksSelf>{}, (Map<String, AssignmentLinksSelf> previousValue, element) {
      final AssignmentLinksSelf? object = AssignmentLinksSelf.fromJson(element.value);
      if (object is AssignmentLinksSelf) {
  ...
  static Map<String, List<AssignmentLinksSelf>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<AssignmentLinksSelf>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<AssignmentLinksSelf>>(key, AssignmentLinksSelf.listFromJson(value));
    });
  }

  @override
  String toString() => 'AssignmentLinksSelf[href=$href, iriTemplate=$iriTemplate]';
