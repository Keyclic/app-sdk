...
,
  ...
  static List<MemberLinksPerson> listFromJson(Iterable? json) {
    if (json == null) {
      return <MemberLinksPerson>[];
    }

    return json.fold(<MemberLinksPerson>[], (List<MemberLinksPerson> previousValue, element) {
  ...
  static Map<String, MemberLinksPerson> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, MemberLinksPerson>{}, (Map<String, MemberLinksPerson> previousValue, element) {
      final MemberLinksPerson? object = MemberLinksPerson.fromJson(element.value);
      if (object is MemberLinksPerson) {
  ...
  static Map<String, List<MemberLinksPerson>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<MemberLinksPerson>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<MemberLinksPerson>>(key, MemberLinksPerson.listFromJson(value));
    });
  }

  @override
  String toString() => 'MemberLinksPerson[href=$href, iriTemplate=$iriTemplate]';
