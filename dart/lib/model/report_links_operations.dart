...
,
  ...
  return ReportLinksOperations(
                  href: json[r'href'],
        iriTemplate: ReportLinksOperationsIriTemplate.fromJson(json[r'iriTemplate']),
    );
  }
  ...
  static List<ReportLinksOperations> listFromJson(Iterable? json) {
    ...
    return json.fold(<ReportLinksOperations>[], (List<ReportLinksOperations> previousValue, element) {
      final ReportLinksOperations? object = ReportLinksOperations.fromJson(element);
  ...
  static Map<String, ReportLinksOperations> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, ReportLinksOperations>{}, (Map<String, ReportLinksOperations> previousValue, element) {
      final ReportLinksOperations? object = ReportLinksOperations.fromJson(element.value);
      if (object is ReportLinksOperations) {
  ...
  static Map<String, List<ReportLinksOperations>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<ReportLinksOperations>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<ReportLinksOperations>>(key, ReportLinksOperations.listFromJson(value));
    });
  }

  @override
  String toString() => 'ReportLinksOperations[href=$href, iriTemplate=$iriTemplate]';
