...
void main() {
  ...
  group('tests for AuthApi', () {
    ...
    // Retrieve an access token and ID token.
    //
    //Future<GetAuthToken200Response> getAuthToken(String xKeyclicApp, GetAuthTokenRequest getAuthTokenRequest, { String acceptLanguage, DateTime xDateTime, String xKeyclicAppPlatform, String xKeyclicAppVersion }) async
