...
,
  ...
  static List<OperationData> listFromJson(Iterable? json) {
    ...
    return json.fold(<OperationData>[], (List<OperationData> previousValue, element) {
  ...
  static Map<String, OperationData> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, OperationData>{}, (Map<String, OperationData> previousValue, element) {
  ...
  static Map<String, List<OperationData>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OperationData>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OperationData>>(key, OperationData.listFromJson(value));
    });
  }

  @override
  String toString() => 'OperationData[description=$description, identificationNumber=$identificationNumber, report=$report, name=$name, scheduledAt=$scheduledAt]';
