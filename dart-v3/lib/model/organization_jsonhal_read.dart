...
,
  ...
  return OrganizationJsonhalRead(
        ...
        endDate: mapToDateTime(json[r'endDate']),
                  logo: json[r'logo'],
                  name: json[r'name'],
        preferences: PreferencesJsonhalOrganizationRead.fromJson(json[r'preferences']),
  ...
  static List<OrganizationJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<OrganizationJsonhalRead>[], (List<OrganizationJsonhalRead> previousValue, element) {
      final OrganizationJsonhalRead? object = OrganizationJsonhalRead.fromJson(element);
  ...
  static Map<String, OrganizationJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, OrganizationJsonhalRead>{};
    }

    return json.entries.fold(<String, OrganizationJsonhalRead>{}, (Map<String, OrganizationJsonhalRead> previousValue, element) {
      final OrganizationJsonhalRead? object = OrganizationJsonhalRead.fromJson(element.value);
      if (object is OrganizationJsonhalRead) {
  ...
  static Map<String, List<OrganizationJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<OrganizationJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<OrganizationJsonhalRead>>(key, OrganizationJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'OrganizationJsonhalRead[links=$links, alternateName=$alternateName, description=$description, endDate=$endDate, logo=$logo, name=$name, preferences=$preferences, startDate=$startDate, id=$id, address=$address, createdAt=$createdAt, updatedAt=$updatedAt, enabled=$enabled, archived=$archived]';
  ...
  Map<String, dynamic> toJson([Iterable<String>? keys]) {
    ...
    contains(r'logo')
        ...
        r'name':
          name,
    if (keys == null || keys.
    any((key) => RegExp(r'^preferences\.').hasMatch(key))
    )
        r'preferences':
            preferences?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
