...
,
  ...
  return GetTicketDocumentTypes200Response(
        embedded: GetTicketDocumentTypes200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetTicketDocumentTypes200Response> listFromJson(Iterable? json) {
    ...
    return json.fold(<GetTicketDocumentTypes200Response>[], (List<GetTicketDocumentTypes200Response> previousValue, element) {
      final GetTicketDocumentTypes200Response? object = GetTicketDocumentTypes200Response.fromJson(element);
  ...
  static Map<String, GetTicketDocumentTypes200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetTicketDocumentTypes200Response>{};
    }

    return json.entries.fold(<String, GetTicketDocumentTypes200Response>{}, (Map<String, GetTicketDocumentTypes200Response> previousValue, element) {
      final GetTicketDocumentTypes200Response? object = GetTicketDocumentTypes200Response.fromJson(element.value);
      if (object is GetTicketDocumentTypes200Response) {
  ...
  static Map<String, List<GetTicketDocumentTypes200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetTicketDocumentTypes200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetTicketDocumentTypes200Response>>(key, GetTicketDocumentTypes200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetTicketDocumentTypes200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
