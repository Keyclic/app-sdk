...
,
  ...
  return GetPlaceCollection200ResponseLinks(
        ...
        previous: GetPlaceCollection200ResponseLinksFirst.fromJson(json[r'previous']),
        item: 
          GetPlaceCollection200ResponseLinksSelf.listFromJson(json[r'item']),
    );
  }
  ...
  static List<GetPlaceCollection200ResponseLinks> listFromJson(Iterable? json) {
    ...
    return json.fold(<GetPlaceCollection200ResponseLinks>[], (List<GetPlaceCollection200ResponseLinks> previousValue, element) {
      final GetPlaceCollection200ResponseLinks? object = GetPlaceCollection200ResponseLinks.fromJson(element);
  ...
  static Map<String, GetPlaceCollection200ResponseLinks> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetPlaceCollection200ResponseLinks>{};
    }

    return json.entries.fold(<String, GetPlaceCollection200ResponseLinks>{}, (Map<String, GetPlaceCollection200ResponseLinks> previousValue, element) {
      final GetPlaceCollection200ResponseLinks? object = GetPlaceCollection200ResponseLinks.fromJson(element.value);
      if (object is GetPlaceCollection200ResponseLinks) {
  ...
  static Map<String, List<GetPlaceCollection200ResponseLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetPlaceCollection200ResponseLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetPlaceCollection200ResponseLinks>>(key, GetPlaceCollection200ResponseLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetPlaceCollection200ResponseLinks[self=$self, first=$first, last=$last, next=$next, previous=$previous, item=$item]';
  ...
  Map<String, dynamic> toJson([Iterable<String>? keys]) {
    ...
    if (keys == null || keys.
    any((key) => RegExp(r'^previous\.').hasMatch(key))
    )
        r'previous':
            previous?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
