...
,
  ...
  static List<BillingJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<BillingJsonhalRead>[], (List<BillingJsonhalRead> previousValue, element) {
  ...
  static Map<String, BillingJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, BillingJsonhalRead>{};
    }

    return json.entries.fold(<String, BillingJsonhalRead>{}, (Map<String, BillingJsonhalRead> previousValue, element) {
      final BillingJsonhalRead? object = BillingJsonhalRead.fromJson(element.value);
      if (object is BillingJsonhalRead) {
  ...
  static Map<String, List<BillingJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<BillingJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<BillingJsonhalRead>>(key, BillingJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'BillingJsonhalRead[adjustedCost=$adjustedCost, initialCost=$initialCost, startDate=$startDate]';

  Map<String, dynamic> toJson([Iterable<String>? keys]) {
    return <String, dynamic>{
    if (keys == null || keys.
    any((key) => RegExp(r'^adjustedCost\.').hasMatch(key))
    )
        r'adjustedCost':
            adjustedCost?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
    ...
    if (keys == null || keys.
    any((key) => RegExp(r'^initialCost\.').hasMatch(key))
    )
        r'initialCost':
            initialCost?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
