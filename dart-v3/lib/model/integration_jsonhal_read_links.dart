...
,
  ...
  return IntegrationJsonhalReadLinks(
        ...
        connector: GetPlaceCollection200ResponseLinksSelf.fromJson(json[r'connector']),
  ...
  static List<IntegrationJsonhalReadLinks> listFromJson(Iterable? json) {
    ...
    return json.fold(<IntegrationJsonhalReadLinks>[], (List<IntegrationJsonhalReadLinks> previousValue, element) {
      final IntegrationJsonhalReadLinks? object = IntegrationJsonhalReadLinks.fromJson(element);
  ...
  static Map<String, IntegrationJsonhalReadLinks> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, IntegrationJsonhalReadLinks>{};
    }

    return json.entries.fold(<String, IntegrationJsonhalReadLinks>{}, (Map<String, IntegrationJsonhalReadLinks> previousValue, element) {
      final IntegrationJsonhalReadLinks? object = IntegrationJsonhalReadLinks.fromJson(element.value);
      if (object is IntegrationJsonhalReadLinks) {
  ...
  static Map<String, List<IntegrationJsonhalReadLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<IntegrationJsonhalReadLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<IntegrationJsonhalReadLinks>>(key, IntegrationJsonhalReadLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'IntegrationJsonhalReadLinks[self=$self, connector=$connector, organization=$organization]';
  ...
  Map<String, dynamic> toJson([Iterable<String>? keys]) {
    ...
    if (keys == null || keys.
    any((key) => RegExp(r'^connector\.').hasMatch(key))
    )
        r'connector':
            connector?.toJson(keys?.fold<List<String>>(<String>[], (List<String> previousValue, String element) {
