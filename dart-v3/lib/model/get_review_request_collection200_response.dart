...
,
  ...
  return GetReviewRequestCollection200Response(
        embedded: GetReviewRequestCollection200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetReviewRequestCollection200Response> listFromJson(Iterable? json) {
    if (json == null) {
      return <GetReviewRequestCollection200Response>[];
    }

    return json.fold(<GetReviewRequestCollection200Response>[], (List<GetReviewRequestCollection200Response> previousValue, element) {
      final GetReviewRequestCollection200Response? object = GetReviewRequestCollection200Response.fromJson(element);
  ...
  static Map<String, GetReviewRequestCollection200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetReviewRequestCollection200Response>{};
    }

    return json.entries.fold(<String, GetReviewRequestCollection200Response>{}, (Map<String, GetReviewRequestCollection200Response> previousValue, element) {
      final GetReviewRequestCollection200Response? object = GetReviewRequestCollection200Response.fromJson(element.value);
      if (object is GetReviewRequestCollection200Response) {
  ...
  static Map<String, List<GetReviewRequestCollection200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetReviewRequestCollection200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetReviewRequestCollection200Response>>(key, GetReviewRequestCollection200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetReviewRequestCollection200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
