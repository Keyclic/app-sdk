...
,
  ...
  static List<RuleLinksCategoryIriTemplate> listFromJson(Iterable? json) {
    ...
    return json.fold(<RuleLinksCategoryIriTemplate>[], (List<RuleLinksCategoryIriTemplate> previousValue, element) {
      final RuleLinksCategoryIriTemplate? object = RuleLinksCategoryIriTemplate.fromJson(element);
  ...
  static Map<String, RuleLinksCategoryIriTemplate> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, RuleLinksCategoryIriTemplate>{};
    }

    return json.entries.fold(<String, RuleLinksCategoryIriTemplate>{}, (Map<String, RuleLinksCategoryIriTemplate> previousValue, element) {
      final RuleLinksCategoryIriTemplate? object = RuleLinksCategoryIriTemplate.fromJson(element.value);
      if (object is RuleLinksCategoryIriTemplate) {
  ...
  static Map<String, List<RuleLinksCategoryIriTemplate>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<RuleLinksCategoryIriTemplate>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<RuleLinksCategoryIriTemplate>>(key, RuleLinksCategoryIriTemplate.listFromJson(value));
    });
  }
