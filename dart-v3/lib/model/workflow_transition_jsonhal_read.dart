...
,
  ...
  return WorkflowTransitionJsonhalRead(
        ...
        fields:
            json[r'fields'] == null ?
              null :
          List<String>.from(json[r'fields']),
                  name: json[r'name'],
        required_:
          ...
          List<String>.from(json[r'required']),
                  id: json[r'id'],
        embedded: WorkflowTransitionJsonhalReadEmbedded.fromJson(json[r'_embedded']),
    );
  }
  ...
  static List<WorkflowTransitionJsonhalRead> listFromJson(Iterable? json) {
    ...
    return json.fold(<WorkflowTransitionJsonhalRead>[], (List<WorkflowTransitionJsonhalRead> previousValue, element) {
      final WorkflowTransitionJsonhalRead? object = WorkflowTransitionJsonhalRead.fromJson(element);
  ...
  static Map<String, WorkflowTransitionJsonhalRead> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, WorkflowTransitionJsonhalRead>{};
    }

    return json.entries.fold(<String, WorkflowTransitionJsonhalRead>{}, (Map<String, WorkflowTransitionJsonhalRead> previousValue, element) {
      final WorkflowTransitionJsonhalRead? object = WorkflowTransitionJsonhalRead.fromJson(element.value);
      if (object is WorkflowTransitionJsonhalRead) {
  ...
  static Map<String, List<WorkflowTransitionJsonhalRead>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<WorkflowTransitionJsonhalRead>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<WorkflowTransitionJsonhalRead>>(key, WorkflowTransitionJsonhalRead.listFromJson(value));
    });
  }

  @override
  String toString() => 'WorkflowTransitionJsonhalRead[links=$links, description=$description, fields=$fields, name=$name, required_=$required_, id=$id, embedded=$embedded]';
