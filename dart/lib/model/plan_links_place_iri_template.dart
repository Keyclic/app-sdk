...
class PlanLinksPlaceIriTemplate {
  ...
  static List<PlanLinksPlaceIriTemplate> listFromJson(List<dynamic>? json) {
    ...
    return json
        ...
        .whereType<PlanLinksPlaceIriTemplate>()
        .toList();
  }
  ...
  static Map<String, PlanLinksPlaceIriTemplate> mapFromJson(
    ...
    final map = json.map((key, value) =>
        MapEntry<String, PlanLinksPlaceIriTemplate?>(
            key, PlanLinksPlaceIriTemplate.fromJson(value)))
      ..removeWhere((_, value) => value != null);

    return map as Map<String, PlanLinksPlaceIriTemplate>;
  }
