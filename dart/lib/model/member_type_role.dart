...
,
  ...
  static List<MemberTypeRole> listFromJson(Iterable? json) {
    ...
    return json.fold(<MemberTypeRole>[], (List<MemberTypeRole> previousValue, element) {
  ...
  static Map<String, MemberTypeRole> mapFromJson(Map<String, dynamic>? json) {
    ...
    return json.entries.fold(<String, MemberTypeRole>{}, (Map<String, MemberTypeRole> previousValue, element) {
  ...
  static Map<String, List<MemberTypeRole>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<MemberTypeRole>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<MemberTypeRole>>(key, MemberTypeRole.listFromJson(value));
    });
  }

  @override
  String toString() => 'MemberTypeRole[createdAt=$createdAt, description=$description, id=$id, name=$name, permissions=$permissions, type=$type, updatedAt=$updatedAt]';
