...
void main() {
  ...
  group('tests for BookmarkApi', () {
    ...
    // Retrieves a Bookmark resource.
    //
    //Future<BookmarkJsonhalRead> getBookmark(String identifier, String xKeyclicApp, { String acceptLanguage, DateTime xDateTime, String xKeyclicAppPlatform, String xKeyclicAppVersion }) async
