...
,
  ...
  static List<EquipmentEditEquipmentCommandWrite> listFromJson(Iterable? json) {
    ...
    return json.fold(<EquipmentEditEquipmentCommandWrite>[], (List<EquipmentEditEquipmentCommandWrite> previousValue, element) {
      final EquipmentEditEquipmentCommandWrite? object = EquipmentEditEquipmentCommandWrite.fromJson(element);
  ...
  static Map<String, EquipmentEditEquipmentCommandWrite> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, EquipmentEditEquipmentCommandWrite>{};
    }

    return json.entries.fold(<String, EquipmentEditEquipmentCommandWrite>{}, (Map<String, EquipmentEditEquipmentCommandWrite> previousValue, element) {
      final EquipmentEditEquipmentCommandWrite? object = EquipmentEditEquipmentCommandWrite.fromJson(element.value);
      if (object is EquipmentEditEquipmentCommandWrite) {
  ...
  static Map<String, List<EquipmentEditEquipmentCommandWrite>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<EquipmentEditEquipmentCommandWrite>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<EquipmentEditEquipmentCommandWrite>>(key, EquipmentEditEquipmentCommandWrite.listFromJson(value));
    });
  }

  @override
  String toString() => 'EquipmentEditEquipmentCommandWrite[brand=$brand, commissioningDate=$commissioningDate, description=$description, lifetime=$lifetime, model=$model, mpn=$mpn, name=$name, parent=$parent, serialNumber=$serialNumber, state=$state, type=$type, warranty=$warranty]';
