...
,
  ...
  return GetAssetCollection200Response(
        embedded: GetAssetCollection200ResponseEmbedded.fromJson(json[r'_embedded']),
  ...
  static List<GetAssetCollection200Response> listFromJson(Iterable? json) {
    ...
    return json.fold(<GetAssetCollection200Response>[], (List<GetAssetCollection200Response> previousValue, element) {
      final GetAssetCollection200Response? object = GetAssetCollection200Response.fromJson(element);
  ...
  static Map<String, GetAssetCollection200Response> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, GetAssetCollection200Response>{};
    }

    return json.entries.fold(<String, GetAssetCollection200Response>{}, (Map<String, GetAssetCollection200Response> previousValue, element) {
      final GetAssetCollection200Response? object = GetAssetCollection200Response.fromJson(element.value);
      if (object is GetAssetCollection200Response) {
  ...
  static Map<String, List<GetAssetCollection200Response>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<GetAssetCollection200Response>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<GetAssetCollection200Response>>(key, GetAssetCollection200Response.listFromJson(value));
    });
  }

  @override
  String toString() => 'GetAssetCollection200Response[embedded=$embedded, totalItems=$totalItems, itemsPerPage=$itemsPerPage, links=$links]';
