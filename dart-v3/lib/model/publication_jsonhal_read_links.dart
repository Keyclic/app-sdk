...
,
  ...
  static List<PublicationJsonhalReadLinks> listFromJson(Iterable? json) {
    ...
    return json.fold(<PublicationJsonhalReadLinks>[], (List<PublicationJsonhalReadLinks> previousValue, element) {
      final PublicationJsonhalReadLinks? object = PublicationJsonhalReadLinks.fromJson(element);
  ...
  static Map<String, PublicationJsonhalReadLinks> mapFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, PublicationJsonhalReadLinks>{};
    }

    return json.entries.fold(<String, PublicationJsonhalReadLinks>{}, (Map<String, PublicationJsonhalReadLinks> previousValue, element) {
      final PublicationJsonhalReadLinks? object = PublicationJsonhalReadLinks.fromJson(element.value);
      if (object is PublicationJsonhalReadLinks) {
  ...
  static Map<String, List<PublicationJsonhalReadLinks>> mapListFromJson(Map<String, dynamic>? json) {
    if (json == null) {
      return <String, List<PublicationJsonhalReadLinks>>{};
    }

    return json.map((key, value) {
      return MapEntry<String, List<PublicationJsonhalReadLinks>>(key, PublicationJsonhalReadLinks.listFromJson(value));
    });
  }

  @override
  String toString() => 'PublicationJsonhalReadLinks[self=$self, organization=$organization]';
